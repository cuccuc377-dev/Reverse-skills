...
class AbstractGTableModel(javax.swing.table.AbstractTableModel, RowObjectTableModel[T], SelectionStorage[T], typing.Generic[T]):
    ...
    def getMaxColumnWidth(self, columnIndex: typing.Union[jpype.JInt, int]) -> int:
        ...

    def getMinColumnWidth(self, columnIndex: typing.Union[jpype.JInt, int]) -> int:
        ...
    ...
    @property
    def maxColumnWidth(self) -> jpype.JInt:
        ...
    ...
    @property
    def minColumnWidth(self) -> jpype.JInt:
        ...
...
class ConfigurableColumnTableModel(javax.swing.table.TableModel):
    ...
    def getEditor(self, columnIndex: typing.Union[jpype.JInt, int]) -> javax.swing.table.TableCellEditor:
        """
        :return: the table cell editor for the given column
        :rtype: javax.swing.table.TableCellEditor
    ...
    def setAllColumnSettings(self, settings: jpype.JArray[ghidra.docking.settings.Settings]) -> None:
        ...
        :param jpype.JArray[ghidra.docking.settings.Settings] settings: An array of Settings that contains Settings for each column where the index
                    of the Settings in the array is the index of the column in the model
        """

    @property
    def editor(self) -> javax.swing.table.TableCellEditor:
        ...
...
class DynamicColumnTableModel(ConfigurableColumnTableModel, RowObjectTableModel[ROW_TYPE], typing.Generic[ROW_TYPE]):
    ...
    def getPreferenceKey(self) -> str:
        ...
        The :obj:`GTableColumnModel` manages this state for the framework.  The column model will 
...
class DynamicTableColumn(java.lang.Object, typing.Generic[ROW_TYPE, COLUMN_TYPE, DATA_SOURCE]):
    ...
    def getColumnEditor(self) -> javax.swing.table.TableCellEditor:
        """
        :return: the optional cell editor for this column; null if no custom editor is used
        :rtype: javax.swing.table.TableCellEditor
        """

    def getColumnMaxWidth(self) -> int:
        """
    ...
    def getColumnMinWidth(self) -> int:
        """
    ...
    def getComparator(self, model: DynamicColumnTableModel[typing.Any], columnIndex: typing.Union[jpype.JInt, int]) -> java.util.Comparator[COLUMN_TYPE]:
        ...
        :param DynamicColumnTableModel[typing.Any] model: the table model
        :param jpype.JInt or int columnIndex: the model column index
    ...
    @property
    def columnMaxWidth(self) -> jpype.JInt:
        ...
    ...
    @property
    def columnMinWidth(self) -> jpype.JInt:
        ...
    ...
    @property
    def columnEditor(self) -> javax.swing.table.TableCellEditor:
        ...
...
class GTable(javax.swing.JTable):
    """
    A sub-class of ``JTable`` that provides navigation and auto-lookup. By default, both of
    these features are disabled.
     
    
    Auto-lookup is only supported on one column and must be specified using the
    ``setAutoLookupColumn()`` method.
    ...
    ``SortedTableModel``, because a binary search can used to locate the desired row. A
    ...
    * Selection management (saving/restoring selection when used with a filter panel)
    ...
    def areActionsEnabled(self) -> bool:
        ...
        This method has a relationship with :meth:`setAutoLookupColumn(int) <.setAutoLookupColumn>`. If this method returns
    ...
    def getCellEditorOverride(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> javax.swing.table.TableCellEditor:
        """
        Performs custom work to locate editors for special table model types.
         
        
        This method allows clients to bypass the :meth:`getCellEditor(int, int) <.getCellEditor>`, which is sometimes
    ...
    def getCellRendererOverride(self, row: typing.Union[jpype.JInt, int], col: typing.Union[jpype.JInt, int]) -> javax.swing.table.TableCellRenderer:
        ...
        This method allows clients to bypass the :meth:`getCellRenderer(int, int) <.getCellRenderer>`, which is
    ...
    def getDynamicTableModel(self) -> DynamicColumnTableModel[typing.Any]:
        """
        :return: the underlying DynamicColumnTableModel if one is in use
        :rtype: DynamicColumnTableModel[typing.Any]
        """
    ...
    def getSelectionManager(self) -> SelectionManager:
        """
        :return: the :obj:`SelectionManager` in use by this ``GTable``, or ``null`` if the
        user has installed their own :obj:`ListSelectionModel`
    ...
    def notifyTableChanged(self, event: javax.swing.event.TableModelEvent) -> None:
        """
        A method that allows clients to signal to this ``GTable`` and its internals that the
        table model has changed.
         
        
        Usually, :meth:`tableChanged(TableModelEvent) <.tableChanged>` is called, but clients alter the table, but
    ...
    def setAccessibleNamePrefix(self, namePrefix: typing.Union[java.lang.String, str]) -> None:
        ...
        :param java.lang.String or str namePrefix: the accessible name prefix to assign to the filter component. For example
    ...
    def setActionsEnabled(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        when this table is focused. Modified keystrokes, like ``Ctrl-C``, will work at all
        times. Finally, if true is passed to this method, then the
        :meth:`auto lookup <.setAutoLookupColumn>` feature is disabled. *
    ...
    def setAutoLookupColumn(self, lookupColumn: typing.Union[jpype.JInt, int]) -> None:
        ...
        actions. See :meth:`setActionsEnabled(boolean) <.setActionsEnabled>`. Passing an invalid column index will
    ...
    def setHTMLRenderingEnabled(self, enable: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        * Wrap tooltip text content with an <html> tag so that it is possible for the content
        to be formatted in a manner that is easier for the user read, and
        * Enable any default:obj:`GTableCellRenderer` instances to render HTML
        content, which they do not do by default.
    ...
    def setUserSortingEnabled(self, enabled: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        :obj:`AbstractSortedTableModel` by clicking the table's headers.
    ...
    @property
    def dynamicTableModel(self) -> DynamicColumnTableModel[typing.Any]:
        ...
...
class TableColumnModelState(SortListener):
    ...
    This class loads and save table column state via requests made by clients like the :obj:`GTable`
    or the :obj:`GTableColumnModel`. These requests are in response to direct users actions (like
...
class DefaultEnumeratedColumnTableModel(GDynamicColumnTableModel[R, java.lang.Void], EnumeratedColumnTableModel[R], typing.Generic[C, R]):
    ...
    def __init__(self, serviceProvider: ghidra.framework.plugintool.ServiceProvider, name: typing.Union[java.lang.String, str], colType: java.lang.Class[C]) -> None:
        ...
...
class EnumeratedColumnTableModel(RowObjectTableModel[R], typing.Generic[R]):
    ...
    @staticmethod
    def createTableColumnDescriptor(cols: collections.abc.Sequence, defaultOrder: java.util.List[C]) -> TableColumnDescriptor[R]:
        ...
...
class EnumeratedDynamicTableColumn(AbstractDynamicTableColumn[R, java.lang.Object, java.lang.Void], EnumeratedColumnTableModel.EditableDynamicTableColumn[R, java.lang.Object, java.lang.Void], typing.Generic[R]):
    ...
    def __init__(self, col: EnumeratedTableColumn[typing.Any, R]) -> None:
        ...
...
class EnumeratedTableColumn(java.lang.Object, typing.Generic[C, R]):
    ...
    def getEditor(self) -> javax.swing.table.TableCellEditor:
        ...
    ...
    def getRenderer(self) -> ghidra.util.table.column.GColumnRenderer[typing.Any]:
        ...
        guaranteed here. The user must ensure that any returned by :meth:`getValueOf(Object) <.getValueOf>` can be
...
class GTableAccess(java.lang.Object):
    """
    Provides public access to the unwrapped table model of a :obj:`GTable`
    """

    class_: typing.ClassVar[java.lang.Class]

    def getUnwrappedModel(self, table: javax.swing.JTable) -> javax.swing.table.TableModel:
        """
        ...
        If the given table is a plain :obj:`JTable`, then this merely delegates to
        :meth:`JTable.getModel() <JTable.getModel>`. However, if the table happens to be a :obj:`GTable`, then this
        will invoke the otherwise-protected :meth:`GTable.getUnwrappedTableModel() <GTable.getUnwrappedTableModel>`. This is both a
        utility and a means to access a protected method of :obj:`GTable`.
        
        :param javax.swing.JTable table: the table whose model to get
        """

    @property
    def unwrappedModel(self) -> javax.swing.table.TableModel:
        ...
...
class IconButtonTableCellEditor(javax.swing.AbstractCellEditor, javax.swing.table.TableCellEditor, typing.Generic[R]):

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, cls: java.lang.Class[R], icon: javax.swing.Icon) -> None:
        ...
...
class ThreadedEnumeratedColumnTableModel(docking.widgets.table.threaded.ThreadedTableModel[R, java.lang.Void], typing.Generic[C, R]):
...
__all__ = ["AbstractDynamicTableColumn", "AbstractDynamicTableColumnStub", "AbstractGTableModel", "AbstractSortedTableModel", "AddRemoveListItem", "AnyObjectTableModel", "AutoscrollAdapter", "ChooseColumnsDialog", "ColumnSortState", "CombinedTableFilter", "ConfigurableColumnTableModel", "DefaultRowFilterTransformer", "DefaultTableCellRendererWrapper", "DefaultTableTextFilterFactory", "DiscoverableTableUtils", "DisplayStringProvider", "DynamicColumnTableModel", "DynamicTableColumn", "DynamicTableColumnExtensionPoint", "DynamicTableModel", "FilterTypeConverter", "FocusableEditor", "GBooleanCellRenderer", "GDynamicColumnTableModel", "GFilterTable", "GTable", "GTableAutoLookup", "GTableCellRenderer", "GTableCellRenderingData", "GTableColumnModel", "GTableFilterPanel", "GTableHeader", "GTableHeaderRenderer", "GTableMouseListener", "GTableTextCellEditor", "GTableToCSV", "GTableWidget", "InvertedTableFilter", "MappedTableColumn", "MultiTextFilterTableFilter", "ObjectSelectedListener", "RowFilterTransformer", "RowObject", "RowObjectFilterModel", "RowObjectSelectionManager", "RowObjectTableModel", "SelectColumnsDialog", "SelectionManager", "SelectionManagerListener", "SelectionStorage", "SortedTableModel", "SortListener", "TableColumnDescriptor", "TableColumnModelState", "TableComparators", "TableFilter", "TableItemPickedListener", "TableModelWrapper", "TableRowMapper", "TableSortingContext", "TableSortState", "TableSortStateEditor", "TableTextFilter", "TableTextFilterFactory", "TableUtils", "VariableColumnTableModel", "WrappingTableModel", "CellEditorUtils", "CustomToStringCellRenderer", "DefaultEnumeratedColumnProgramTableModel", "DefaultEnumeratedColumnTableModel", "EnumeratedColumnProgramTableModel", "EnumeratedColumnTableModel", "EnumeratedDynamicTableColumn", "EnumeratedTableColumn", "GTableAccess", "HexBigIntegerTableCellEditor", "HexDefaultGColumnRenderer", "IconButtonTableCellEditor", "IconButtonTableCellRenderer", "RangeCursorTableHeaderRenderer", "RowWrappedEnumeratedColumnTableModel", "SpannedRenderer", "SpanSetTableCellRenderer", "SpanTableCellRenderer", "ThreadedEnumeratedColumnTableModel"]
