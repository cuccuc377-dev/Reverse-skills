...
class SearchLocationContextRenderer(ghidra.util.table.column.AbstractGColumnRenderer[SearchLocationContext]):
    ...
    def renderHtmlContext(self, data: docking.widgets.table.GTableCellRenderingData, context: SearchLocationContext, showLineNumbers: typing.Union[jpype.JBoolean, bool]) -> java.awt.Component:
        ...
...
__all__ = ["FindDialogSearcher", "SearchLocationContext", "SearchLocationContextBuilder", "SearchLocationContextRenderer", "SearchResults", "TextComponentSearcher", "TextComponentSearchLocation", "TextComponentSearchResults"]
