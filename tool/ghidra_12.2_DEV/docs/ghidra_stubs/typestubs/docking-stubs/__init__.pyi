...
class ActionContext(java.lang.Object):
    ...
    :obj:`ComponentProvider`s can choose to return ActionContext objects in their 
    ...
    * contextProvider - the :obj:`ActionContextProvider` that created the context.  This
    will be null in the case that a default context was created.  When
    not null this will typically be a:obj:`ComponentProvider` or a
    :obj:`DialogComponentProvider`.  This value is set by the 
                                framework.
    ...
    * mouseEvent - the mouse event that triggered the action; null if the action was
    ...
    def getContextProvider(self) -> docking.action.ActionContextProvider:
        """
        Returns the context provider used to create this context.  May be null.
        
        :return: the context provider
        :rtype: docking.action.ActionContextProvider
        """
    ...
    def setContextProvider(self, provider: docking.action.ActionContextProvider) -> ActionContext:
        """
        Sets the context provider for this ActionContext.  This method is used internally by the 
        framework.
        
        :param docking.action.ActionContextProvider provider: the context provider
        :return: this context
        :rtype: ActionContext
        """
    ...
    @property
    def contextProvider(self) -> docking.action.ActionContextProvider:
        ...
...
class ComponentProvider(help.HelpDescriptor, docking.action.ActionContextProvider):
    ...
    **Show Provider Action** - Each provider has an action to show the provider.  For
    ...
    def getActionContext(self, event: java.awt.event.MouseEvent) -> ActionContext:
        ...
        :param java.awt.event.MouseEvent event: popup event which corresponds to this request. Will be null for key-stroke or 
...
class DialogActionContext(DefaultActionContext):
    ...
    :meth:`setContextProvider(ActionContextProvider) <.setContextProvider>`, this class serves no real purpose at the time
...
__all__ = ["AbstractDockingTool", "AbstractErrDialog", "ActionBindingPanel", "ActionContext", "ActionToGuiHelper", "ActionToGuiMapper", "ComponentLoadedListener", "ComponentNode", "ComponentPlaceholder", "ComponentProvider", "ComponentProviderActivationListener", "ComponentTransferable", "ComponentTransferableData", "DefaultActionContext", "DefaultFocusOwnerProvider", "DetachedWindowNode", "DialogActionContext", "DialogComponentProvider", "DialogComponentProviderPopupActionManager", "DisabledComponentLayerFactory", "DockableComponent", "DockableHeader", "DockableToolBarManager", "DockingActionInputBindingListener", "DockingActionPerformer", "DockingActionProxy", "DockingCheckBoxMenuItem", "DockingContextListener", "DockingDialog", "DockingErrorDisplay", "DockingFrame", "DockingKeyBindingAction", "DockingMenuItem", "DockingMouseBindingAction", "DockingUtils", "DockingWindowListener", "DockingWindowManager", "DockingWindowManagerTestUtils", "DockingWindowsContextSensitiveHelpListener", "DropCode", "DropDownMenuIcon", "DropTargetFactory", "DropTargetHandler", "EditListener", "EmptyBorderToggleButton", "ErrLogDialog", "ErrLogExpandableDialog", "ErrorReporter", "ExecutableAction", "FocusOwnerProvider", "GenericHeader", "GlobalMenuAndToolBarManager", "HeaderCursor", "HiddenDockingFrame", "KbEnabledState", "KeyBindingOverrideKeyEventDispatcher", "KeyBindingPrecedence", "KeyEntryListener", "KeyEntryPanel", "KeyEntryTextField", "MenuBarMenuHandler", "MouseBindingMouseEventDispatcher", "MouseEntryTextField", "MultiActionDialog", "MySplitPane", "Node", "PlaceholderInstaller", "PlaceholderManager", "PlaceholderSet", "PopupActionManager", "PopupMenuContext", "PopupMenuHandler", "ReusableDialogComponentProvider", "RootNode", "ShowAllComponentsAction", "ShowComponentAction", "ShowWindowAction", "SplitNode", "SplitPanel", "StatusBar", "StatusBarSpacer", "SystemExecutableAction", "TaskScheduler", "Tool", "TransferActionListener", "UndoRedoKeeper", "WindowActionManager", "WindowNode", "WindowPosition", "DefaultHelpService"]
