...
class ImporterUtilities(java.lang.Object):
    ...
    @staticmethod
    def getLoadSpec(program: ghidra.program.model.listing.Program, monitor: ghidra.util.task.TaskMonitor) -> ghidra.app.util.opinion.LoadSpec:
        """
...
__all__ = ["AddToProgramDialog", "ImporterDialog", "ImporterLanguageDialog", "ImporterPlugin", "ImporterUtilities", "LanguageSortedTableModel", "LcsSelectionEvent", "LcsSelectionListener", "LoadLibrariesOptionsDialog", "NewLanguagePanel", "ProjectIndexService"]
