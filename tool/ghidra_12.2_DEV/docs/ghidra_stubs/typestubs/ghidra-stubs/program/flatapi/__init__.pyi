...
class FlatProgramAPI(java.lang.Object):
    ...
    def createDwords(self, start: ghidra.program.model.address.Address, count: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    @deprecated("use createLabel(Address, String, boolean, SourceType) instead")
    def createSymbol(self, address: ghidra.program.model.address.Address, name: typing.Union[java.lang.String, str], makePrimary: typing.Union[jpype.JBoolean, bool], makeUnique: typing.Union[jpype.JBoolean, bool], sourceType: ghidra.program.model.symbol.SourceType) -> ghidra.program.model.symbol.Symbol:
        ...
        :param java.lang.String or str name: the name of the symbol
        :param jpype.JBoolean or bool makePrimary: true if the symbol should be made primary
        :param jpype.JBoolean or bool makeUnique: ignored
        :param ghidra.program.model.symbol.SourceType sourceType: the source type.
        :return: the newly created code or function symbol
        :rtype: ghidra.program.model.symbol.Symbol
        :raises java.lang.Exception: if there is any exception
        ...
        use :meth:`createLabel(Address, String, boolean, SourceType) <.createLabel>` instead
        """
    ...
    def end(self, commit: typing.Union[jpype.JBoolean, bool]) -> None:
        """
    ...
    @typing.overload
    def findBytes(self, start: ghidra.program.model.address.Address, byteRegex: typing.Union[java.lang.String, str]) -> ghidra.program.model.address.Address:
        """
        ...
        The ``byteRegex`` may contain special regular expression characters that need to be
        ...
        :param ghidra.program.model.address.Address start: the address to start searching.  If null, then the start of the program
                will be used.
        :param java.lang.String or str byteRegex: the byte pattern regex for which to search
        :return: the first address where the byte was found, or null if the bytes were not found
        :rtype: ghidra.program.model.address.Address
        :raises IllegalArgumentException: if ``byteRegex`` is not a valid regular expression
    ...
    @typing.overload
    def findBytes(self, start: ghidra.program.model.address.Address, byteRegex: typing.Union[java.lang.String, str], matchLimit: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
    ...
    @typing.overload
    def findBytes(self, start: ghidra.program.model.address.Address, byteRegex: typing.Union[java.lang.String, str], matchLimit: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
        Finds the first ``<matchLimit>`` occurrences of the byte array sequence that matches
        the given byte regex, starting from the address. If the start address is null, then the
        find will start from the minimum address of the program.
        ...
        :param ghidra.program.model.address.Address start: the address to start searching.  If null, then the start of the program
                will be used.
        :param java.lang.String or str byteRegex: the byte regex pattern for which to search
        :param jpype.JInt or int matchLimit: The number of matches to which the search should be restricted
    ...
    @typing.overload
    def findBytes(self, set: ghidra.program.model.address.AddressSetView, byteRegex: typing.Union[java.lang.String, str], matchLimit: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int]) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
    ...
    def findBytes(self, set: ghidra.program.model.address.AddressSetView, byteRegex: typing.Union[java.lang.String, str], matchLimit: typing.Union[jpype.JInt, int], alignment: typing.Union[jpype.JInt, int], searchAcrossAddressGaps: typing.Union[jpype.JBoolean, bool]) -> jpype.JArray[ghidra.program.model.address.Address]:
        """
    ...
    @typing.overload
    def removeEquate(self, instruction: ghidra.program.model.listing.Instruction, operandIndex: typing.Union[jpype.JInt, int], value: typing.Union[jpype.JLong, int]) -> None:
        """
    ...
    def removeEquates(self, instruction: ghidra.program.model.listing.Instruction, operandIndex: typing.Union[jpype.JInt, int]) -> None:
        """
    ...
    @typing.overload
    def saveProgram(self, program: ghidra.program.model.listing.Program, path: java.util.List[java.lang.String]) -> None:
        """
    ...
    def setBytes(self, address: ghidra.program.model.address.Address, values: jpype.JArray[jpype.JByte]) -> None:
        """
    ...
    def setDouble(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JDouble, float]) -> None:
        """
    ...
    def setFloat(self, address: ghidra.program.model.address.Address, value: typing.Union[jpype.JFloat, float]) -> None:
        """
    ...
    @typing.overload
    def setReferencePrimary(self, reference: ghidra.program.model.symbol.Reference, primary: typing.Union[jpype.JBoolean, bool]) -> None:
        """
        Sets the given reference as primary.
