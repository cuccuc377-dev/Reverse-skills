...
class ArchiveType(java.lang.Enum[ArchiveType]):
    ...
    def isValidSourceArchive(self) -> bool:
        """
    ...
    @property
    def validSourceArchive(self) -> jpype.JBoolean:
        ...
...
class BitFieldDataType(AbstractDataType):
    ...
    @staticmethod
    def getNormalizedBitOffset(bitFieldDataType: BitFieldDataType, byteOffset: typing.Union[jpype.JInt, int]) -> int:
        """
        ...
        :param BitFieldDataType bitFieldDataType: the :obj:`BitFieldDataType`
        :param jpype.JInt or int byteOffset: the offset of the component (relative to the structure struct of the
    ...
    @staticmethod
    def intersects(bitFieldDataType1: BitFieldDataType, bitFieldDataType2: BitFieldDataType, offset1: typing.Union[jpype.JInt, int], offset2: typing.Union[jpype.JInt, int]) -> bool:
        """
        Checks if two bitfields would conflict if inserted into the same structure at the given 
        offsets.
        
        :param BitFieldDataType bitFieldDataType1: the first BitFieldDataType
        :param BitFieldDataType bitFieldDataType2: the second BitFieldDataType
        :param jpype.JInt or int offset1: the offset in the structure for the first BitFieldDataType
        :param jpype.JInt or int offset2: the offset in the structure for the second BitFieldDataType
...
class DataTypeWriter(java.lang.Object):
    ...
    @typing.type_check_only
    class CompositeNode(java.lang.Comparable[DataTypeWriter.CompositeNode]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @typing.overload
    def write(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
...
class Int16TDataType(AbstractSignedIntegerDataType):
    """
    16-bit signed integer (C99 Standard type ``int16_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[Int16TDataType]
...
class Int32TDataType(AbstractSignedIntegerDataType):
    """
    32-bit signed integer (C99 Standard type ``int32_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[Int32TDataType]
...
class Int64TDataType(AbstractSignedIntegerDataType):
    """
    64-bit signed integer (C99 Standard type ``int64_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[Int64TDataType]
...
class Int8TDataType(AbstractSignedIntegerDataType):
    """
    8-bit signed integer (C99 Standard type ``int8_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[Int8TDataType]
...
class PointerSizedIntegerDataType(AbstractSignedIntegerDataType):
    """
    Pointer-sized signed integer
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[PointerSizedIntegerDataType]
...
class UInt16TDataType(AbstractUnsignedIntegerDataType):
    """
    16-bit unsigned integer (C99 Standard type ``uint16_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[UInt16TDataType]
...
class UInt32TDataType(AbstractUnsignedIntegerDataType):
    """
    32-bit unsigned integer (C99 Standard type ``uint32_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[UInt32TDataType]
...
class UInt64TDataType(AbstractUnsignedIntegerDataType):
    """
    64-bit unsigned integer (C99 Standard type ``uint64_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[UInt64TDataType]
...
class UInt8TDataType(AbstractUnsignedIntegerDataType):
    """
    8-bit unsigned integer (C99 Standard type ``uint8_t``)
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[UInt8TDataType]
...
class UnsignedPointerSizedIntegerDataType(AbstractUnsignedIntegerDataType):
    """
    Pointer-sized unsigned integer
    """

    class_: typing.ClassVar[java.lang.Class]
    dataType: typing.Final[UnsignedPointerSizedIntegerDataType]
...
__all__ = ["AbstractColorDataType", "AbstractComplexDataType", "AbstractDataType", "AbstractFloatDataType", "AbstractIntegerDataType", "AbstractLeb128DataType", "AbstractPointerTypedefBuiltIn", "AbstractSignedIntegerDataType", "AbstractStringDataType", "AbstractUnsignedIntegerDataType", "AddressSpaceSettingsDefinition", "AIFFDataType", "AlignedComponentPacker", "AlignedStructureInspector", "AlignedStructurePacker", "AlignmentDataType", "AlignmentType", "AnnotationHandler", "ArchiveType", "Array", "ArrayDataType", "ArrayStringable", "AUDataType", "AudioPlayer", "BadDataType", "BitFieldDataType", "BitFieldPacking", "BitFieldPackingImpl", "BitGroup", "BitmapResource", "BitmapResourceDataType", "BooleanDataType", "BuiltIn", "BuiltInDataType", "BuiltInDataTypeClassExclusionFilter", "BuiltInDataTypeManager", "ByteDataType", "Category", "CategoryPath", "CharDataType", "CharsetSettingsDefinition", "ColorIcon", "Complex16DataType", "Complex32DataType", "Complex8DataType", "ComponentOffsetSettingsDefinition", "Composite", "CompositeAlignmentHelper", "CompositeDataTypeImpl", "CompositeInternal", "CountedDynamicDataType", "CustomFormat", "CustomOrganization", "CycleGroup", "DataImage", "DataOrganization", "DataOrganizationImpl", "DataType", "DataTypeArchiveIdDumper", "DataTypeComparator", "DataTypeComponent", "DataTypeComponentImpl", "DataTypeConflictHandler", "DataTypeDependencyException", "DataTypeDisplayOptions", "DataTypeEncodeException", "DataTypeImpl", "DataTypeInstance", "DataTypeManager", "DataTypeManagerChangeListener", "DataTypeManagerChangeListenerAdapter", "DataTypeManagerChangeListenerHandler", "DataTypeManagerDomainObject", "DataTypeMnemonicSettingsDefinition", "DataTypeNameComparator", "DataTypeObjectComparator", "DataTypePath", "DataTypeTransferable", "DataTypeWithCharset", "DataTypeWriter", "DataUtilities", "DefaultAnnotationHandler", "DefaultDataType", "DialogResourceDataType", "DomainFileBasedDataTypeManager", "DoubleComplexDataType", "DoubleDataType", "DWordDataType", "Dynamic", "DynamicDataType", "EndianSettingsDefinition", "Enum", "EnumDataType", "EnumValuePartitioner", "FactoryDataType", "FactoryStructureDataType", "FileArchiveBasedDataTypeManager", "FileBasedDataTypeManager", "FileDataTypeManager", "FileTimeDataType", "Float10DataType", "Float16DataType", "Float2DataType", "Float4DataType", "Float8DataType", "FloatComplexDataType", "FloatDataType", "FunctionDefinition", "FunctionDefinitionDataType", "GenericCallingConvention", "GenericDataType", "GifDataType", "GIFResource", "IBO32DataType", "IBO64DataType", "ICategory", "IconMaskResourceDataType", "IconResource", "IconResourceDataType", "IllegalRenameException", "IndexedDynamicDataType", "Int16TDataType", "Int32TDataType", "Int64TDataType", "Int8TDataType", "Integer16DataType", "Integer3DataType", "Integer5DataType", "Integer6DataType", "Integer7DataType", "IntegerDataType", "InternalDataTypeComponent", "InvalidatedListener", "InvalidDataTypeException", "JPEGDataType", "LEB128", "LongDataType", "LongDoubleComplexDataType", "LongDoubleDataType", "LongLongDataType", "MacintoshTimeStampDataType", "MemBufferImageInputStream", "MenuResourceDataType", "MetaDataType", "MIDIDataType", "MissingBuiltInDataType", "MutabilitySettingsDefinition", "NoisyStructureBuilder", "OffsetMaskSettingsDefinition", "OffsetShiftSettingsDefinition", "PackingType", "PaddingSettingsDefinition", "ParameterDefinition", "ParameterDefinitionImpl", "PascalString255DataType", "PascalStringDataType", "PascalUnicodeDataType", "Playable", "PngDataType", "PngResource", "Pointer", "Pointer16DataType", "Pointer24DataType", "Pointer32DataType", "Pointer40DataType", "Pointer48DataType", "Pointer56DataType", "Pointer64DataType", "Pointer8DataType", "PointerDataType", "PointerSizedIntegerDataType", "PointerType", "PointerTypedef", "PointerTypedefBuilder", "PointerTypeSettingsDefinition", "ProgramArchitectureTranslator", "ProgramBasedDataTypeManager", "ProjectArchiveBasedDataTypeManager", "QWordDataType", "ReadOnlyDataTypeComponent", "RenderUnicodeSettingsDefinition", "RepeatCountDataType", "RepeatedDynamicDataType", "RepeatedStringDataType", "Resource", "RGB16ColorDataType", "RGB16EncodingSettingsDefinition", "RGB32ColorDataType", "RGB32EncodingSettingsDefinition", "ScorePlayer", "SegmentedCodePointerDataType", "ShiftedAddressDataType", "ShortDataType", "SignedByteDataType", "SignedCharDataType", "SignedDWordDataType", "SignedLeb128DataType", "SignedQWordDataType", "SignedWordDataType", "SourceArchive", "StandAloneDataTypeManager", "StringDataInstance", "StringDataType", "StringLayoutEnum", "StringRenderBuilder", "StringRenderParser", "StringUTF8DataType", "Structure", "StructureDataType", "StructuredDynamicDataType", "StructureFactory", "StructureInternal", "TerminatedSettingsDefinition", "TerminatedStringDataType", "TerminatedUnicode32DataType", "TerminatedUnicodeDataType", "TranslationSettingsDefinition", "TypeDef", "TypedefDataType", "TypeDefSettingsDefinition", "UInt16TDataType", "UInt32TDataType", "UInt64TDataType", "UInt8TDataType", "Undefined", "Undefined1DataType", "Undefined2DataType", "Undefined3DataType", "Undefined4DataType", "Undefined5DataType", "Undefined6DataType", "Undefined7DataType", "Undefined8DataType", "Unicode32DataType", "UnicodeDataType", "Union", "UnionDataType", "UnionInternal", "UnsignedCharDataType", "UnsignedInteger16DataType", "UnsignedInteger3DataType", "UnsignedInteger5DataType", "UnsignedInteger6DataType", "UnsignedInteger7DataType", "UnsignedIntegerDataType", "UnsignedLeb128DataType", "UnsignedLongDataType", "UnsignedLongLongDataType", "UnsignedPointerSizedIntegerDataType", "UnsignedShortDataType", "VoidDataType", "WAVEDataType", "WideChar16DataType", "WideChar32DataType", "WideCharDataType", "WordDataType"]
