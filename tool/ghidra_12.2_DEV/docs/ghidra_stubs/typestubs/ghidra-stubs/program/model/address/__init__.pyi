...
class Address(java.lang.Comparable[Address]):
    ...
    @typing.overload
    def subtractNoWrap(self, displacement: java.math.BigInteger) -> Address:
        """
        Creates a new Address by subtracting displacement from the Address.  The Address will not 
        wrap within the space and in fact will throw an exception if the result is less than the min
        address in this space or greater than the max address in this space.
        
        :param java.math.BigInteger displacement: the displacement to subtract.
        :return: The new Address
        :rtype: Address
        :raises AddressOverflowException: if the offset in this Address would overflow due to this
        operation.
...
class AddressRangeChunker(java.lang.Iterable[AddressRange]):
    ...
    @typing.overload
    def __init__(self, range: AddressRange, chunkSizeUnsigned: typing.Union[jpype.JLong, int]) -> None:
        ...

    @typing.overload
    def __init__(self, start: Address, end: Address, chunkSizeUnsigned: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class AddressSetView(java.lang.Iterable[AddressRange]):
    ...
    @typing.overload
    def intersectRange(self, range: AddressRange) -> AddressSet:
        """
        Computes the intersection of this address set with the given address range.
        ...
        :param AddressRange range: the range
        :return: AddressSet a new address set that contains all addresses that are contained in both
                this set and the given range.
        :rtype: AddressSet
        """
...
class AddressSpace(java.lang.Comparable[AddressSpace]):
    ...
    def getAddress(self, offset: typing.Union[jpype.JLong, int], isAddressableWordOffset: typing.Union[jpype.JBoolean, bool]) -> Address:
        ...
        :param jpype.JLong or int offset: the offset for the new address.
        :param jpype.JBoolean or bool isAddressableWordOffset: if true the specified offset is an addressable unit/word 
        offset, otherwise offset is a byte offset.  See :meth:`getAddressableUnitSize() <.getAddressableUnitSize>`
    ...
    @typing.overload
    def subtractNoWrap(self, addr: GenericAddress, displacement: java.math.BigInteger) -> Address:
        """
...
class SegmentedAddress(GenericAddress):
    ...
    def normalize(self, seg: typing.Union[jpype.JInt, int]) -> SegmentedAddress:
        ...
        :param jpype.JInt or int seg: the segment value to normalize to.
        :return: the new address
...
__all__ = ["AbstractAddressSpace", "Address", "AddressCollectors", "AddressFactory", "AddressFormatException", "AddressIterator", "AddressIteratorAdapter", "AddressMapImpl", "AddressObjectMap", "AddressOutOfBoundsException", "AddressOverflowException", "AddressRange", "AddressRangeChunker", "AddressRangeImpl", "AddressRangeIterator", "AddressRangeSplitter", "AddressRangeToAddressComparator", "AddressSet", "AddressSetCollection", "AddressSetMapping", "AddressSetView", "AddressSetViewAdapter", "AddressSpace", "DefaultAddressFactory", "EmptyAddressIterator", "EmptyAddressRangeIterator", "GenericAddress", "GenericAddressSpace", "GlobalNamespace", "GlobalSymbol", "ImmutableAddressSet", "KeyRange", "Mark", "OldGenericNamespaceAddress", "OverlayAddressSpace", "ProtectedAddressSpace", "SegmentedAddress", "SegmentedAddressSpace", "SegmentMismatchException", "SingleAddressSetCollection", "SpecialAddress", "CachedAddressSetView"]
