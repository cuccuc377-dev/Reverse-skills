...
class CodeUnitFormat(java.lang.Object):
    ...
    def getOffcutLabelString(self, offcutAddress: ghidra.program.model.address.Address, cu: CodeUnit, markupAddress: ghidra.program.model.address.Address, symbol: ghidra.program.model.symbol.Symbol) -> str:
        ...
...
class Library(ghidra.program.model.symbol.Namespace):
    ...
    def setAssociatedProgramPath(self, programPath: typing.Union[java.lang.String, str]) -> None:
        """
        Sets the program file pathname within the project which corresponds to this library.
         
        
        NOTE: Assigning a path to :obj:`Library.UNKNOWN` Library will be ignored.
        
        :param java.lang.String or str programPath: a program file pathname  or null to clear the stored path.
        :raises InvalidInputException: on invalid programPath is specified
        """
    ...
    @associatedProgramPath.setter
    def associatedProgramPath(self, value: java.lang.String):
        ...
...
class Program(ghidra.program.model.data.DataTypeManagerDomainObject, ghidra.program.model.lang.ProgramArchitecture):
    ...
    def getSourceLanguageIDs(self) -> java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID]:
        """
        :return: the :obj:`SourceLanguageID`s of the source languages found in the program
        :rtype: java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID]
        """
    ...
    def setSourceLanguageIDs(self, sourceLanguageIDs: java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID]) -> None:
        """
        Sets the :obj:`SourceLanguageID`s of the source languages found in the program
        
        :param java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID] sourceLanguageIDs: The :obj:`Set` of :obj:`SourceLanguageID`s
        """
    ...
    @property
    def sourceLanguageIDs(self) -> java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID]:
        ...

    @sourceLanguageIDs.setter
    def sourceLanguageIDs(self, value: java.util.Set[ghidra.app.util.sourcelanguage.SourceLanguageID]):
        ...
...
__all__ = ["CodeUnitFormat", "CodeUnitFormatOptions", "AddressChangeSet", "AutoParameterImpl", "AutoParameterType", "Bookmark", "BookmarkComparator", "BookmarkManager", "BookmarkType", "BookmarkTypeComparator", "CircularDependencyException", "CodeUnit", "CodeUnitComments", "CodeUnitIterator", "CommentHistory", "CommentType", "ContextChangeException", "Data", "DataBuffer", "DataIterator", "DataStub", "DataTypeArchive", "DataTypeArchiveChangeSet", "DataTypeChangeSet", "DefaultProgramContext", "DomainObjectChangeSet", "DuplicateGroupException", "FlowOverride", "Function", "FunctionIterator", "FunctionManager", "FunctionOverlapException", "FunctionSignature", "FunctionSignatureImpl", "FunctionTag", "FunctionTagChangeSet", "FunctionTagManager", "GhidraClass", "Group", "IncompatibleLanguageException", "Instruction", "InstructionIterator", "InstructionPcodeOverride", "InstructionStub", "LabelString", "Library", "Listing", "LocalVariable", "LocalVariableImpl", "OperandRepresentationList", "Parameter", "ParameterImpl", "Program", "ProgramChangeSet", "ProgramContext", "ProgramFragment", "ProgramModule", "ProgramTreeChangeSet", "ProgramUserData", "RegisterChangeSet", "RepeatableComment", "ReturnParameterImpl", "StackFrame", "StackVariableComparator", "StubListing", "SymbolChangeSet", "ThunkFunction", "Variable", "VariableFilter", "VariableImpl", "VariableOffset", "VariableSizeException", "VariableStorage", "VariableUtilities"]
