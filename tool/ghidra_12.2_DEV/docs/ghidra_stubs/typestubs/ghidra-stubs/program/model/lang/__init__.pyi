...
class LanguageNotFoundException(java.io.IOException):
    ...
    def __init__(self, languageID: LanguageID) -> None:
        ...
        :param LanguageID languageID: :obj:`LanguageID`
        """

    @typing.overload
    def __init__(self, languageID: LanguageID, cause: java.lang.Throwable) -> None:
        """
        Language not found because of an exception
        
        :param LanguageID languageID: :obj:`LanguageID`
        :param java.lang.Throwable cause: :obj:`Throwable` that caused the language to not be found
        """
...
class LanguageProvider(ghidra.util.classfinder.ExtensionPoint):
    ...
    def getLanguage(self, languageId: LanguageID) -> Language:
        ...
        :rtype: Language
        :raises LanguageNotFoundException: if language instantiation error
        """

    @typing.overload
    def getLanguage(self, languageId: LanguageID, monitor: ghidra.util.task.TaskMonitor) -> Language:
        """
        Returns the language with the given name or null if no language has that name.
...
class PcodeParser(ghidra.pcodeCPort.slgh_compile.PcodeCompile):
    ...
    def getDefaultConstantSize(self) -> int:
        ...
    ...
    @property
    def defaultConstantSize(self) -> jpype.JInt:
        ...
...
class PrototypeModel(java.lang.Object):
    ...
    def getArgLocation(self, argIndex: typing.Union[jpype.JInt, int], params: jpype.JArray[ghidra.program.model.listing.Parameter], dataType: ghidra.program.model.data.DataType, program: ghidra.program.model.listing.Program) -> ghidra.program.model.listing.VariableStorage:
        ...
        This method does not apply any storage rules specific to varags functions. 
        Use :meth:`getStorageLocations(Program,DataType[],boolean,boolean) <.getStorageLocations>` instead.
        """
    ...
    def getNextArgLocation(self, params: jpype.JArray[ghidra.program.model.listing.Parameter], dataType: ghidra.program.model.data.DataType, program: ghidra.program.model.listing.Program) -> ghidra.program.model.listing.VariableStorage:
        ...
        datatypes, is highly discouraged since it will produce inaccurate results.
        It is recommended that a complete function signature be used in
        conjunction with the :meth:`getStorageLocations(Program, DataType[], boolean, boolean) <.getStorageLocations>`
        method.  Parameter storage allocation may be affected by the return datatype
        specified (e.g., hidden return storage parameter).
    ...
    @typing.overload
    def getStorageLocations(self, program: ghidra.program.model.listing.Program, dataTypes: jpype.JArray[ghidra.program.model.data.DataType], addAutoParams: typing.Union[jpype.JBoolean, bool], isVarArgs: typing.Union[jpype.JBoolean, bool]) -> jpype.JArray[ghidra.program.model.listing.VariableStorage]:
        """
        Compute the variable storage for a given array of return/parameter datatypes.  
        The first array element is the return datatype, which is followed by any input parameter 
        datatypes in order. If addAutoParams is true, pointer datatypes will automatically be 
        ...
        i.e., minimum array length is 1)
        :param jpype.JBoolean or bool addAutoParams: true if auto-parameter storage locations can be generated
        :param jpype.JBoolean or bool isVarArgs: If true, the last input parameter will be treated as the last fixed argument
        of a varargs function (via :obj:`PrototypePieces.firstVarArgSlot`).
        :return: dynamic storage locations orders by ordinal where first element corresponds to
        return storage. The returned array may also include additional auto-parameter storage 
        locations.
        :rtype: jpype.JArray[ghidra.program.model.listing.VariableStorage]
...
__all__ = ["AddressLabelInfo", "BasicCompilerSpec", "BasicCompilerSpecDescription", "BasicLanguageDescription", "CompilerSpec", "CompilerSpecDescription", "CompilerSpecID", "CompilerSpecNotFoundException", "ConstantPool", "ContextSetting", "DataTypeProviderContext", "DecompilerLanguage", "DisassemblerContext", "DisassemblerContextAdapter", "DynamicVariableStorage", "Endian", "ExternalLanguageCompilerSpecQuery", "GhidraLanguagePropertyKeys", "IncompatibleMaskException", "InjectContext", "InjectPayload", "InjectPayloadCallfixup", "InjectPayloadCallfixupError", "InjectPayloadCallother", "InjectPayloadCallotherError", "InjectPayloadJumpAssist", "InjectPayloadSegment", "InjectPayloadSleigh", "InputListType", "InstructionBlock", "InstructionBlockFlow", "InstructionContext", "InstructionError", "InstructionPrototype", "InstructionSet", "InsufficientBytesException", "InvalidPrototype", "Language", "LanguageCompilerSpecPair", "LanguageCompilerSpecQuery", "LanguageDescription", "LanguageID", "LanguageNotFoundException", "LanguageProvider", "LanguageService", "LanguageVersionException", "Mask", "MaskImpl", "NestedDelaySlotException", "OldLanguageMappingService", "OperandType", "ParallelInstructionLanguageHelper", "ParamEntry", "ParameterPieces", "ParamList", "ParamListRegisterOut", "ParamListStandard", "ParamListStandardOut", "ParserContext", "PcodeInjectLibrary", "PcodeParser", "Processor", "ProcessorContext", "ProcessorContextImpl", "ProcessorContextView", "ProcessorNotFoundException", "ProgramArchitecture", "ProgramProcessorContext", "PrototypeModel", "PrototypeModelError", "PrototypeModelMerged", "PrototypePieces", "ReadOnlyProcessorContext", "Register", "RegisterBuilder", "RegisterManager", "RegisterTranslator", "RegisterTree", "RegisterValue", "SpaceNames", "StorageClass", "UndefinedValueException", "UnknownContextException", "UnknownDataException", "UnknownInstructionException", "UnknownRegister", "VersionedLanguageService"]
