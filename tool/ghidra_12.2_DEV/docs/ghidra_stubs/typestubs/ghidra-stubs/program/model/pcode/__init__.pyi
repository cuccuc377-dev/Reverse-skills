...
class HighFunctionDBUtil(java.lang.Object):
    ...
    @staticmethod
    def writeUnionFacet(function: ghidra.program.model.listing.Function, dt: ghidra.program.model.data.DataType, fieldNum: typing.Union[jpype.JInt, int], addr: ghidra.program.model.address.Address, hash: typing.Union[jpype.JLong, int], isAddr: typing.Union[jpype.JBoolean, bool], source: ghidra.program.model.symbol.SourceType) -> None:
        """
        ...
        :param jpype.JBoolean or bool isAddr: is true if the new facet is address based
...
class PackedDecode(Decoder, java.io.Closeable):
...
class UnionFacetSymbol(HighSymbol):
    ...
    def __init__(self, uniqueId: typing.Union[jpype.JLong, int], nm: typing.Union[java.lang.String, str], dt: ghidra.program.model.data.DataType, func: HighFunction) -> None:
        ...

    @staticmethod
    def buildSymbolName(fldNum: typing.Union[jpype.JInt, int], addr: ghidra.program.model.address.Address, isAddr: typing.Union[jpype.JBoolean, bool]) -> str:
        """
        Generate an automatic symbol name, given a field number and address
        
        :param jpype.JInt or int fldNum: is the field number
        :param ghidra.program.model.address.Address addr: is the Address
        :param jpype.JBoolean or bool isAddr: is true if the facet should be address based
        :return: the name
        :rtype: str
        """

    @staticmethod
    def extractAddressBased(nm: typing.Union[java.lang.String, str]) -> bool:
        """
...
__all__ = ["AddressXML", "AttributeId", "BlockCondition", "BlockCopy", "BlockDoWhile", "BlockGoto", "BlockGraph", "BlockIfElse", "BlockIfGoto", "BlockInfLoop", "BlockList", "BlockMap", "BlockMultiGoto", "BlockProperIf", "BlockSwitch", "BlockWhileDo", "ByteIngest", "CachedEncoder", "DataTypeSymbol", "Decoder", "DecoderException", "DynamicEntry", "DynamicHash", "ElementId", "Encoder", "EquateSymbol", "FunctionPrototype", "GlobalSymbolMap", "HighCodeSymbol", "HighConstant", "HighExternalSymbol", "HighFunction", "HighFunctionDBUtil", "HighFunctionShellSymbol", "HighFunctionSymbol", "HighGlobal", "HighLabelSymbol", "HighLocal", "HighOther", "HighParam", "HighParamID", "HighSymbol", "HighVariable", "JumpTable", "LinkedByteBuffer", "ListLinked", "LocalSymbolMap", "MappedDataEntry", "MappedEntry", "PackedBytes", "PackedDecode", "PackedDecodeOverlay", "PackedEncode", "PackedEncodeOverlay", "ParamMeasure", "PartialUnion", "PatchEncoder", "PatchPackedEncode", "PcodeBlock", "PcodeBlockBasic", "PcodeDataTypeManager", "PcodeException", "PcodeFactory", "PcodeOp", "PcodeOpAST", "PcodeOpBank", "PcodeOverride", "PcodeSyntaxTree", "SequenceNumber", "StringIngest", "SymbolEntry", "UnionFacetSymbol", "Varnode", "VarnodeAST", "VarnodeBank", "VarnodeTranslator", "XmlEncode"]
