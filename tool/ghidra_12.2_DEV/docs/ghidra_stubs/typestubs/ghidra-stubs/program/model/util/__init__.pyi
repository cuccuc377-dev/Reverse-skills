...
class MemoryByteIterator(java.util.Iterator[java.lang.Byte]):
    """
    Class to iterate over the bytes in memory for an address set.
    """

    class_: typing.ClassVar[java.lang.Class]
    MAX_BUF_SIZE: typing.Final = 16384
    ...
    def nextByte(self) -> int:
        ...
        :raises NoSuchElementException: if the iteration has no more elements
        """
...
__all__ = ["AcyclicCallGraphBuilder", "AddressSetPropertyMap", "CodeUnitInsertionException", "CompositeDataTypeElementInfo", "DataTypeInfo", "DefaultIntPropertyMap", "DefaultPropertyMap", "DeletedException", "IntPropertyMap", "LongPropertyMap", "MemoryByteIterator", "ObjectPropertyMap", "ProcessorSymbolType", "PropertyMap", "PropertyMapManager", "PropertySet", "SettingsPropertyMap", "StringPropertyMap", "VoidPropertyMap"]
