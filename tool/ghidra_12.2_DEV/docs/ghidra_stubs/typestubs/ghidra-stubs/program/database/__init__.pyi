...
class DbCache(java.lang.Object, typing.Generic[T]):
    """
    ...
    @typing.type_check_only
    class DummyCache(DbCache[DbObject]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    class_: typing.ClassVar[java.lang.Class]
    DUMMY: typing.Final[DbCache[typing.Any]]
    INVALID_COUNT: typing.Final = -1

    def __init__(self, factory: DbFactory[T], lock: ghidra.util.Lock, hardCacheSize: typing.Union[jpype.JInt, int]) -> None:
        """
        Constructor
        
        :param DbFactory[T] factory: the factory for creating new instances of database objects
        :param ghidra.util.Lock lock: the database lock.
        :param jpype.JInt or int hardCacheSize: the size of the hard reference cache
        """

    def add(self, dbObject: T) -> T:
        """
        Adds the given database object to the cache.
        
        :param T dbObject: the object to add to the cache.
    ...
    @typing.overload
    def getCachedInstance(self, key: typing.Union[java.lang.Long, int]) -> T:
        """
        ...
        :param java.lang.Long or int key: the key of the object to retrieve.
        :return: the cached object or null if the object with that key is not currently cached.
        :rtype: T
        """

    @typing.overload
    def getCachedInstance(self, dbRecord: db.DBRecord) -> T:
        """
        ...
        object must implement the :meth:`DbObject.refresh(DBRecord) <DbObject.refresh>` method which by default
        ignores the record and simply calls :meth:`DbObject.refresh(DBRecord) <DbObject.refresh>`.
        ...
        :param db.DBRecord dbRecord: the valid record corresponding to the object to be retrieved and possibly
    ...
    def getIfValid(self, key: typing.Union[java.lang.Long, int]) -> T:
        """
    ...
    def getRaw(self, key: typing.Union[java.lang.Long, int]) -> T:
        """
    ...
    def keyChanged(self, oldKey: typing.Union[jpype.JLong, int], newKey: typing.Union[jpype.JLong, int]) -> None:
        ...
        :param jpype.JLong or int oldKey: the old key
        :param jpype.JLong or int newKey: the new key
        """
    ...
    @property
    def modificationCount(self) -> jpype.JInt:
        ...
    ...
    @property
    def cachedInstance(self) -> T:
        ...


class DbFactory(java.lang.Object, typing.Generic[T]):
    """
    Interface for Factories that create :obj:`DbObject`s. Required by the :obj:`DbCache`
    ...
    @typing.overload
    def instantiate(self, key: typing.Union[jpype.JLong, int]) -> T:
        """
        ...
        :param jpype.JLong or int key: the database key the database key
        :return: the newly created instance of type T or null if no record found
        :rtype: T
        """

    @typing.overload
    def instantiate(self, record: db.DBRecord) -> T:
        """
        Creates a new DatabaseObject of type T for the given record.
        
        :param db.DBRecord record: the database record to create its associated unique instance of T
        :return: the newly created instance of type T
        :rtype: T
        """


class DbObject(java.lang.Object):
    """
    ...
    should be stored in a :obj:`DbCache` and the cache should be queried before creating
    any new instances.
    ...
    def isValid(self) -> bool:
        ...
        different from being the inverse of :meth:`needsRefreshing() <.needsRefreshing>`, specifically in the case
        where the object has been deleted. For a deleted object, the :obj:`.isValid` method
        will return false, but the :meth:`needsRefreshing() <.needsRefreshing>` will also return false.
...
class ProgramDB(ghidra.framework.data.DomainObjectAdapterDB, ghidra.program.model.listing.Program, ghidra.program.util.ChangeManager):
    ...
    LIBRARY_ORDINAL_ASSIGNMENT_ADDED_VERSION: typing.Final = 33
...
__all__ = ["GhidraDataTypeArchiveMergeManagerFactory", "GhidraProgramMultiUserMergeManagerFactory", "ProgramBuilder", "ChangeDiff", "DataTypeArchiveContentHandler", "DataTypeArchiveDB", "DataTypeArchiveDBChangeSet", "DataTypeArchiveLinkContentHandler", "DataTypeArchiveMergeManagerFactory", "DbCache", "DbFactory", "DbObject", "DBStringMapAdapter", "IntRangeMap", "IntRangeMapDB", "ListingDB", "ManagerDB", "MyChangeDiff", "ObsoleteProgramPropertiesService", "OverlayRegionSupplier", "OverlaySpaceDBAdapter", "OverlaySpaceDBAdapterV0", "OverlaySpaceDBAdapterV1", "ProgramAddressFactory", "ProgramCompilerSpec", "ProgramContentHandler", "ProgramDB", "ProgramDBChangeSet", "ProgramLinkContentHandler", "ProgramMultiUserMergeManagerFactory", "ProgramOverlayAddressSpace", "ProgramUserDataDB", "ProjectDataTypeManager", "SpecExtension"]
