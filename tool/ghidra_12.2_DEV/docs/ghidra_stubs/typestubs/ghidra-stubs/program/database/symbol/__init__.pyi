...
class EquateDB(ghidra.program.database.DbObject, ghidra.program.model.symbol.Equate):
    """
...
class EquateManager(ghidra.program.model.symbol.EquateTable, db.util.ErrorHandler, ghidra.program.database.ManagerDB):
    ...
    @typing.type_check_only
    class EquateFactory(ghidra.program.database.DbFactory[EquateDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class EquateRefFactory(ghidra.program.database.DbFactory[EquateRefDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class EquateRefDB(ghidra.program.database.DbObject, ghidra.program.model.symbol.EquateReference):
    """
...
class GlobalVariableSymbolDB(VariableSymbolDB):
    ...
    def __init__(self, symbolMgr: SymbolManager, variableMgr: VariableStorageManagerDB, address: ghidra.program.model.address.Address, record: db.DBRecord) -> None:
        """
...
class LibrarySymbol(SymbolDB, java.lang.Comparable[LibrarySymbol]):
    """
    ...
    def setExternalLibraryPath(self, libraryPath: typing.Union[java.lang.String, str]) -> None:
        ...
        The :obj:`Library.UNKNOWN` Library path may only be cleared.
        
        :param java.lang.String or str libraryPath: library program path or null to clear
        :raises InvalidInputException: if an invalid project file path is specified
        """
    ...
    def setOrdinal(self, ordinal: typing.Union[jpype.JInt, int]) -> None:
        ...
        No change is made if this Library symbol corresponds to :obj:`Library.UNKNOWN` Library.
        
        :param jpype.JInt or int ordinal: positive greater or equal to 0.
        :raises IllegalArgumentException: if a negative ordinal is specified
        """

    @staticmethod
    def validateExternalPath(path: typing.Union[java.lang.String, str]) -> None:
        """
        Perform path validation for an external library path within the project
        
        :param java.lang.String or str path: external library path within the project (null is allowed for clearing path)
        :raises InvalidInputException: if path is invalid
        """
...
class SymbolDatabaseAdapterV4(SymbolDatabaseAdapter):
    ...
    @typing.type_check_only
    class V4ConvertedRecordIterator(db.ConvertedRecordIterator):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class SymbolDatabaseAdapterV5(SymbolDatabaseAdapter):
    """
...
class SymbolDB(ghidra.program.database.DbObject, ghidra.program.model.symbol.Symbol):
    """
...
class SymbolManager(ghidra.program.model.symbol.SymbolTable, ghidra.program.database.ManagerDB):
    ...
    @typing.type_check_only
    class SymbolFactory(ghidra.program.database.DbFactory[SymbolDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def createLibrarySymbol(self, name: typing.Union[java.lang.String, str], pathname: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> LibrarySymbol:
        ...
        ordered Library symbol sequence.  Use :meth:`LibrarySymbol.setOrdinal(int) <LibrarySymbol.setOrdinal>` to adjust
        ordinal.
    ...
    def getLibrarySymbolList(self) -> java.util.List[LibrarySymbol]:
        """
        
        
        :return: an ordered unmodifiable list of Library symbols
        :rtype: java.util.List[LibrarySymbol]
        """
    ...
    @property
    def librarySymbolList(self) -> java.util.List[LibrarySymbol]:
        ...
...
class VariableStorageManagerDB(VariableStorageManager):
    ...
    @typing.type_check_only
    class VariableStorageFactory(ghidra.program.database.DbFactory[VariableStorageManagerDB.MyVariableStorage]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class MyVariableStorage(ghidra.program.database.DbObject):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class ByHashCache(java.lang.Object):
        """
...
__all__ = ["AddressSetFilteredSymbolIterator", "ClassSymbol", "CodeSymbol", "EquateDB", "EquateDBAdapter", "EquateDBAdapterV0", "EquateManager", "EquateRefDB", "EquateRefDBAdapter", "EquateRefDBAdapterV0", "EquateRefDBAdapterV1", "FunctionSymbol", "GhidraClassDB", "GlobalVariableSymbolDB", "LabelHistoryAdapter", "LabelHistoryAdapterNoTable", "LabelHistoryAdapterV0", "LibraryDB", "LibrarySymbol", "MemorySymbol", "NamespaceDB", "NamespaceManager", "NamespaceSymbol", "OldVariableStorageDBAdapterV0V1", "OldVariableStorageManagerDB", "OverlappingNamespaceException", "SymbolDatabaseAdapter", "SymbolDatabaseAdapterV0", "SymbolDatabaseAdapterV1", "SymbolDatabaseAdapterV2", "SymbolDatabaseAdapterV3", "SymbolDatabaseAdapterV4", "SymbolDatabaseAdapterV5", "SymbolDB", "SymbolManager", "TypeFilteredSymbolIterator", "VariableStorageDBAdapter", "VariableStorageDBAdapterNoTable", "VariableStorageDBAdapterV2", "VariableStorageManager", "VariableStorageManagerDB", "VariableSymbolDB"]
