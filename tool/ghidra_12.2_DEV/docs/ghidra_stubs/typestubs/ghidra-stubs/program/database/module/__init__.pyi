...
class FragmentDB(ghidra.program.database.DbObject, ghidra.program.model.listing.ProgramFragment):
    """
...
@typing.type_check_only
class ModuleDB(ghidra.program.database.DbObject, ghidra.program.model.listing.ProgramModule):
    """
...
class ModuleManager(java.lang.Object):
    ...
    @typing.type_check_only
    class ModuleFactory(ghidra.program.database.DbFactory[ModuleDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class FragmentFactory(ghidra.program.database.DbFactory[FragmentDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["FragmentDB", "FragmentDBAdapter", "FragmentDBAdapterV0", "ModuleDB", "ModuleDBAdapter", "ModuleDBAdapterV0", "ModuleDBAdapterV1", "ModuleManager", "ParentChildDBAdapter", "ParentChildDBAdapterV0", "ProgramTreeDBAdapter", "ProgramTreeDBAdapterV0", "TreeManager"]
