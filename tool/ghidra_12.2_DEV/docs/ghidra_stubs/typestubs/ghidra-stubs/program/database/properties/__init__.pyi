...
class PropertyMapDB(ghidra.program.database.DbObject, ghidra.program.model.util.PropertyMap[T], typing.Generic[T]):
    """
...
__all__ = ["DBPropertyMapManager", "GenericSaveable", "IntPropertyMapDB", "LongPropertyMapDB", "ObjectPropertyMapDB", "PropertiesDBAdapter", "PropertiesDBAdapterV0", "PropertyMapDB", "StringPropertyMapDB", "UnsupportedMapDB", "VoidPropertyMapDB"]
