...
class CodeManager(db.util.ErrorHandler, ghidra.program.database.ManagerDB):
    ...
    class CodeUnitFactory(ghidra.program.database.DbFactory[CodeUnitDB]):
    ...
    def getInstructionDB(self, record: db.DBRecord) -> ghidra.program.model.listing.Instruction:
        ...
    ...
    @property
    def instructionDB(self) -> ghidra.program.model.listing.Instruction:
        ...
...
class CodeUnitCache(ghidra.program.database.DbCache[CodeUnitDB]):
    """
    Specialized version of :obj:`DbCache` for code units. Because the cache has to 
    ...
    def __init__(self, factory: CodeManager.CodeUnitFactory, lock: ghidra.util.Lock, hardCacheSize: typing.Union[jpype.JInt, int]) -> None:
        ...

    def getData(self, dbRecord: db.DBRecord) -> DataDB:
        """
        Gets the Data object for the given record or null if the record is an instruction record.
        
        :param db.DBRecord dbRecord: the data or instruction record
        :return: the DataDB for the record or null if the record is an instruction
        :rtype: DataDB
        """

    def getInstruction(self, dbRecord: db.DBRecord) -> InstructionDB:
        """
    ...
    @property
    def data(self) -> DataDB:
        ...

    @property
    def instruction(self) -> InstructionDB:
        ...


@typing.type_check_only
class CodeUnitDB(ghidra.program.database.DbObject, ghidra.program.model.listing.CodeUnit, ghidra.program.model.lang.ProcessorContext):
    """
...
class DataDB(CodeUnitDB, ghidra.program.model.listing.Data):
    ...
    @typing.type_check_only
    class ComponentFactory(ghidra.program.database.DbFactory[DataComponent]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["CodeManager", "CodeUnitCache", "CodeUnitDB", "CodeUnitKeyIterator", "CodeUnitRecordIterator", "CommentHistoryAdapter", "CommentHistoryAdapterNoTable", "CommentHistoryAdapterV0", "CommentsDBAdapter", "CommentsDBAdapterV0", "CommentsDBAdapterV1", "CommentTypeFilterAddressIterator", "CommentTypeFilterIterator", "DataComponent", "DataDB", "DataDBAdapter", "DataDBAdapterV0", "DataFilteredCodeUnitIterator", "DataKeyIterator", "DataRecordIterator", "EmptyCodeUnitIterator", "InstDBAdapter", "InstDBAdapterV0", "InstDBAdapterV1", "InstructionDB", "InstructionRecordIterator", "ProtoDBAdapter", "ProtoDBAdapterV0", "ProtoDBAdapterV1", "PrototypeManager", "StringDiff", "StringDiffUtils"]
