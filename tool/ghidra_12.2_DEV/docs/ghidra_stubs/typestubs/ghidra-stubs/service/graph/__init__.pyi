...
class GraphDisplayProvider(ghidra.util.classfinder.ExtensionPoint):
    ...
    def getGraphDisplay(self, reuseGraph: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> GraphDisplay:
        ...
        use the :meth:`getGraphDisplay(boolean, boolean, TaskMonitor) <.getGraphDisplay>` method instead.
    ...
    @typing.overload
    def getGraphDisplay(self, reuseGraph: typing.Union[jpype.JBoolean, bool], append: typing.Union[jpype.JBoolean, bool], monitor: ghidra.util.task.TaskMonitor) -> GraphDisplay:
        """
        Returns a GraphDisplay that can be used to "display" a graph
        
        :param jpype.JBoolean or bool reuseGraph: if true, this provider will attempt to re-use an existing GraphDisplay
        :param jpype.JBoolean or bool append: if true and there is a graph display to reuse, don't clear the existing graph
        so that it can be appended to. Otherwise, any reused graph display will be have its 
        existing graph cleared.
        :param ghidra.util.task.TaskMonitor monitor: the :obj:`TaskMonitor` that can be used to monitor and cancel the operation
        :return: an object that can be used to display or otherwise consume (e.g., export) the graph
...
__all__ = ["AttributedGraphExporter", "DummyGraphDisplayListener", "EdgeGraphActionContext", "GraphActionContext", "GraphDisplay", "GraphDisplayListener", "GraphDisplayProvider", "VertexGraphActionContext", "Attributed", "AttributedEdge", "AttributedGraph", "AttributedVertex", "DefaultGraphDisplayOptions", "EmptyGraphType", "GraphDisplayOptions", "GraphDisplayOptionsBuilder", "GraphLabelPosition", "GraphType", "GraphTypeBuilder", "LayoutAlgorithmNames", "VertexShape"]
