...
class ClearExternalPathCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    """
    ...
    def __init__(self, externalName: typing.Union[java.lang.String, str]) -> None:
        ...
        :param java.lang.String or str externalName: external Library name
        """
...
class SetExternalNameCmd(ghidra.framework.cmd.Command[ghidra.program.model.listing.Program]):
    ...
    def __init__(self, externalName: typing.Union[java.lang.String, str], externalPath: typing.Union[java.lang.String, str]) -> None:
        ...
        setting the associated external program path.  If created, a :obj:`SourceType.USER_DEFINED`
        source will be specified.
        
        :param java.lang.String or str externalName: the Library name.
        :param java.lang.String or str externalPath: the project file path of the program file to associate with the Library.
        """

    @typing.overload
    def __init__(self, externalName: typing.Union[java.lang.String, str], externalPath: typing.Union[java.lang.String, str], source: ghidra.program.model.symbol.SourceType) -> None:
        """
        Constructs a new command for creating a Library, if it does not exist, and optionally 
        ...
        :param java.lang.String or str externalName: the Library name.
        :param java.lang.String or str externalPath: the project file path of the program file to associate with the Library.
        :param ghidra.program.model.symbol.SourceType source: the symbol source type to be applied if the library must be created.
        """
...
__all__ = ["AddExternalNameCmd", "AddMemRefCmd", "AddMemRefsCmd", "AddOffsetMemRefCmd", "AddRegisterRefCmd", "AddShiftedMemRefCmd", "AddStackRefCmd", "AssociateSymbolCmd", "ClearExternalPathCmd", "ClearFallThroughCmd", "EditRefTypeCmd", "RemoveAllReferencesCmd", "RemoveExternalNameCmd", "RemoveExternalRefCmd", "RemoveReferenceCmd", "SetExternalNameCmd", "SetExternalRefCmd", "SetFallThroughCmd", "SetPrimaryRefCmd", "UpdateExternalNameCmd"]
