...
class ComLoader(AbstractLibrarySupportLoader):
    """
    A :obj:`Loader` for processing old-style DOS COM executables
    """

    class_: typing.ClassVar[java.lang.Class]
    COM_NAME: typing.Final = "Old-style DOS Executable (COM)"
...
class ElfLoader(AbstractLibrarySupportLoader):
    ...
    @staticmethod
    @typing.overload
    def isElf(program: ghidra.program.model.listing.Program) -> bool:
        """
    ...
    @staticmethod
    @typing.overload
    def isElf(executableFormatString: typing.Union[java.lang.String, str]) -> bool:
        """
        :return: true if the specified executable format string matches the ELF loader
        :rtype: bool
        
        
        :param java.lang.String or str executableFormatString: executable format string retrieved from a program's properties
        """
...
class Loader(ghidra.util.classfinder.ExtensionPoint, java.lang.Comparable[Loader]):
    ...
    def createArg(self, arg: typing.Union[java.lang.String, str]) -> str:
        """
        :return: the given argument with :obj:`.COMMAND_LINE_ARG_PREFIX` prepended
        :rtype: str
        
         
        
        This is a convenience method to make working with :obj:`Loader` command line options less
        verbose.
        
        :param java.lang.String or str arg: the argument
        """
    ...
    def isFallback(self) -> bool:
        """
        :return: whether or not this is a "fallback" :obj:`Loader`
        :rtype: bool
    ...
    @property
    def fallback(self) -> jpype.JBoolean:
        ...
...
class LoaderService(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def getAllSupportedLoadSpecs(provider: ghidra.app.util.bin.ByteProvider, monitor: ghidra.util.task.TaskMonitor) -> LoaderMap:
        """
    ...
    @staticmethod
    @typing.overload
    @deprecated("Use getAllSupportedLoadSpecs(ByteProvider, TaskMonitor)")
    def getAllSupportedLoadSpecs(provider: ghidra.app.util.bin.ByteProvider) -> LoaderMap:
        ...
        Use :meth:`getAllSupportedLoadSpecs(ByteProvider, TaskMonitor) <.getAllSupportedLoadSpecs>`
        """
    ...
    @staticmethod
    @typing.overload
    def getSupportedLoadSpecs(provider: ghidra.app.util.bin.ByteProvider, loaderFilter: java.util.function.Predicate[Loader], monitor: ghidra.util.task.TaskMonitor) -> LoaderMap:
        """
        Gets all supported :obj:`LoadSpec`s for loading the given :obj:`ByteProvider`.
    ...
    @staticmethod
    @typing.overload
    @deprecated("Use getSupportedLoadSpecs(ByteProvider, Predicate, TaskMonitor)")
    def getSupportedLoadSpecs(provider: ghidra.app.util.bin.ByteProvider, loaderFilter: java.util.function.Predicate[Loader]) -> LoaderMap:
        ...
        Use :meth:`getSupportedLoadSpecs(ByteProvider, Predicate, TaskMonitor) <.getSupportedLoadSpecs>`
        """


class LoaderTier(java.lang.Enum[LoaderTier]):
    """
    When sorting, :obj:`Loader`s are first :meth:`sorted <Loader.compareTo>` by tier, and then
    by :meth:`Loader.getTierPriority() <Loader.getTierPriority>` to break ties
    """
...
class TenetPlusPlusLoader(Loader):

    @typing.type_check_only
    class ModuleEvent(java.lang.Record):
...
__all__ = ["AbstractLibrarySupportLoader", "AbstractOrdinalSupportLoader", "AbstractPeDebugLoader", "AbstractProgramLoader", "AbstractProgramWrapperLoader", "AddressSetPartitioner", "BinaryLoader", "BoundedBufferedReader", "CoffLoader", "ComLoader", "DbgLoader", "DecompileDebugByteManager", "DecompileDebugDataTypeManager", "DecompileDebugFormatManager", "DecompileDebugFunctionManager", "DecompileDebugXmlLoader", "DefExportLine", "DefLoader", "DyldCacheLoader", "DyldCacheOptions", "DyldCacheProgramBuilder", "DyldCacheUtils", "ElfDataType", "ElfLoader", "ElfLoaderOptionsFactory", "ElfProgramBuilder", "GdtLoader", "GzfLoader", "IntelHexLoader", "IntelHexMemImage", "IntelHexRecord", "IntelHexRecordReader", "IntelHexRecordWriter", "LibraryExportedSymbol", "LibraryHints", "LibraryLookupTable", "LibraryPathsDialog", "LibrarySymbolTable", "Loaded", "LoadedOpen", "Loader", "LoaderMap", "LoaderOpinionException", "LoaderService", "LoaderTier", "LoadException", "LoadResults", "LoadSpec", "MachoLoader", "MachoPrelinkProgramBuilder", "MachoPrelinkUtils", "MachoProgramBuilder", "MapLoader", "MemorySection", "MemorySectionResolver", "MotorolaHexLoader", "MSCoffLoader", "MzLoader", "NeLoader", "Omf51Loader", "OmfLoader", "OpinionException", "PeDataType", "PefLoader", "PeLoader", "QueryOpinionService", "QueryOpinionServiceHandler", "QueryResult", "SomLoader", "UnixAoutLoader", "UnixAoutProgramLoader", "XmlLoader", "TenetLoader", "TenetPlusPlusLoader"]
