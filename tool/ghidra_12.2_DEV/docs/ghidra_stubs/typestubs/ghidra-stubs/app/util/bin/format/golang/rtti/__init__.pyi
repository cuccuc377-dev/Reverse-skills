...
class GoRttiMapper(ghidra.app.util.bin.format.golang.structmapping.DataTypeMapper, ghidra.app.util.bin.format.golang.structmapping.DataTypeMapperContext):
    ...
    *     
    ...
    @staticmethod
    @typing.overload
    def getFirstGoSection(program: ghidra.program.model.listing.Program, *sectionNames: typing.Union[java.lang.String, str]) -> ghidra.program.model.mem.MemoryBlock:
        ...

    @typing.overload
    def getFirstGoSection(self, *sectionNames: typing.Union[java.lang.String, str]) -> ghidra.program.model.mem.MemoryBlock:
        ...
    ...
    @property
    def firstGoSection(self) -> ghidra.program.model.mem.MemoryBlock:
        ...
...
class GoTypeManager(java.lang.Object):
    ...
    def createSpecializedChanDT(self, fullChanTypeName: typing.Union[java.lang.String, str], elementTypeName: typing.Union[java.lang.String, str]) -> ghidra.program.model.data.DataType:
        ...
...
__all__ = ["GoApiSnapshot", "GoFuncData", "GoFuncDataTable", "GoFuncFlag", "GoFunctabEntry", "GoIface", "GoItab", "GoModuledata", "GoName", "GoPcDataTable", "GoPcHeader", "GoPcValueEvaluator", "GoRttiMapper", "GoSlice", "GoSourceFileInfo", "GoString", "GoSymbolName", "GoSymbolNameType", "GoTypeManager", "GoVarlenString", "JsonPatch", "JsonPatchApplier", "MethodInfo"]
