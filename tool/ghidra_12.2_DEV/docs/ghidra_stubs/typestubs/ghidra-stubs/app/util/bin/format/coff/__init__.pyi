...
__all__ = ["AoutHeader", "AoutHeaderFactory", "AoutHeaderMagic", "AoutHeaderMIPS", "BigEndianUnitSizeByteSwapperInputStream", "CoffConstants", "CoffException", "CoffFileHeader", "CoffFileHeaderFlag", "CoffFileHeaderTargetID", "CoffLineNumber", "CoffMachineType", "CoffRelocation", "CoffSectionHeader", "CoffSectionHeader1", "CoffSectionHeader2", "CoffSectionHeader3", "CoffSectionHeaderFactory", "CoffSectionHeaderFlags", "CoffSectionHeaderReserved", "CoffSymbol", "CoffSymbolAux", "CoffSymbolAuxArray", "CoffSymbolAuxBeginningOfBlock", "CoffSymbolAuxDefault", "CoffSymbolAuxEndOfBlock", "CoffSymbolAuxEndOfStruct", "CoffSymbolAuxFactory", "CoffSymbolAuxFilename", "CoffSymbolAuxFunction", "CoffSymbolAuxName", "CoffSymbolAuxSection", "CoffSymbolAuxTagName", "CoffSymbolSectionNumber", "CoffSymbolSpecial", "CoffSymbolStorageClass", "CoffSymbolType"]
