...
class ProgramLoader(java.lang.Object):
    ...
    class Builder(java.lang.Object):
        ...
        @typing.overload
        def loadAll(self) -> ghidra.app.util.opinion.LoadResults[ghidra.framework.model.DomainObject]:
            """
            Loads the specified :meth:`source <.source>` with this :obj:`Builder`'s 
            current configuration
            ...
            :rtype: ghidra.app.util.opinion.LoadResults[ghidra.framework.model.DomainObject]
            :raises IOException: if there was an IO-related problem loading
            :raises LanguageNotFoundException: if there was a problem getting the language
            :raises CancelledException: if the operation was cancelled
            :raises VersionException: if there was an issue with database versions, probably due to a 
        ...
        @typing.overload
        def loadAll(self, consumer: java.lang.Object) -> ghidra.app.util.opinion.LoadResults[ghidra.framework.model.DomainObject]:
            """
            Loads the specified :meth:`source <.source>` with this :obj:`Builder`'s 
            current configuration
            
            :param java.lang.Object consumer: A reference to the object "consuming" the returned :obj:`LoadResults`, 
            used to ensure the underlying :obj:`DomainObject`s are only closed when every consumer
            is done with it (see :meth:`LoadResults.close() <LoadResults.close>`).
            :return: The :obj:`LoadResults` which contains one or more :obj:`Loaded` 
            :obj:`DomainObject`s (created but not saved)
            :rtype: ghidra.app.util.opinion.LoadResults[ghidra.framework.model.DomainObject]
            :raises IOException: if there was an IO-related problem loading
...
__all__ = ["AutoImporter", "CsHintLoadSpecChooser", "LcsHintLoadSpecChooser", "LibrarySearchPathManager", "LoaderArgsOptionChooser", "LoadSpecChooser", "MultipleProgramsException", "OptionChooser", "ProgramLoader", "SingleLoaderFilter", "MessageLog"]
