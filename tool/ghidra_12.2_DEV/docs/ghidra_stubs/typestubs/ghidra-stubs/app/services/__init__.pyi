...
class DebuggerListingService(CodeViewerService):
    ...
    def createNewListing(self) -> ghidra.debug.api.listing.DebuggerListing:
        """
        Create a new disconnected debugger listing
        
        :return: newly created debugger listing
        :rtype: ghidra.debug.api.listing.DebuggerListing
        """

    def findNextCustomTitle(self) -> str:
        """
    ...
    def getAllListings(self) -> java.util.List[ghidra.debug.api.listing.DebuggerListing]:
        """
        Get all debugger listings
        
        :return: List of all debugger listings
        :rtype: java.util.List[ghidra.debug.api.listing.DebuggerListing]
        """
    ...
    def getGoToSleighMode(self) -> ghidra.pcode.exec_.SleighUtils.LitIdMode:
        """
        Get the mode of the Go-to dialog's Sleigh expressions
        
        :return: the current mode
        :rtype: ghidra.pcode.exec_.SleighUtils.LitIdMode
        """
    ...
    def setGoToSleighMode(self, mode: ghidra.pcode.exec_.SleighUtils.LitIdMode) -> None:
        """
        ...
        :param ghidra.pcode.exec_.SleighUtils.LitIdMode mode: the new mode
        """
    ...
    @property
    def goToSleighMode(self) -> ghidra.pcode.exec_.SleighUtils.LitIdMode:
        ...

    @goToSleighMode.setter
    def goToSleighMode(self, value: ghidra.pcode.exec_.SleighUtils.LitIdMode):
        ...
    ...
    @property
    def allListings(self) -> java.util.List[ghidra.debug.api.listing.DebuggerListing]:
        ...
...
class DebuggerStaticMappingService(ghidra.debug.api.modules.DebuggerAddressTranslator):
    """
    ...
    def openMappedProgramsInView(self, trace: ghidra.trace.model.Trace, set: ghidra.program.model.address.AddressSetView, snap: typing.Union[jpype.JLong, int], failures: java.util.Set[java.lang.Exception]) -> java.util.Set[ghidra.program.model.listing.Program]:
        ...
        This essentially calls :meth:`getMappedProgramUrlsInView(Trace, AddressSetView, long) <.getMappedProgramUrlsInView>` and
...
class DebuggerTraceManagerService(java.lang.Object):
    ...
    def saveTrace(self, trace: ghidra.trace.model.Trace) -> java.util.concurrent.CompletableFuture[java.lang.Void]:
        ...
        need to invoke :meth:`CompletableFuture.exceptionally(Function) <CompletableFuture.exceptionally>` on the returned future. The
    ...
    def saveTraceAs(self, trace: ghidra.trace.model.Trace) -> java.util.concurrent.CompletableFuture[java.lang.Void]:
        """
        ...
        invoke :meth:`CompletableFuture.exceptionally(Function) <CompletableFuture.exceptionally>` on the returned future. The future
        is returned as a means of registering follow-up actions.
        
        :param ghidra.trace.model.Trace trace: the trace to (rename and) save
        :return: a future which completes when the save is finished
        :rtype: java.util.concurrent.CompletableFuture[java.lang.Void]
        """
...
__all__ = ["AbstractAnalyzer", "AnalysisPriority", "Analyzer", "AnalyzerAdapter", "AnalyzerType", "BlockModelService", "BlockModelServiceListener", "BookmarkService", "ButtonPressedListener", "ClipboardContentProviderService", "ClipboardService", "CodeFormatService", "CodeViewerService", "ConsoleService", "CoordinatedListingPanelListener", "DataService", "DataTypeArchiveService", "DataTypeManagerService", "DataTypeQueryService", "DataTypeReference", "DataTypeReferenceFinder", "EclipseIntegrationService", "FieldMatcher", "FieldMouseHandlerService", "FileImporterService", "FileSystemBrowserService", "FunctionComparisonService", "GhidraScriptService", "GoToOverrideService", "GoToService", "GoToServiceListener", "GraphDisplayBroker", "HoverService", "ListingMarginProviderService", "ListingOverviewProviderService", "MarkerDescriptor", "MarkerService", "MarkerSet", "MemorySearchService", "NavigationHistoryService", "ProgramLocationPair", "ProgramManager", "ProgramTreeService", "QueryData", "StringTranslationService", "StringValidatorQuery", "StringValidatorService", "StringValidityScore", "Terminal", "TerminalService", "ViewManagerService", "ViewService", "VSCodeIntegrationService", "DebuggerAutoMappingService", "DebuggerConsoleService", "DebuggerControlService", "DebuggerEmulationService", "DebuggerListingService", "DebuggerLogicalBreakpointService", "DebuggerPlatformService", "DebuggerStaticMappingService", "DebuggerTargetService", "DebuggerTraceManagerService", "DebuggerWatchesService", "ProgressService", "TraceRmiLauncherService", "TraceRmiService", "InternalTraceRmiService"]
