...
class DebuggerStaticMappingContext(ghidra.debug.api.modules.DebuggerAddressTranslator):
    ...
    class ChangeCollector(java.lang.Record, java.lang.AutoCloseable):
        ...
        def __init__(self, ctx: DebuggerStaticMappingContext) -> None:
            ...

        def ctx(self) -> DebuggerStaticMappingContext:
            ...
    ...
    def addProgram(self, cc: DebuggerStaticMappingContext.ChangeCollector, program: ghidra.program.model.listing.Program) -> None:
        ...

    def addTrace(self, cc: DebuggerStaticMappingContext.ChangeCollector, trace: ghidra.trace.model.Trace) -> None:
        ...

    def collectChanges(self) -> DebuggerStaticMappingContext.ChangeCollector:
        ...

    def removeChangeListener(self, l: ghidra.debug.api.modules.DebuggerStaticMappingChangeListener) -> None:
        ...

    def removeProgram(self, cc: DebuggerStaticMappingContext.ChangeCollector, program: ghidra.program.model.listing.Program) -> None:
        ...

    def removeTrace(self, cc: DebuggerStaticMappingContext.ChangeCollector, trace: ghidra.trace.model.Trace) -> None:
        ...

    def setPrograms(self, cc: DebuggerStaticMappingContext.ChangeCollector, programs: java.util.Set[ghidra.program.model.listing.Program]) -> None:
        ...

    def setTraces(self, cc: DebuggerStaticMappingContext.ChangeCollector, traces: java.util.Set[ghidra.trace.model.Trace]) -> None:
        ...
...
__all__ = ["AbstractMapEntry", "AbstractMapProposal", "DebuggerStaticMappingContext", "DebuggerStaticMappingProposals", "DebuggerStaticMappingServicePlugin", "DebuggerStaticMappingUtils", "DefaultModuleMapProposal", "DefaultRegionMapProposal", "DefaultSectionMapProposal", "DynamicStaticSynchronizationPlugin", "InfoPerProgram", "InfoPerTrace", "MapModulesBackgroundCommand", "MappingEntry", "MapRegionsBackgroundCommand", "MapSectionsBackgroundCommand", "ModuleRegionMatcher", "PeekOpenedDomainObject", "ProgramModuleIndexer"]
