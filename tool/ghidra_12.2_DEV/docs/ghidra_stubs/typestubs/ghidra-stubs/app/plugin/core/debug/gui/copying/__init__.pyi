...
class DebuggerCopyIntoProgramDialog(docking.ReusableDialogComponentProvider):
    ...
    @typing.type_check_only
    class RangeTableColumns(java.lang.Enum[DebuggerCopyIntoProgramDialog.RangeTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerCopyIntoProgramDialog.RangeTableColumns, DebuggerCopyIntoProgramDialog.RangeEntry]):
    ...
    class RangeTableModel(docking.widgets.table.DefaultEnumeratedColumnTableModel[DebuggerCopyIntoProgramDialog.RangeTableColumns, DebuggerCopyIntoProgramDialog.RangeEntry]):
        ...
        def __init__(self, tool: ghidra.framework.plugintool.PluginTool, dialog: DebuggerCopyIntoProgramDialog) -> None:
            ...
...
__all__ = ["DebuggerCopyActionsPlugin", "DebuggerCopyIntoProgramDialog", "DebuggerCopyPlan"]
