...
class LocationReferencesTableModel(ghidra.util.table.AddressBasedTableModel[LocationReference]):
    ...
    @typing.type_check_only
    class ContextColumn(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn[LocationReference, LocationReference]):
    ...
    @typing.type_check_only
    class FieldNameColumn(ghidra.util.table.field.AbstractProgramBasedDynamicTableColumn[LocationReference, java.lang.String]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["AddressLocationDescriptor", "DataTypeLocationDescriptor", "FindReferencesToAction", "FindReferencesToAddressAction", "FunctionDefinitionLocationDescriptor", "FunctionParameterNameLocationDescriptor", "FunctionParameterTypeLocationDescriptor", "FunctionReturnTypeLocationDescriptor", "FunctionSignatureFieldLocationDescriptor", "GenericCompositeDataTypeLocationDescriptor", "GenericCompositeDataTypeProgramLocation", "GenericDataTypeLocationDescriptor", "GenericDataTypeProgramLocation", "LabelLocationDescriptor", "LocationDescriptor", "LocationReference", "LocationReferencesHighlighter", "LocationReferencesPanel", "LocationReferencesPlugin", "LocationReferencesProvider", "LocationReferencesProviderContext", "LocationReferencesService", "LocationReferencesTableModel", "LocationReferenceToAddressTableRowMapper", "LocationReferenceToFunctionContainingTableRowMapper", "LocationReferenceToProgramLocationTableRowMapper", "MnemonicLocationDescriptor", "OperandLocationDescriptor", "ReferenceUtils", "StructureMemberLocationDescriptor", "UnionLocationDescriptor", "VariableNameLocationDescriptor", "VariableTypeLocationDescriptor", "VariableXRefLocationDescriptor", "XRefLocationDescriptor"]
