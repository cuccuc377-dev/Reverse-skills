...
class FunctionEditorModel(java.lang.Object):
    ...
    def setFunctionData(self, ns: ghidra.program.model.symbol.Namespace, functionDefinition: ghidra.program.model.data.FunctionDefinitionDataType) -> None:
        ...
...
__all__ = ["FunctionData", "FunctionDataView", "FunctionEditorDialog", "FunctionEditorModel", "FunctionSignatureTextField", "FunctionVariableData", "ModelChangeListener", "ParameterDataTypeCellEditor", "ParameterTableModel", "ParamInfo", "RegisterDropDownSelectionDataModel", "StorageAddressEditorDialog", "StorageAddressModel", "StorageTableCellEditor", "VarnodeInfo", "VarnodeLocationCellEditor", "VarnodeLocationTableCellRenderer", "VarnodeSizeCellEditor", "VarnodeTableModel", "VarnodeType", "VarnodeTypeCellEditor"]
