...
class DebuggerTraceTabPanel(docking.widgets.tab.GTabPanel[ghidra.trace.model.Trace], ghidra.framework.plugintool.util.PluginEventListener, ghidra.framework.model.DomainObjectListener, ghidra.framework.model.DomainFolderChangeListener):
