...
class ExternalReferencesProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    @typing.type_check_only
    class ExternalNamesTableModel(docking.widgets.table.AbstractGTableModel[ExternalReferencesProvider.ExternalNamesRow]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["CreateDefaultReferenceAction", "DeleteReferencesAction", "EditExternalReferencePanel", "EditMemoryReferencePanel", "EditReferenceDialog", "EditReferencePanel", "EditReferencesModel", "EditReferencesProvider", "EditRegisterReferencePanel", "EditStackReferencePanel", "ExternalReferencesProvider", "InstructionPanel", "InstructionPanelListener", "OffsetTableDialog", "OffsetTablePlugin", "ParameterConflictException", "ReferencesPlugin", "ReservedNameException"]
