...
class DebuggerSnapshotTablePanel(javax.swing.JPanel):
    ...
    class SnapshotTableColumns(java.lang.Enum[DebuggerSnapshotTablePanel.SnapshotTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerSnapshotTablePanel.SnapshotTableColumns, SnapshotRow]):
    ...
    @typing.type_check_only
    class StyleCurrentSnapRenderer(ghidra.util.table.column.AbstractGColumnRenderer[java.lang.Object], docking.widgets.table.GTableAccess):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class SnapshotTableModel(docking.widgets.table.ThreadedEnumeratedColumnTableModel[DebuggerSnapshotTablePanel.SnapshotTableColumns, SnapshotRow]):
    ...
    def addSnapshot(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...

    def getCurrent(self) -> ghidra.debug.api.tracemgr.DebuggerCoordinates:
        ...

    def getRow(self, snap: typing.Union[jpype.JLong, int]) -> SnapshotRow:
        ...

    def getTrace(self) -> ghidra.trace.model.Trace:
        ...

    def removeSnapshot(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...

    def setCurrent(self, coords: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> None:
        ...

    def setHideScratch(self, hideScratch: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def setTrace(self, trace: ghidra.trace.model.Trace) -> None:
        ...

    def updateSnapshot(self, snapshot: ghidra.trace.model.time.TraceSnapshot) -> None:
        ...
    ...
    @current.setter
    def current(self, value: ghidra.debug.api.tracemgr.DebuggerCoordinates):
        ...

    @property
    def row(self) -> SnapshotRow:
        ...



__all__ = ["DebuggerSnapshotTablePanel", "DebuggerTimePlugin", "DebuggerTimeProvider", "DebuggerTimeSelectionDialog", "SnapshotRow", "SnapshotTableModel"]
