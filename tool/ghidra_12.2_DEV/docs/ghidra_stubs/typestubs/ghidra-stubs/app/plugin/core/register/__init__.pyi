...
class RegisterManagerProvider(ghidra.framework.plugintool.ComponentProviderAdapter):
    ...
    @typing.type_check_only
    class RegisterManagerContext(ghidra.app.context.ProgramActionContext):
        ...
        def hasSelectedRegisterValueRanges(self) -> bool:
            ...
...
class SetRegisterValueDialog(docking.DialogComponentProvider):
    ...
    @typing.type_check_only
    class RegisterComboRenderer(docking.widgets.list.GListCellRenderer[RegisterWrapper]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["EditRegisterValueDialog", "RegisterManagerProvider", "RegisterPlugin", "RegisterTree", "RegisterTreeGroupNode", "RegisterTreeNode", "RegisterTreeRootNode", "RegisterValueRange", "RegisterValueRangeComparator", "RegisterValueRenderer", "RegisterValuesPanel", "RegisterWrapper", "SearchableRegisterTreeNode", "SetRegisterValueDialog"]
