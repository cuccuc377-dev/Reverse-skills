...
class DebuggerWatchesProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.services.DebuggerWatchesService):
    ...
    @typing.type_check_only
    class WatchTableColumns(java.lang.Enum[DebuggerWatchesProvider.WatchTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerWatchesProvider.WatchTableColumns, DefaultWatchRow]):
    ...
    @typing.type_check_only
    class WatchDataTypeEditor(ghidra.base.widgets.table.AbstractDataTypeTableCellEditor):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["DebuggerWatchActionContext", "DebuggerWatchesPlugin", "DebuggerWatchesProvider", "DefaultWatchRow", "SavedSettings"]
