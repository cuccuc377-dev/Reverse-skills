...
class VariableValueHoverService(ghidra.app.plugin.core.hover.AbstractConfigurableHover, ghidra.app.plugin.core.codebrowser.hover.ListingHoverService, ghidra.app.decompiler.component.hover.DecompilerHoverService):
    ...
    def getUnwindInfo(self, program: ghidra.program.model.listing.Program, key: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> ghidra.app.plugin.core.debug.stack.UnwindInfo:
        ...
...
class VariableValueUtils(java.lang.Enum[VariableValueUtils]):
    ...
    @staticmethod
    def getStackPointer(platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, snap: typing.Union[jpype.JLong, int]) -> ghidra.program.model.address.Address:
        """
        Get the stack pointer from the innermost frame of the given thread's stack
         
         
        
        This will prefer the stack pointer in the :obj:`TraceStackFrame`. If that's not available,
    ...
    @staticmethod
    def getStackPointerFromRegisters(platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, snap: typing.Union[jpype.JLong, int]) -> ghidra.program.model.address.Address:
        """
        Get the program counter for the given thread's innermost frame using its
        :obj:`TraceMemorySpace`, i.e., registers
    ...
    @staticmethod
    def getStackPointerFromStack(platform: ghidra.trace.model.guest.TracePlatform, thread: ghidra.trace.model.thread.TraceThread, snap: typing.Union[jpype.JLong, int]) -> ghidra.program.model.address.Address:
        """
        Get the stack pointer for the given thread's innermost frame using its :obj:`TraceStack`
...
__all__ = ["VariableValueHoverPlugin", "VariableValueHoverService", "VariableValueRow", "VariableValueTable", "VariableValueUtils"]
