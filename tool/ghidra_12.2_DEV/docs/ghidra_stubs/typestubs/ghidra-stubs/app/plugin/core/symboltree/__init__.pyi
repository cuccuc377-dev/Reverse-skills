...
class SymbolTreePlugin(ghidra.framework.plugintool.Plugin, SymbolTreeService):
    ...
    class_: typing.ClassVar[java.lang.Class]
    OPTIONS_CATEGORY: typing.Final = "Symbol Tree"
    OPTION_NAME_GROUP_THRESHOLD: typing.Final = "Group Threshold"
...
__all__ = ["DisconnectedSymbolTreeProvider", "EditExternalLocationDialog", "EditExternalLocationPanel", "SymbolCategory", "SymbolGTree", "SymbolGTreeDragNDropHandler", "SymbolTreeActionContext", "SymbolTreePlugin", "SymbolTreeProvider", "SymbolTreeService"]
