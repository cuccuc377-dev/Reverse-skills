...
class ProgramTreePlugin(ghidra.app.plugin.ProgramPlugin, ghidra.app.services.ProgramTreeService, ghidra.framework.options.OptionsChangeListener, ghidra.framework.plugintool.PluginWithTransientState[ProgramTreePlugin.ProgramTreeTransientState]):
    """
    ...
    @typing.type_check_only
    class ProgramTreeTransientState(java.lang.Record):
        ...
        def ss(self) -> ghidra.framework.options.SaveState:
            ...
...
__all__ = ["DnDMoveManager", "DnDTreeCellRenderer", "DragNDropTree", "GroupTransferable", "PasteManager", "ProgramDnDTree", "ProgramListener", "ProgramNode", "ProgramTreeAction", "ProgramTreeActionContext", "ProgramTreeActionManager", "ProgramTreeModelListener", "ProgramTreeModularizationPlugin", "ProgramTreePanel", "ProgramTreePlugin", "ProgramTreeTransferable", "ReorderManager", "TreeDragSrcAdapter", "TreeListener", "TreeViewProvider", "ViewChangeListener", "ViewManagerComponentProvider", "ViewPanel", "ViewProviderService"]
