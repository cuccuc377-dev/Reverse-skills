...
class ExtensionInstallationInfo(java.lang.Object):
    """
    A class that contains an :obj:`ExtensionDetails` and any :obj:`extension points <ClassFileInfo>`
    ...
    @staticmethod
    def get() -> java.util.Set[ExtensionInstallationInfo]:
        """
        :return: information for each installed extension
        :rtype: java.util.Set[ExtensionInstallationInfo]
        """

    def getClassInfos(self) -> java.util.Set[ghidra.util.classfinder.ClassFileInfo]:
        ...

    def getExtension(self) -> ghidra.util.extensions.ExtensionDetails:
        ...

    @property
    def extension(self) -> ghidra.util.extensions.ExtensionDetails:
        ...

    @property
    def classInfos(self) -> java.util.Set[ghidra.util.classfinder.ClassFileInfo]:
        ...
...
class ExtensionInstaller(java.lang.Object):
    ...
    * version
    ...
    :obj:`ExtensionTableDialog`. Installation consists of unzipping the extension archive to an
...
@typing.type_check_only
class ExtensionRowObject(java.lang.Object):
...
class ExtensionTableDialog(docking.DialogComponentProvider):
    """
...
@typing.type_check_only
class ExtensionTableModel(docking.widgets.table.threaded.ThreadedTableModel[ExtensionRowObject, java.lang.Object]):
    """
    ...
    @typing.type_check_only
    class ExtensionNameColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.String, java.lang.Object]):
        """
    ...
    @typing.type_check_only
    class ExtensionDescriptionColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.String, java.lang.Object]):
        """
    ...
    @typing.type_check_only
    class ExtensionVersionColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.String, java.lang.Object]):
        """
        Table column for displaying the extension description.
        """
    ...
    @typing.type_check_only
    class ExtensionInstalledColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.Boolean, java.lang.Object]):
        """
    ...
    @typing.type_check_only
    class ExtensionInstallationDirColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.String, java.lang.Object]):
        """
    ...
    @typing.type_check_only
    class ExtensionArchiveFileColumn(docking.widgets.table.AbstractDynamicTableColumn[ExtensionRowObject, java.lang.String, java.lang.Object]):
        """
...
class ExtensionTablePanel(javax.swing.JPanel):
    ...
    def getSelectedItem(self) -> ExtensionRowObject:
        ...
    ...
    @property
    def selectedItem(self) -> ExtensionRowObject:
        ...
...
__all__ = ["ExtensionDetailsPanel", "ExtensionInstallationInfo", "ExtensionInstaller", "ExtensionRowObject", "ExtensionTableDialog", "ExtensionTableModel", "ExtensionTablePanel"]
