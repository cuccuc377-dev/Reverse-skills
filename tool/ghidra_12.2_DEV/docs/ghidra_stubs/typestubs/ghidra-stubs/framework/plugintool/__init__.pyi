...
class Plugin(ghidra.util.classfinder.ExtensionPoint, ghidra.framework.plugintool.util.PluginEventListener, ghidra.framework.plugintool.util.ServiceListener):
    ...
    * Have a constructor with exactly 1 parameter: :obj:`PluginTool`.
    *     
    ...
    ************
    ...
    All Plugin Classes **MUST END IN** "Plugin".  If not, the :obj:`ClassSearcher` will not find
    them.
    ...
    *****************
    ...
    2.     
        ...
        2.     
            1. Services listed in the ``@``:obj:`PluginInfo` annotation are automatically
    ...
    *************************
    ...
    Conversely, any services your Plugin advertises in ``@PluginInfo`` must be published via
    calls to :meth:`registerServiceProvided() <.registerServiceProvided>` in your
    ...
    * :obj:`PluginWithTransientState` - allows this Plugin to save and restore per-program
    transient state.
    """
...
class PluginWithTransientState(java.lang.Object, typing.Generic[T]):
    """
    A :obj:`Plugin` that can save and restore transient state
    ...
    back. Whatever object is returned by :meth:`getTransientState() <.getTransientState>` state will be fed back to this
    plugin via :meth:`restoreTransientState(Object) <.restoreTransientState>` after the tool state is switched back to the
    domain object that was active.
    """

    class_: typing.ClassVar[java.lang.Class]

    def getTransientState(self) -> T:
        """
    ...
    def isDisposed(self) -> bool:
        """
        Already required/provided by :obj:`Plugin`
        
        :return: true if the plugin has been disposed
        :rtype: bool
        """

    def restoreTransientState(self, state: T) -> None:
        """
        Provides the transient state object that was returned in the corresponding
        :meth:`getTransientState() <.getTransientState>` call.
        
        :param T state: the state object that was generated by this plugin's getTransientState() method.
        """
...
__all__ = ["NavigatableComponentProviderAdapter", "BusyToolException", "ComponentProviderAdapter", "DefaultPluginInstaller", "DefaultPluginPackagingProvider", "GenericStandAloneApplication", "ModalPluginTool", "Plugin", "PluginConfigurationModel", "PluginEvent", "PluginInstaller", "PluginManager", "PluginPackagingProvider", "PluginsConfiguration", "PluginTool", "PluginToolAccessUtils", "PluginToolMacAboutHandler", "PluginToolMacQuitHandler", "PluginWithTransientState", "ProjectPluginEvent", "ServiceInterfaceImplementationPair", "SettableApplicationInformationDisplayFactory", "StandAloneApplication", "StandAlonePluginTool", "ToolServicesAdapter", "ServiceProvider", "ServiceProviderDecorator", "ServiceProviderStub", "AutoConfigState", "AutoService", "PluginToolUtils"]
