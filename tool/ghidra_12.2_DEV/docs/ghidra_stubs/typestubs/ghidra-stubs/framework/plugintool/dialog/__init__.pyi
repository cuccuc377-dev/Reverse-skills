...
class KeyBindingsPanel(javax.swing.JPanel):
    ...
    @typing.type_check_only
    class KeyBindingsRenderer(docking.widgets.table.GTableCellRenderer):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class KeyBindingsTableModel(docking.widgets.table.GDynamicColumnTableModel[docking.actions.ActionBindingsDescriptor, java.lang.Object]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, actions: java.util.List[docking.actions.ActionBindingsDescriptor]) -> None:
            ...
...
class PluginInstallerDialog(docking.DialogComponentProvider):
    ...
    @typing.type_check_only
    class InstalledCellRenderer(docking.widgets.table.GBooleanCellRenderer):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class PluginInstallerTableModel(docking.widgets.table.threaded.ThreadedTableModel[ghidra.framework.plugintool.util.PluginDescription, java.util.List[ghidra.framework.plugintool.util.PluginDescription]]):
    ...
    @typing.type_check_only
    class PluginWarningColumn(docking.widgets.table.AbstractDynamicTableColumn[ghidra.framework.plugintool.util.PluginDescription, javax.swing.Icon, java.util.List[ghidra.framework.plugintool.util.PluginDescription]]):
        """
...
__all__ = ["AbstractDetailsPanel", "IconMap", "KeyBindingsPanel", "ManagePluginsDialog", "PluginDetailsPanel", "PluginInstallerDialog", "PluginInstallerTableModel", "PluginManagerComponent", "SaveToolConfigDialog", "ToolIconUrlRenderer"]
