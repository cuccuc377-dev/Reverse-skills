...
class Platform(java.lang.Enum[Platform]):
    ...
    OPENBSD_X86_64: typing.Final[Platform]
    """
    Identifies a OpenBSD x86 64-bit OS.
    """

    OPENBSD_ARM_64: typing.Final[Platform]
    """
...
class OperatingSystem(java.lang.Enum[OperatingSystem]):
    ...
    OPEN_BSD: typing.Final[OperatingSystem]
...
__all__ = ["GhidraApplicationConfiguration", "HeadlessGhidraApplicationConfiguration", "ToolUtils", "Application", "ApplicationConfiguration", "Architecture", "GenericRunInfo", "Log4jErrorLogger", "LoggingInitialization", "ModuleInitializer", "OSFileNotFoundException", "Platform", "ShutdownHookRegistry", "ShutdownPriority", "TestApplicationUtils", "ApplicationIdentifier", "ApplicationProperties", "ApplicationVersion", "GModule", "OperatingSystem", "PluggableServiceRegistry", "PluggableServiceRegistryException"]
