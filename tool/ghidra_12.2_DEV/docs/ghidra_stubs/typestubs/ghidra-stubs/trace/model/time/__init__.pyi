...
class TraceSnapshot(java.lang.Object):
    ...
    def isFork(self) -> bool:
        ...
        the minimum key is *not* considered a fork.
...
class TraceTimeManager(java.lang.Object):
    ...
    def getMostRecentFork(self, snap: typing.Union[jpype.JLong, int]) -> int:
        """
        Get the most recent fork snapshot key since a given key
         
         
        
        This searches the snapshots for one where :meth:`TraceSnapshot.isFork() <TraceSnapshot.isFork>` is true. Note that
        conventionally, negative snaps are *scratch* space. If a non-negative snap is given,
        ...
        will return :const:`Long.MIN_VALUE`, even if that snapshot does not actually exist.
    ...
    @property
    def mostRecentFork(self) -> jpype.JLong:
        ...
