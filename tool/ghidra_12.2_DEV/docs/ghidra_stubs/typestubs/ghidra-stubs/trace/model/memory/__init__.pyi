...
class TraceMemoryOperations(java.lang.Object):
    ...
    piecewise. Note that the state itself is only effective *at the starting snap* of the
    lifespan. Otherwise, the effective state is :obj:`TraceMemoryState.UNKNOWN`.
    ...
    class StatePredicate(java.lang.Enum[TraceMemoryOperations.StatePredicate], java.util.function.Predicate[TraceMemoryState]):
        """
        Built-in predicates for filtering/testing state entries
         
        
        Many methods accept an unrestricted :obj:`Predicate` on :obj:`TraceMemoryState`. However,
        use of these built-ins is strongly recommended for two reasons: 1) They handle conventional
        cases, e.g., null representing :obj:`TraceMemoryState.UNKNOWN`. 2) Caching depends on the
        implementation being able to recognize the identity of the predicate. This generally cannot
        be done with lambda methods.
        """

        class_: typing.ClassVar[java.lang.Class]
        IS_KNOWN: typing.Final[TraceMemoryOperations.StatePredicate]
        IS_ERROR: typing.Final[TraceMemoryOperations.StatePredicate]
        IS_KNOWN_OR_ERROR: typing.Final[TraceMemoryOperations.StatePredicate]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> TraceMemoryOperations.StatePredicate:
            ...

        @staticmethod
        def values() -> jpype.JArray[TraceMemoryOperations.StatePredicate]:
            ...
    ...
    def getAddressesWithState(self, span: ghidra.trace.model.Lifespan, set: ghidra.program.model.address.AddressSetView, predicate: java.util.function.Predicate[TraceMemoryState]) -> ghidra.program.model.address.AddressSetView:
        ...
        :meth:`AddressSetView.intersect(AddressSetView) <AddressSetView.intersect>` with ``set`` if a strict intersection is
        required.
        ...
        :obj:`StatePredicate.IS_KNOWN_OR_ERROR` and subtract the result from ``set``.
    ...
    def getMostRecentStates(self, within: ghidra.trace.model.TraceAddressSnapRange) -> java.lang.Iterable[java.util.Map.Entry[ghidra.trace.model.TraceAddressSnapRange, TraceMemoryState]]:
        ...
        Typically ``within`` is the box whose width is the address range and whose height is
        :meth:`Lifespan.since(long) <Lifespan.since>` a desired snap. Queries that respect forking should only extend
        as far back as the most recent forked snapshot.
         
        
        In this context, "most recent" means the latest state other than
        :obj:`TraceMemoryState.UNKNOWN`. The entries returned *can* overlap. The rule is that
        :obj:`TraceMemoryState.KNOWN` entries may *not* overlap one another. They are split
        and truncated so that they extend as far as possible into the future without overlapping. A
        :obj:`TraceMemoryState.ERROR` entry can overlap a less-recent :obj:`TraceMemoryState.KNOWN`
    ...
    def isStateEntirely(range: ghidra.program.model.address.AddressRange, stateEntries: collections.abc.Sequence, state: TraceMemoryState) -> bool:
        ...
        Each of the given entries *must* intersect the given range, or else the behavior is
        undefined. If the same range is given to :meth:`getStates(long, AddressRange) <.getStates>`, this
    ...
    @staticmethod
    def oneState(range: ghidra.program.model.address.AddressRange, states: collections.abc.Sequence) -> TraceMemoryState:
        """
        Check if the return value of :meth:`getStates(long, AddressRange) <.getStates>` or similar represents a
        ...
        collection will result in :obj:`TraceMemoryState.UNKNOWN`.
        ...
        :param ghidra.program.model.address.AddressRange range: the range to check, usually that passed to
                    :meth:`getStates(long, AddressRange) <.getStates>`.
        :param collections.abc.Sequence states: the collection returned by :meth:`getStates(long, AddressRange) <.getStates>`.
    ...
    def removeBytes(self, snap: typing.Union[jpype.JLong, int], start: ghidra.program.model.address.Address, len: typing.Union[jpype.JInt, int]) -> None:
        ...
        also deleted, i.e., set to :obj:`TraceMemoryState.UNKNOWN`.
...
class TraceMemoryState(java.lang.Enum[TraceMemoryState]):
    ...
    IMPLIED_BY_NULL: typing.Final[TraceMemoryState]

    def impliedByNull(self) -> bool:
        ...

    @staticmethod
    def orImplied(s: TraceMemoryState) -> TraceMemoryState:
        ...
...
__all__ = ["RegisterValueConverter", "RegisterValueException", "TraceMemory", "TraceMemoryFlag", "TraceMemoryManager", "TraceMemoryOperations", "TraceMemoryRegion", "TraceMemorySpace", "TraceMemorySpaceInputStream", "TraceMemoryState", "TraceOverlappedRegionException", "TraceRegister", "TraceRegisterContainer"]
