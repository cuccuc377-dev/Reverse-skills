...
class TraceBreakpointKind(java.lang.Enum[TraceBreakpointKind]):
    ...
    class TraceBreakpointKindSet(org.apache.commons.collections4.set.AbstractSetDecorator[TraceBreakpointKind]):
        ...
        class_: typing.ClassVar[java.lang.Class]
        EMPTY: typing.Final[TraceBreakpointKind.TraceBreakpointKindSet]
    ...
    class CommonSet(java.lang.Enum[TraceBreakpointKind.CommonSet]):

        class_: typing.ClassVar[java.lang.Class]
        SWX: typing.Final[TraceBreakpointKind.CommonSet]
        HWX: typing.Final[TraceBreakpointKind.CommonSet]
        READ: typing.Final[TraceBreakpointKind.CommonSet]
        WRITE: typing.Final[TraceBreakpointKind.CommonSet]
        ACCESS: typing.Final[TraceBreakpointKind.CommonSet]
        VALUES: typing.Final[java.util.List[TraceBreakpointKind.CommonSet]]

        def kinds(self) -> TraceBreakpointKind.TraceBreakpointKindSet:
            ...

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> TraceBreakpointKind.CommonSet:
            ...

        @staticmethod
        def values() -> jpype.JArray[TraceBreakpointKind.CommonSet]:
            ...
    ...
    VALUES: typing.Final[java.util.List[TraceBreakpointKind]]
...
__all__ = ["TraceBreakpointCommon", "TraceBreakpointKind", "TraceBreakpointLocation", "TraceBreakpointManager", "TraceBreakpointSpec"]
