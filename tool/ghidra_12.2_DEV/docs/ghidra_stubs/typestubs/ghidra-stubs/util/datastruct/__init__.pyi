...
class Accumulator(java.util.function.Consumer[T], typing.Generic[T]):
    """
...
class ListAccumulator(Accumulator[T], java.lang.Iterable[T], typing.Generic[T]):
    """
...
class SetAccumulator(Accumulator[T], java.lang.Iterable[T], typing.Generic[T]):
    """
...
class SetAccumulatorWrapper(Accumulator[T], typing.Generic[T]):
    """
    ...
    def __init__(self, accumulator: Accumulator[T]) -> None:
        ...
...
__all__ = ["AbstractWeakValueMap", "AbstractWeakValueNavigableMap", "Accumulator", "AccumulatorSizeException", "Array", "BitTree", "BooleanArray", "ByteArray", "ByteArrayArray", "CallbackAccumulator", "CaseInsensitiveDuplicateStringComparator", "CopyOnReadWeakSet", "CopyOnWriteWeakSet", "Counter", "DataStructureErrorHandlerFactory", "DataTable", "DoubleArray", "DoubleArrayArray", "FixedSizeHashMap", "FixedSizeStack", "FloatArray", "FloatArrayArray", "FullKeySet", "IndexRange", "IndexRangeIterator", "IntArray", "IntArrayArray", "IntArrayList", "IntIndexManager", "IntIntHashtable", "IntKeyIndexer", "IntListIndexer", "IntObjectHashtable", "IntSet", "ListAccumulator", "ListenerErrorHandler", "ListenerErrorHandlerFactory", "ListenerSet", "LongArray", "LongArrayArray", "LongArrayList", "LongArrayListIterator", "LongComparator", "LongDoubleHashtable", "LongIntHashtable", "LongKeyIndexer", "LongLongHashtable", "LongObjectHashtable", "LRUMap", "LRUSet", "ManagedDataTable", "NoSuchIndexException", "ObjectArray", "ObjectCache", "ObjectIntHashtable", "ObjectKeyIndexer", "ObjectLongHashtable", "ObjectRangeMap", "ObjectValueRange", "Prime", "PriorityQueue", "PropertySetIndexRangeIterator", "QueueStub", "RangeMap", "RedBlackEntry", "RedBlackKeySet", "RedBlackLongKeySet", "RedBlackTree", "SetAccumulator", "SetAccumulatorWrapper", "ShortArray", "ShortArrayArray", "ShortKeyIndexer", "ShortKeySet", "ShortListIndexer", "ShortLongHashtable", "ShortObjectHashtable", "ShortStringHashtable", "SizeRestrictedAccumulatorWrapper", "SoftCacheMap", "SortedRangeList", "Stack", "StringArray", "StringArrayArray", "StringIntHashtable", "StringKeyIndexer", "ThreadSafeListenerStorage", "ThreadUnsafeWeakSet", "ValueRange", "WeakDataStructureFactory", "WeakSet", "WeakStore", "WeakValueHashMap", "WeakValueTreeMap", "Duo", "Range", "CollectionChangeListener", "DefaultObservableCollection", "ObservableCollection", "PrivatelyQueuedListener"]
