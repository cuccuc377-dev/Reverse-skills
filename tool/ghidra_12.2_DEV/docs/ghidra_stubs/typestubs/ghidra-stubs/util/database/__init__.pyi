...
class DBAnnotatedObject(ghidra.program.database.DbObject):
    """
...
class DBCachedDomainObjectAdapter(ghidra.framework.data.DBDomainObjectSupport):
    ...
    def getReadWriteLock(self) -> ghidra.util.Lock:
        """
        Get the "read-write" lock
        
        :return: the lock
        :rtype: ghidra.util.Lock
        """

    @property
    def readWriteLock(self) -> ghidra.util.Lock:
        ...
...
class DBCachedObjectStore(db.util.ErrorHandler, typing.Generic[T]):
    ...
    store keeps a cache of objects using :obj:`DbCache`. See
...
class DebuggerFactoryAdapter(ghidra.program.database.DbFactory[T], typing.Generic[T]):
    """
    Maps :obj:`DBAnnotatedObjectFactory` objects into :obj:`DbFactory` objects that is needed by
    the :obj:`DbCache`.
    """

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, store: DBCachedObjectStore[T], table: db.Table, factory: DBAnnotatedObjectFactory[T]) -> None:
        ...
...
__all__ = ["AbstractDirectedLongKeyIterator", "AbstractDirectedRecordIterator", "BackwardLongKeyIterator", "BackwardRecordIterator", "DBAnnotatedObject", "DBAnnotatedObjectFactory", "DBBufferInputStream", "DBBufferOutputStream", "DBCachedDomainObjectAdapter", "DBCachedObjectIndex", "DBCachedObjectStore", "DBCachedObjectStoreEntrySet", "DBCachedObjectStoreEntrySubSet", "DBCachedObjectStoreFactory", "DBCachedObjectStoreFoundKeysValueCollection", "DBCachedObjectStoreKeySet", "DBCachedObjectStoreKeySubSet", "DBCachedObjectStoreMap", "DBCachedObjectStoreSubMap", "DBCachedObjectStoreValueCollection", "DBCachedObjectStoreValueSubCollection", "DBObjectColumn", "DBSynchronizedCollection", "DBSynchronizedIterator", "DBSynchronizedSpliterator", "DebuggerFactoryAdapter", "DirectedIterator", "DirectedLongKeyIterator", "DirectedRecordIterator", "DomainObjectLockHold", "FieldSpan", "ForwardLongKeyIterator", "ForwardRecordIterator", "KeySpan", "ObjectKey", "SchemaBuilder", "SynchronizedSpliterator"]
