...
class AbstractRStarConstraintsTree(AbstractConstraintsTree[DS, DR, NS, NR, T, Q], typing.Generic[DS, DR, NS, NR, T, Q]):
    ...
    @typing.type_check_only
    class LeastOverlap(java.lang.Comparable[AbstractRStarConstraintsTree.LeastOverlap]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, node: NR, bounds: NS, all: java.util.List[NR], areaEnlargement: typing.Union[jpype.JDouble, float]) -> None:
            ...
    ...
    @typing.type_check_only
    class IndexScore(java.lang.Record, java.lang.Comparable[AbstractRStarConstraintsTree.IndexScore]):

        class_: typing.ClassVar[java.lang.Class]

        def areaDiff(self) -> float:
            ...

        def areaSum(self) -> float:
            ...
    ...
    @typing.type_check_only
    class ReInsertInfo(java.lang.Object):

        class_: typing.ClassVar[java.lang.Class]

        def checkAndSet(self, levelFromBottom: typing.Union[jpype.JInt, int]) -> bool:
            ...
    ...
    class LevelInfo(java.lang.Object):
        ...
        def __init__(self, dstLevelFromBottom: typing.Union[jpype.JInt, int]) -> None:
            """
            Create level information
            
            :param jpype.JInt or int dstLevelFromBottom: the parent level of the destination, counting from the bottom.
        ...
        def getDstLevelFromTop(self, leafLevel: typing.Union[jpype.JInt, int]) -> int:
            ...

        def setLevelTowardTop1(self) -> AbstractRStarConstraintsTree.LevelInfo:
            ...

        @property
        def dstLevelFromTop(self) -> jpype.JInt:
            ...
...
__all__ = ["AbstractConstraintsTree", "AbstractConstraintsTreeSpatialMap", "AbstractRStarConstraintsTree", "BoundedShape", "BoundingShape", "DBTreeDataRecord", "DBTreeNodeRecord", "DBTreeRecord", "Query", "SpatialMap"]
