...
class CancelledException(UsrException):
    ...
    class_: typing.ClassVar[java.lang.Class]
    DEFAULT_MESSAGE: typing.Final = "Operation cancelled"
    ...
    def isDefaultMessage(self) -> bool:
        """
        :return: true if the message of this exception is Operation cancelled
        :rtype: bool
        """

    @property
    def defaultMessage(self) -> jpype.JBoolean:
        ...
...
__all__ = ["BadLinkException", "RollbackException", "VersionException", "UserAccessException", "ClosedException", "CryptoException", "DuplicateFileException", "DuplicateNameException", "FileInUseException", "GraphException", "InvalidInputException", "MultipleCauses", "NotEmptyException", "NotFoundException", "NotYetImplementedException", "NoValueException", "PropertyTypeMismatchException", "AssertException", "CancelledException", "IOCancelledException", "TimeoutException", "UnableToSwingException", "UsrException"]
