...
class BlockStreamHandle(java.lang.Object, typing.Generic[T]):
    ...
    def openBlockStream(self, monitor: ghidra.util.task.TaskMonitor) -> T:
        """
        Invoked by client to establish the remote connection and return 
        the opened block stream.
        
        :param ghidra.util.task.TaskMonitor monitor: monitor which will allow cancellation of transfer
...
class BufferFileHandle(java.lang.Object):
    ...
    def getInputBlockStream(self) -> InputBlockStream:
        ...
        .. seealso::
            ...
            | :obj:`BufferFileAdapter.getInputBlockStream(TaskMonitor)`
        """
    ...
    def getOutputBlockStream(self, blockCount: typing.Union[jpype.JInt, int]) -> OutputBlockStream:
        ...
        .. seealso::
            ...
            | :obj:`BufferFileAdapter.getOutputBlockStream(int, TaskMonitor)`
        """
...
class ManagedBufferFileHandle(BufferFileHandle):
    ...
    def getInputBlockStream(self, changeMapData: jpype.JArray[jpype.JByte]) -> InputBlockStream:
        ...
        .. seealso::
            ...
            | :obj:`ManagedBufferFileAdapter.getInputBlockStream(byte[], TaskMonitor)`
        """
...
__all__ = ["BlockStream", "BlockStreamHandle", "BufferFile", "BufferFileAdapter", "BufferFileBlock", "BufferFileHandle", "BufferFileManager", "BufferMgr", "BufferNode", "ChangeMap", "ChangeMapFile", "DataBuffer", "IndexProvider", "InputBlockStream", "LocalBufferFile", "LocalManagedBufferFile", "ManagedBufferFile", "ManagedBufferFileAdapter", "ManagedBufferFileHandle", "OutputBlockStream", "RecoveryFile", "RecoveryMgr", "RemoteBufferFileHandle", "RemoteManagedBufferFileHandle", "VersionFile", "VersionFileHandler"]
