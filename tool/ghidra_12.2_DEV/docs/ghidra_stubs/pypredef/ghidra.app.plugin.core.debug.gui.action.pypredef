...
class DebuggerGoToDialog(ghidra.app.plugin.core.debug.gui.breakpoint.AbstractDebuggerSleighInputDialog):
    ...
    def setLitIdMode(self, mode: ghidra.pcode.exec_.SleighUtils.LitIdMode) -> None:
        ...
...
class DebuggerGoToTrait(java.lang.Object):
    ...
    class GoToResult(java.lang.Record):
        ...
        .. seealso::
            ...
            | :obj:`DebuggerGoToTrait.goTo(String, String, LitIdMode)`
        """
    ...
    def goTo(self, spaceName: typing.Union[java.lang.String, str], offset: typing.Union[java.lang.String, str], mode: ghidra.pcode.exec_.SleighUtils.LitIdMode) -> java.util.concurrent.CompletableFuture[DebuggerGoToTrait.GoToResult]:
        """
        ...
        :param ghidra.pcode.exec_.SleighUtils.LitIdMode mode: the mode for parsing integer literals and ids
        :return: the result
    ...
    def validate(self, factory: ghidra.program.model.address.AddressFactory, spaceName: typing.Union[java.lang.String, str], offset: typing.Union[java.lang.String, str], mode: ghidra.pcode.exec_.SleighUtils.LitIdMode) -> None:
        ...
...
class DebuggerTrackLocationTrait(java.lang.Object):
    ...
    def clearTrackedLocation(self) -> None:
        ...
...
__all__ = ["BasicAutoReadMemorySpec", "BasicAutoReadMemorySpecFactory", "BasicLocationTrackingSpecFactory", "ByModuleAutoMapSpec", "ByRegionAutoMapSpec", "BySectionAutoMapSpec", "DebuggerAutoReadMemoryAction", "DebuggerGoToDialog", "DebuggerGoToTrait", "DebuggerProgramLocationActionContext", "DebuggerReadsMemoryTrait", "DebuggerTrackLocationAction", "DebuggerTrackLocationTrait", "NoneAutoMapSpec", "NoneLocationTrackingSpec", "OneToOneAutoMapSpec", "PCByRegisterLocationTrackingSpec", "PCByStackLocationTrackingSpec", "PCLocationTrackingSpec", "RegisterLocationTrackingSpec", "SPLocationTrackingSpec", "WatchLocationTrackingSpec", "WatchLocationTrackingSpecFactory"]
