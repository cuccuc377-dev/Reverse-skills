...
class AbstractActionBuilder(java.lang.Object, typing.Generic[T, C, B]):
    ...
    @typing.overload
    def buildAndInstallLocal(self, provider: docking.DialogComponentProvider) -> T:
        """
        Builds and adds the action as a local action for the given dialog provider
        
        :param docking.DialogComponentProvider provider: the dialog provider to add the action to
        :return: the newly created action
        :rtype: T
        """
