...
class AddressFieldOptionsWrappedOption(ghidra.framework.options.CustomOption):
    ...
    def displayUpperCase(self) -> bool:
        ...
    ...
    def setDisplayUpperCase(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class AnnotatedStringHandler(ghidra.util.classfinder.ExtensionPoint):
    ...
    def getPrototypeString(self, displayText: typing.Union[java.lang.String, str]) -> str:
        ...
        :param java.lang.String or str displayText: the text that may be wrapped, will not be null
        :return: the example of how this is used.
        :rtype: str
        """
    ...
    def handleMouseClick(self, text: jpype.JArray[java.lang.String], sourceNavigatable: ghidra.app.nav.Navigatable, serviceProvider: ghidra.framework.plugintool.ServiceProvider) -> bool:
        """
        ...
        :param jpype.JArray[java.lang.String] text: the constituent parts of the annotation
        :param ghidra.app.nav.Navigatable sourceNavigatable: the location in the program that was clicked.
        :param ghidra.framework.plugintool.ServiceProvider serviceProvider: the service provider for needed services.
    ...
    @typing.overload
    def modify(self, text: jpype.JArray[java.lang.String], program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address) -> jpype.JArray[java.lang.String]:
        """
        ...
        :param ghidra.program.model.address.Address addr: address of the annotation in the program
...
class CommentUtils(java.lang.Object):
    ...
    @staticmethod
    def fixupAnnotations(rawCommentText: typing.Union[java.lang.String, str], program: ghidra.program.model.listing.Program, addr: ghidra.program.model.address.Address) -> str:
        """
        ...
        :param ghidra.program.model.address.Address addr: address of comment in program
...
class LabelFieldMouseHandler(FieldMouseHandlerExtension):
    """
...
class LabelFieldSymbolLoader(java.lang.Object):
    """
    A simple class to load all symbols for a given code unit
    """

    class Symbols(java.lang.Object):
        """
        ...
        def getAllSymbols(self) -> java.util.List[ghidra.program.model.symbol.Symbol]:
            ...

        @property
        def allSymbols(self) -> java.util.List[ghidra.program.model.symbol.Symbol]:
            ...


    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, cu: ghidra.program.model.listing.CodeUnit, max: typing.Union[jpype.JInt, int], displayFunctionLabel: typing.Union[jpype.JBoolean, bool]) -> None:
        ...

    def getSymbols(self) -> LabelFieldSymbolLoader.Symbols:
        ...
    ...
    @property
    def symbols(self) -> LabelFieldSymbolLoader.Symbols:
        ...
...
class ListingFieldDescriptionProvider(docking.widgets.fieldpanel.FieldDescriptionProvider):
    ...
    def setVerbose(self, b: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
class VariableAnnotatedStringHandler(AnnotatedStringHandler):
    """
    ...
    name:
    ``    {@variable local_8} or{@variable coolVariable SomeFunction}``
    The user annotation will be converted to use address information:
    ``    {@variable Stack[0xa] FUN_1234eaea}``
    """

    @typing.type_check_only
    class VariableMatcher(java.lang.Object):

        class_: typing.ClassVar[java.lang.Class]

        def matches(self, v: ghidra.program.model.listing.Variable) -> bool:
            ...


    @typing.type_check_only
    class NameMatcher(VariableAnnotatedStringHandler.VariableMatcher):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class AddressMatcher(VariableAnnotatedStringHandler.VariableMatcher):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["AbstractOffsetFieldFactory", "AbstractOpenCloseField", "AbstractVariableFieldFactory", "AddressAnnotatedStringHandler", "AddressFieldFactory", "AddressFieldOptionsPropertyEditor", "AddressFieldOptionsWrappedOption", "AnnotatedMouseHandler", "AnnotatedStringFieldMouseHandler", "AnnotatedStringHandler", "Annotation", "AnnotationCommentPart", "AnnotationException", "ArrayElementFieldLocation", "ArrayElementPropertyEditor", "ArrayElementWrappedOption", "ArrayValuesFieldFactory", "AssignedVariableFieldFactory", "BrowserCodeUnitFormat", "BrowserCodeUnitFormatOptions", "BytesFieldFactory", "CollapsedCodeFieldFactory", "CollapsedCodeFieldMouseHandler", "CommentFieldMouseHandler", "CommentPart", "CommentUtils", "DummyFieldFactory", "EolCommentFieldFactory", "EolEnablement", "EolExtraCommentsOption", "EolExtraCommentsPropertyEditor", "ErrorFieldMouseHandler", "ErrorListingField", "FieldFactory", "FieldMouseHandler", "FieldMouseHandlerExtension", "FieldNameFieldFactory", "FieldStringInfo", "FileOffsetFieldFactory", "FunctionCallFixupFieldFactory", "FunctionOffsetFieldFactory", "FunctionOpenCloseField", "FunctionOpenCloseFieldFactory", "FunctionPurgeFieldFactory", "FunctionRepeatableCommentFieldFactory", "FunctionRepeatableCommentFieldMouseHandler", "FunctionSignatureFieldFactory", "FunctionSignatureSourceFieldFactory", "FunctionTagFieldFactory", "GhidraLocalURLAnnotatedStringHandler", "GhidraServerURLAnnotatedStringHandler", "ImagebaseOffsetFieldFactory", "ImageFactoryField", "ImageFactoryFieldMouseHandler", "IndentField", "InstructionMaskValueFieldFactory", "InvalidAnnotatedStringHandler", "LabelCodeUnitFormat", "LabelFieldFactory", "LabelFieldMouseHandler", "LabelFieldSymbolLoader", "ListingColors", "ListingField", "ListingFieldDescriptionProvider", "ListingFieldHighlightFactoryAdapter", "ListingTextField", "MemoryBlockOffsetFieldFactory", "MemoryBlockStartFieldFactory", "MnemonicFieldFactory", "MnemonicFieldMouseHandler", "NamespacePropertyEditor", "NamespaceWrappedOption", "OpenCloseField", "OpenCloseFieldFactory", "OpenCloseFieldMouseHandler", "OperandFieldFactory", "OperandFieldHelper", "OperandFieldMouseHandler", "OptionsBasedDataTypeDisplayOptions", "ParallelInstructionFieldFactory", "PcodeFieldMouseHandler", "PlateFieldFactory", "PostCommentFieldFactory", "PreCommentFieldFactory", "ProgramAnnotatedStringHandler", "RegisterFieldFactory", "RegisterTransitionFieldFactory", "ResourceFieldLocation", "SeparatorFieldFactory", "SourceMapFieldFactory", "SpaceFieldFactory", "SpacerFieldFactory", "StringCommentPart", "SubDataFieldFactory", "SymbolAnnotatedStringHandler", "ThunkedFunctionFieldFactory", "ThunkedFunctionFieldMouseHandler", "URLAnnotatedStringHandler", "VariableAnnotatedStringHandler", "VariableCommentFieldFactory", "VariableCommentFieldMouseHandler", "VariableLocFieldFactory", "VariableNameFieldFactory", "VariableOpenCloseField", "VariablesOpenCloseFieldFactory", "VariableTypeFieldFactory", "VariableXRefFieldFactory", "VariableXRefFieldMouseHandler", "VariableXRefHeaderFieldFactory", "XRefFieldFactory", "XRefFieldMouseHandler", "XRefHeaderFieldFactory"]
