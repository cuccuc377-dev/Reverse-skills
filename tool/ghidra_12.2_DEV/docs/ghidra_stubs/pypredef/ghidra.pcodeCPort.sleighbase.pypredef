...
class SleighBase(ghidra.pcodeCPort.translate.Translate, NamedSymbolProvider):
    ...
    """
    Note: The value of :obj:`.MAX_UNIQUE_SIZE` must match the corresponding value defined by
    sleighbase.cc
    """
...
__all__ = ["address_set", "NamedSymbolProvider", "SleighBase", "VarnodeSymbolCompare"]
