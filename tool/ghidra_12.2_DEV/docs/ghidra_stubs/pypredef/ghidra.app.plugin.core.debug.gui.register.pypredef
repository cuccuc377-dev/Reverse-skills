...
class DebuggerAvailableRegistersDialog(docking.ReusableDialogComponentProvider):
    ...
    class AvailableRegisterTableColumns(java.lang.Enum[DebuggerAvailableRegistersDialog.AvailableRegisterTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerAvailableRegistersDialog.AvailableRegisterTableColumns, AvailableRegisterRow]):
...
class DebuggerRegistersProvider(ghidra.framework.plugintool.ComponentProviderAdapter, ghidra.app.plugin.core.debug.gui.DebuggerProvider, docking.actions.PopupActionProvider):
    ...
    @typing.type_check_only
    class RegisterTableColumns(java.lang.Enum[DebuggerRegistersProvider.RegisterTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerRegistersProvider.RegisterTableColumns, RegisterRow]):
    ...
    @typing.type_check_only
    class RegisterValueCellEditor(docking.widgets.table.HexBigIntegerTableCellEditor):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class RegisterDataTypeEditor(ghidra.base.widgets.table.AbstractDataTypeTableCellEditor):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["AvailableRegisterRow", "DebuggerAvailableRegistersActionContext", "DebuggerAvailableRegistersDialog", "DebuggerRegisterActionContext", "DebuggerRegisterColumnFactory", "DebuggerRegistersPlugin", "DebuggerRegistersProvider", "RegisterRow"]
