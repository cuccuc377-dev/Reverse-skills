...
class CodeBrowserPlugin(AbstractCodeBrowserPlugin[CodeViewerProvider], ghidra.framework.plugintool.PluginWithTransientState[CodeBrowserPlugin.CodeBrowserTransientState]):

    @typing.type_check_only
    class CodeBrowserTransientState(java.lang.Record):
        ...
        def position(self) -> docking.widgets.fieldpanel.support.ViewerPosition:
            ...
...
__all__ = ["AbstractCodeBrowserPlugin", "AddressRangeBytesTableColumn", "AddressRangeCodeUnitTableColumn", "AddressRangeInfo", "AddressRangeTableModel", "CodeBrowserPlugin", "CodeBrowserPluginInterface", "CodeBrowserSelectionPlugin", "CodeViewerActionContext", "CodeViewerLocationMemento", "CodeViewerProvider", "LayeredColorModel", "ListingMiddleMouseHighlightProvider", "MarkAndSelectionAction", "MarkerServiceBackgroundColorModel", "OtherPanelContext", "SelectEndpointsAction"]
