...
class DBTraceMemorySpace(ghidra.trace.model.memory.TraceMemorySpace, InternalTraceMemoryOperations, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    @typing.type_check_only
    class AddressSetStateCacheKey(java.lang.Record):
        ...
        def predicate(self) -> ghidra.trace.model.memory.TraceMemoryOperations.StatePredicate:
            ...
    ...
    @typing.type_check_only
    class MostRecentStateCacheKey(java.lang.Record):
    ...
    BLOCK_CACHE_SIZE: typing.Final = 10
    BLOCKS_PER_BUFFER: typing.Final = 256
    STATE_BLOCK_SHIFT: typing.Final = 8
    STATE_BLOCK_SIZE: typing.Final = 256
    STATE_BLOCK_MASK: typing.Final = -256
    STATE_CACHE_SIZE: typing.Final = 500
    STATE_MR_CACHE_SIZE: typing.Final = 100
    ...
    def paint(self, painter: ghidra.trace.database.map.DBTraceAddressSnapRangePropertyMapTree.Painter, depth: typing.Union[jpype.JInt, int]) -> None:
        """
        For developers and testers.
        """
...
class InternalTraceMemoryOperations(ghidra.trace.model.memory.TraceMemoryOperations):
    ...
    @staticmethod
    def requireOne(range: ghidra.program.model.address.AddressRange, states: collections.abc.Sequence, register: ghidra.program.model.lang.Register) -> ghidra.trace.model.memory.TraceMemoryState:
        ...
...
__all__ = ["DBTraceEmptyMemBuffer", "DBTraceMemBuffer", "DBTraceMemoryBlockEntry", "DBTraceMemoryBufferEntry", "DBTraceMemoryManager", "DBTraceMemoryRegion", "DBTraceMemorySpace", "DBTraceMemoryStateEntry", "DBTraceObjectMemory", "DBTraceObjectRegister", "DBTraceObjectRegisterContainer", "InternalTraceMemoryOperations"]
