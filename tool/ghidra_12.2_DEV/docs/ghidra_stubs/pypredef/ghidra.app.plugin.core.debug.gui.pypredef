...
class DebuggerBlockChooserDialog(docking.ReusableDialogComponentProvider):
    ...
    @typing.type_check_only
    class MemoryBlockTableColumns(java.lang.Enum[DebuggerBlockChooserDialog.MemoryBlockTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerBlockChooserDialog.MemoryBlockTableColumns, DebuggerBlockChooserDialog.MemoryBlockRow]):
...
class DebuggerResources(java.lang.Object):
    ...
    class SaveTraceAsAction(java.lang.Object):

        class_: typing.ClassVar[java.lang.Class]
        NAME: typing.Final = "Save Trace As"
        DESCRIPTION: typing.Final = "Rename and save the selected trace"
        ICON: typing.Final[javax.swing.Icon]
        GROUP: typing.Final = "Dbg7. Trace"
        HELP_ANCHOR: typing.Final = "save_trace_as"
...
__all__ = ["AbstractDebuggerMapProposalDialog", "AbstractDebuggerParameterDialog", "DebuggerBlockChooserDialog", "DebuggerByteSource", "DebuggerLocationLabel", "DebuggerProvider", "DebuggerResources", "DebuggerSearchRegionFactory", "DebuggerSnapActionContext", "InvokeActionEntryAction", "MultiProviderSaveBehavior", "PasteIntoTargetMixin"]
