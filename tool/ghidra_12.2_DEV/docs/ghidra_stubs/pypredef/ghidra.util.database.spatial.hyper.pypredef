...
class Dimension(java.lang.Object, typing.Generic[T, P, B]):
    ...
    def distance(self, upper: T, lower: T) -> float:
        ...
...
__all__ = ["AbstractHyperBoxQuery", "AbstractHyperRStarTree", "Dimension", "EuclideanHyperSpace", "HyperBox", "HyperDirection", "HyperPoint", "LongDimension", "StringDimension", "ULongDimension"]
