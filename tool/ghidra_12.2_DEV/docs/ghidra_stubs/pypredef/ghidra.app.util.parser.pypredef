...
class FunctionSignatureParser(java.lang.Object):
    ...
    class FsParseResult(java.lang.Record):
        """
        ...
        def __init__(self, namespace: ghidra.app.util.SymbolPath, functionDefinition: ghidra.program.model.data.FunctionDefinitionDataType) -> None:
            ...

        def equals(self, o: java.lang.Object) -> bool:
            ...

        def functionDefinition(self) -> ghidra.program.model.data.FunctionDefinitionDataType:
            ...

        def hashCode(self) -> int:
            ...

        def namespace(self) -> ghidra.app.util.SymbolPath:
            ...
    ...
    def parseWithNamespace(self, originalSignature: ghidra.program.model.listing.FunctionSignature, signatureText: typing.Union[java.lang.String, str]) -> FunctionSignatureParser.FsParseResult:
        ...
