...
class Lifespan(generic.Span[java.lang.Long, Lifespan], java.lang.Iterable[java.lang.Long]):
    ...
    def since(snap: typing.Union[jpype.JLong, int]) -> Lifespan:
        ...
        :obj:`Long.MIN_VALUE`. Otherwise, the lower endpoint is 0 to exclude scratch space.
...
__all__ = ["AddressSnap", "DefaultAddressSnap", "DefaultTraceLocation", "DefaultTraceSpan", "ImmutableTraceAddressSnapRange", "Lifespan", "Trace", "TraceAddressSnapRange", "TraceAddressSnapSpace", "TraceChangeSet", "TraceClosedException", "TraceDomainObjectListener", "TraceExecutionState", "TraceLocation", "TraceOptionsManager", "TraceSpan", "TraceTimeViewport", "TraceUniqueObject", "TraceUserData"]
