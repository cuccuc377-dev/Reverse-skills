...
class ActionBindingsDescriptor(java.lang.Object):
    """
    An interface that allows the :obj:`KeyBindingsModel` API to provide key and mouse binding information
    ...
    @property
    def bindingText(self) -> java.lang.String:
        ...
...
class KeyBindingsModel(java.lang.Object):
    """
    ...
    class KeyBindingState(ActionBindingsDescriptor):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class UnregisteredActionKeyBindingState(KeyBindingsModel.KeyBindingState):
        """
    ...
    @typing.type_check_only
    class ActionKeyBindingState(KeyBindingsModel.KeyBindingState):
        """
    ...
    def getActionBindings(self) -> java.util.List[ActionBindingsDescriptor]:
        ...
    ...
    @property
    def actionBindings(self) -> java.util.List[ActionBindingsDescriptor]:
        ...
...
__all__ = ["ActionAdapter", "ActionBindingsDescriptor", "AutoGeneratedDockingAction", "DockingToolActions", "KeyBindingsModel", "KeyBindingUtils", "KeyEntryDialog", "PopupActionProvider", "SetKeyBindingAction", "SharedActionRegistry", "SharedDockingActionPlaceholder", "SharedStubKeyBindingAction", "ToolActions"]
