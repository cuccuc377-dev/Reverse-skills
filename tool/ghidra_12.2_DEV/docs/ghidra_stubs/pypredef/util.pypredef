...
class HistoryList(java.lang.Object, typing.Generic[T]):
    ...
    If nulls are not allowed, then any calls to :meth:`add(Object) <.add>` a null value will be ignored.
    ...
    def add(self, t: T) -> None:
        ...
        After this call, the :meth:`current history item <.getCurrentHistoryItem>` will be the 
        newly added item.
        ...
        by using  :meth:`Swing.runLater(Runnable) <Swing.runLater>`.
        
        :param T t: the item to add.
        """

    def addReplace(self, t: T) -> None:
        """
        Performs an :meth:`add(Object) <.add>` after removing the last item in the history, which is 
    ...
    def setAllowNulls(self, allowNulls: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        value will be stored in this list **only as the last item**.  See the class javadoc for 
        more info.
...
__all__ = ["CollectionUtils", "HistoryList"]
