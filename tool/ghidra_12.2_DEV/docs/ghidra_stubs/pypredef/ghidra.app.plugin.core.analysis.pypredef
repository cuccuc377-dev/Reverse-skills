...
class OneShotAnalysisCommand(ghidra.framework.cmd.BackgroundCommand[ghidra.program.model.listing.Program], AutoAnalysisManagerListener):
    """
    Background task to artificially kick off Auto analysis by
    calling anything that analyzes bytes.
    """
...
class SourceLanguageAnalyzer(ghidra.app.services.AbstractAnalyzer):
    """
    ...
    def __init__(self) -> None:
        """
        Creates a new :obj:`SourceLanguageAnalyzer`
        """
...
__all__ = ["AbstractDemanglerAnalyzer", "AnalysisBackgroundCommand", "AnalysisEnablementTableModel", "AnalysisOptionsDialog", "AnalysisOptionsEditor", "AnalysisOptionsUpdater", "AnalysisPanel", "AnalysisScheduler", "AnalysisTask", "AnalysisTaskList", "AnalysisWorker", "AnalyzeAllOpenProgramsTask", "AnalyzeProgramStrategy", "AnalyzerEnablementState", "ApplyDataArchiveAnalyzer", "ArmSymbolAnalyzer", "AutoAnalysisManager", "AutoAnalysisManagerListener", "AutoAnalysisPlugin", "CliMetadataTokenAnalyzer", "ConstantPropagationAnalyzer", "ConstantPropagationContextEvaluator", "DataOperandReferenceAnalyzer", "DefaultDataTypeManagerService", "DWARFAnalyzer", "ElfScalarOperandAnalyzer", "EmbeddedMediaAnalyzer", "ExternalSymbolResolverAnalyzer", "FindNoReturnFunctionsAnalyzer", "FindPossibleReferencesPlugin", "FindReferencesTableModel", "GolangStringAnalyzer", "GolangSymbolAnalyzer", "MachoFunctionStartsAnalyzer", "MinGWPseudoRelocationHandler", "MinGWPseudoRelocList", "MingwRelocationAnalyzer", "NonReturningFunctionNames", "NoReturnFunctionAnalyzer", "OneShotAnalysisCommand", "OperandReferenceAnalyzer", "PefAnalyzer", "PefDebugAnalyzer", "ProjectPathChooserEditor", "RegisterContextBuilder", "ScalarOperandAnalyzer", "SegmentedCallingConventionAnalyzer", "SourceLanguageAnalyzer", "StoredAnalyzerTimes", "StoredAnalyzerTimesPropertyEditor", "TransientProgramProperties", "UpdateAlignmentAction", "ReferenceAddressPair", "ConventionAnalysisDecompileConfigurer", "DecompilerCallConventionAnalyzer", "DecompilerFunctionAnalyzer", "DecompilerSwitchAnalyzer", "SwitchAnalysisDecompileConfigurer"]
