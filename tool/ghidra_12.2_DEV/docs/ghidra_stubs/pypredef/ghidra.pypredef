...
class GhidraRun(GhidraLaunchable):
    ...
    **Note**: The Plugin path is a user preference that
    ...
    class LaunchArguments(java.lang.Record):
        """
...
__all__ = ["GhidraException", "GhidraOptions", "GhidraRun", "GhidraThreadGroup", "JarRun", "JShellRun", "SoftwareModelingInitializer", "MiscellaneousPluginPackage", "ProjectInitializer", "SwingExceptionHandler", "Ghidra", "GhidraApplicationLayout", "GhidraClassLoader", "GhidraJarApplicationLayout", "GhidraLaunchable", "GhidraLauncher", "GhidraTestApplicationLayout"]
