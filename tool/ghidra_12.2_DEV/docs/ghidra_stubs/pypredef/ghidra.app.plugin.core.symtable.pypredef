...
class AbstractSymbolTableModel(ghidra.util.table.AddressBasedTableModel[SymbolRowObject]):
    ...
    @typing.type_check_only
    class RenameTask(ghidra.util.task.Task):
...
class SymbolTablePlugin(ghidra.framework.plugintool.Plugin, SymbolTableService):
    """
    ...
    @typing.type_check_only
    class LabelFieldSymbolModel(TransientSymbolTableModel):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, sp: ghidra.framework.plugintool.ServiceProvider, program: ghidra.program.model.listing.Program, rowObjects: java.util.HashSet[SymbolRowObject]) -> None:
            ...

        def setData(self, rowObjects: java.util.HashSet[SymbolRowObject]) -> None:
            ...
...
class SymbolTableService(java.lang.Object):
    """
    Service for showing :obj:`Symbol`s in a table.
    """

    class_: typing.ClassVar[java.lang.Class]

    def showSymbols(self, codeUnit: ghidra.program.model.listing.CodeUnit) -> ghidra.app.plugin.core.table.TableComponentProvider[SymbolRowObject]:
        """
        Shows all symbols and offcut symbols contained in the given code unit.
        
        :param ghidra.program.model.listing.CodeUnit codeUnit: the code unit
        :return: the table provider that is shown
        :rtype: ghidra.app.plugin.core.table.TableComponentProvider[SymbolRowObject]
        """
...
__all__ = ["AbstractSymbolTableModel", "DeletedSymbolRowObject", "FilterDialog", "NewSymbolFilter", "ReferencePanel", "ReferenceProvider", "ReferenceTableContext", "SymbolEditor", "SymbolFilter", "SymbolPanel", "SymbolProvider", "SymbolReferenceModel", "SymbolRenderer", "SymbolRowObject", "SymbolRowObjectToAddressTableRowMapper", "SymbolRowObjectToProgramLocationTableRowMapper", "SymbolTableDnDAdapter", "SymbolTableDragProvider", "SymbolTableModel", "SymbolTablePlugin", "SymbolTableService", "TransientSymbolTableDnDAdapter", "TransientSymbolTableModel"]
