...
class SourceMapFieldHover(ghidra.app.plugin.core.hover.AbstractConfigurableHover, ListingHoverService):
    """
...
class SourceMapFieldHoverPlugin(ghidra.framework.plugintool.Plugin):
    """
...
__all__ = ["DataTypeListingHover", "DataTypeListingHoverPlugin", "FunctionSignatureListingHover", "FunctionSignatureListingHoverPlugin", "LabelListingHover", "LabelListingHoverPlugin", "ListingHoverService", "ProgramAddressRelationshipListingHover", "ProgramAddressRelationshipListingHoverPlugin", "ReferenceListingHover", "ReferenceListingHoverPlugin", "ScalarOperandListingHover", "ScalarOperandListingHoverPlugin", "SourceMapFieldHover", "SourceMapFieldHoverPlugin", "TruncatedTextListingHover", "TruncatedTextListingHoverPlugin"]
