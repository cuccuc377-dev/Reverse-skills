...
class BookmarkDB(ghidra.program.database.DbObject, ghidra.program.model.listing.Bookmark):

    class_: typing.ClassVar[java.lang.Class]

    def isOwnedBy(self, bookmarkDBManager: BookmarkDBManager) -> bool:
        ...
    ...
    @property
    def ownedBy(self) -> jpype.JBoolean:
        ...
...
class BookmarkDBManager(ghidra.program.model.listing.BookmarkManager, db.util.ErrorHandler, ghidra.program.database.ManagerDB):
    ...
    @typing.type_check_only
    class BookmarkFactory(ghidra.program.database.DbFactory[BookmarkDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class BookmarkTypes(java.lang.Object):
    """
...
__all__ = ["BookmarkDB", "BookmarkDBAdapter", "BookmarkDBAdapterV0", "BookmarkDBAdapterV1", "BookmarkDBAdapterV2", "BookmarkDBAdapterV3", "BookmarkDBManager", "BookmarkTypeDB", "BookmarkTypeDBAdapter", "BookmarkTypeDBAdapterNoTable", "BookmarkTypeDBAdapterV0", "BookmarkTypes", "EmptyAddressIterator", "OldBookmark", "OldBookmarkManager"]
