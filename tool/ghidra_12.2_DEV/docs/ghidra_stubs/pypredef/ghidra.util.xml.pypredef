...
class XmlUtilities(java.lang.Object):
    ...
    def fromString(s: typing.Union[java.lang.String, str]) -> org.jdom2.Element:
        ...
        :param java.lang.String or str s: the xml string
        :return: an element
        :rtype: org.jdom2.Element
        :raises JDOMException: if there is an exception building the element
        :raises IOException: if there is an exception building the element
        """
