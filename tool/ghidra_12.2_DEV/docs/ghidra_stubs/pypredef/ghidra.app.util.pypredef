...
I = typing.TypeVar("I")
OptionType = typing.TypeVar("OptionType")
R = typing.TypeVar("R")
S = typing.TypeVar("S")
T = typing.TypeVar("T")
...
class AbstractOptionBuilder(java.lang.Object, typing.Generic[ValueType, OptionType]):
    """
    A class to build :obj:`AbstractOption`s
    """
    ...
    def __init__(self, name: typing.Union[java.lang.String, str]) -> None:
        """
        Creates a new :obj:`AbstractOptionBuilder`
        
        :param java.lang.String or str name: The name of the :obj:`Option` to be built
        """

    def build(self) -> OptionType:
        """
        :return: a new :obj:`AbstractOption` based on the current state of this 
        :obj:`AbstractOptionBuilder`
        :rtype: OptionType
        """

    def commandLineArgument(self, arg: typing.Union[java.lang.String, str]) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets the :obj:`Option`'s command line argument
        
        :param java.lang.String or str arg: The :obj:`Option`'s command line argument
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """

    def description(self, desc: typing.Union[java.lang.String, str]) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets the :obj:`Option`'s description
        
        :param java.lang.String or str desc: The :obj:`Option`'s description
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """

    def group(self, g: typing.Union[java.lang.String, str]) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets the :obj:`Option`'s group
        
        :param java.lang.String or str g: The :obj:`Option`'s group
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """

    def hidden(self, hide: typing.Union[jpype.JBoolean, bool]) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets whether or not the :obj:`Option` is hidden
        
        :param jpype.JBoolean or bool hide: True if the :obj:`Option` should be hidden; otherwise, false
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """

    def stateKey(self, key: typing.Union[java.lang.String, str]) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets the :obj:`Option`'s state key
        
        :param java.lang.String or str key: The :obj:`Option`'s state key
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """

    def value(self, v: ValueType) -> AbstractOptionBuilder[ValueType, OptionType]:
        """
        Sets the :obj:`Option`'s value
        
        :param ValueType v: The :obj:`Option`'s value
        :return: This :obj:`AbstractOptionBuilder`
        :rtype: AbstractOptionBuilder[ValueType, OptionType]
        """
...
class NamespaceCache(java.lang.Object):
    ...
    Note: This class is not currently multi-threaded.  Accesses are expected to be on the Swing
    thread.
    """
...
class NamespaceChooserDialog(docking.DialogComponentProvider):
    ...
    @property
    def namespaceText(self) -> java.lang.String:
        ...
...
class Option(java.lang.Object):
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any]) -> None:
        ...
        :param java.lang.String or str name: the name of the option
        :param java.lang.Class[typing.Any] valueClass: valueClass the type of the option value
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], value: java.lang.Object, valueClass: java.lang.Class[typing.Any], arg: typing.Union[java.lang.String, str]) -> None:
        ...
        :param java.lang.String or str name: the name of the option
        :param java.lang.Class[typing.Any] valueClass: valueClass the type of the option value, which should match ``<T>``
        :param java.lang.Object value: the value of the option (could be ``null``)
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any], value: java.lang.Object, arg: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str]) -> None:
        ...
        :param java.lang.Object value: the value of the option (could be ``null``)
        :param java.lang.String or str arg: the option's command line argument (could be ``null``)
        :param java.lang.String or str group: the name for group of options (could be ``null``)
    ...
    def __init__(self, name: typing.Union[java.lang.String, str], valueClass: java.lang.Class[typing.Any], value: java.lang.Object, arg: typing.Union[java.lang.String, str], group: typing.Union[java.lang.String, str], stateKey: typing.Union[java.lang.String, str], hidden: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        :param java.lang.String or str arg: the option's command line argument (could be ``null``)
        :param java.lang.String or str group: the name for group of options (could be ``null``)
        :param java.lang.String or str stateKey: the state key name (could be ``null``)
    ...
    def copy(self) -> Option:
        """
        :return: a copy of this :obj:`Option` object
        :rtype: Option
        
         
        
        NOTE: :obj:`Option` subclasses should always overwrite this method so they can return 
        their exact type, instead of the more generic :obj:`Option` type.
    ...
    def getCustomEditorComponent(self, addressFactoryService: AddressFactoryService) -> java.awt.Component:
        """
        Override if you want to provide a custom widget for selecting your options. 
         
        
        Important! If you override this you MUST also override the :meth:`copy() <.copy>` method so it 
        returns a new instance of your custom editor.
        
        :param AddressFactoryService addressFactoryService: The :obj:`AddressFactoryService`
        :return: the custom editor :obj:`Component`, or ``null`` if there isn't one
    ...
    @staticmethod
    def newAddress(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.AddressOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.AddressOption.Builder`
        :rtype: ghidra.app.util.importer.options.AddressOption.Builder
    ...
    @staticmethod
    def newAddressSpace(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.AddressSpaceOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.AddressSpaceOption.Builder`
        :rtype: ghidra.app.util.importer.options.AddressSpaceOption.Builder
    ...
    @staticmethod
    def newBoolean(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.BooleanOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.BooleanOption.Builder`
        :rtype: ghidra.app.util.importer.options.BooleanOption.Builder
    ...
    @staticmethod
    def newDomainFile(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.DomainFileOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.DomainFileOption.Builder`
        :rtype: ghidra.app.util.importer.options.DomainFileOption.Builder
    ...
    @staticmethod
    def newDomainFolder(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.DomainFolderOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.DomainFolderOption.Builder`
        :rtype: ghidra.app.util.importer.options.DomainFolderOption.Builder
    ...
    @staticmethod
    def newHexLong(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.HexLongOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.HexLongOption.Builder`
        :rtype: ghidra.app.util.importer.options.HexLongOption.Builder
    ...
    @staticmethod
    def newInteger(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.IntegerOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.IntegerOption.Builder`
        :rtype: ghidra.app.util.importer.options.IntegerOption.Builder
    ...
    @staticmethod
    def newString(name: typing.Union[java.lang.String, str]) -> ghidra.app.util.importer.options.StringOption.Builder:
        """
        :return: a new :obj:`ghidra.app.util.importer.options.StringOption.Builder`
        :rtype: ghidra.app.util.importer.options.StringOption.Builder
    ...
    def setOptionListener(self, listener: OptionListener) -> None:
        ...
        :param OptionListener listener: The :obj:`OptionListener` to set
        """
    ...
    def setValue(self, object: java.lang.Object) -> None:
        ...
        :raises java.lang.IllegalArgumentException: if the type of the object doesn't not match this option's
        value class
        """
...
__all__ = ["AbstractOptionBuilder", "AddEditDialog", "AddressFactoryService", "AddressInput", "AddressSetEditorPanel", "ByteCopier", "ClipboardType", "CodeUnitInfo", "CodeUnitInfoTransferable", "ColorAndStyle", "CommentTypes", "DataTypeNamingUtil", "DomainObjectService", "EditFieldNameDialog", "EolComments", "FunctionXrefsTableModel", "GhidraFileOpenDataFlavorHandlerService", "HelpTopics", "HexLong", "ListingHighlightProvider", "MemoryBlockUtils", "NamespaceCache", "NamespaceChooserDialog", "NamespaceDropDownModel", "Option", "OptionException", "OptionListener", "OptionsDialog", "OptionsEditorPanel", "OptionUtils", "OptionValidator", "Permissions", "ProcessorInfo", "ProgramDropProvider", "RefRepeatComment", "SearchConstants", "SelectionTransferable", "SelectionTransferData", "SymbolInspector", "ToolTipUtils", "XReferenceUtil", "XReferenceUtils", "NamespaceUtils", "PseudoCodeUnit", "PseudoData", "PseudoDataComponent", "PseudoDisassembler", "PseudoDisassemblerContext", "PseudoFlowProcessor", "PseudoInstruction", "RepeatInstructionByteTracker", "SymbolPath", "SymbolPathParser", "FileOpenDataFlavorHandler", "FileOpenDropHandler", "GenericHelpTopics", "DataTypeDependencyOrderer", "DecompilerConcurrentQ"]
