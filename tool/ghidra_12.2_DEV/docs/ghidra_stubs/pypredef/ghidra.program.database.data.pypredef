...
@typing.type_check_only
class CategoryDB(ghidra.program.database.DbObject, ghidra.program.model.data.Category):
    """
...
@typing.type_check_only
class DataTypeDB(ghidra.program.database.DbObject, ghidra.program.model.data.DataType):
    """
...
class DataTypeManagerDB(ghidra.program.model.data.DataTypeManager):
    ...
    * It is important that the use of :meth:`DataType.clone(DataTypeManager) <DataType.clone>`
    ...
    @typing.type_check_only
    class CategoryFactory(ghidra.program.database.DbFactory[CategoryDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class ArchiveFactory(ghidra.program.database.DbFactory[SourceArchiveDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class DtFactory(ghidra.program.database.DbFactory[DataTypeDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    def fixupComposites(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        Fixup all composites and their components which may be affected by a data organization
...
class DataTypeUtilities(java.lang.Object):
    ...
    @staticmethod
    def getTypedefReplacement(typedef: ghidra.program.model.data.TypeDef, enforceSizeMatch: typing.Union[jpype.JBoolean, bool]) -> ghidra.program.model.data.DataType:
        """
        Get a BuiltIn :obj:`TypeDef` replacement, if one exists, for the specified fabricated 
        typedef.  It is important that the supplied typedef has the correct target 
        :obj:`DataTypeManager` and associated :obj:`DataOrganization` so that a proper replacement 
        ...
        :param ghidra.program.model.data.TypeDef typedef: :obj:`TypeDef` data type to consider for replacement
        :param jpype.JBoolean or bool enforceSizeMatch: if true, size of replacement must match specified typedef
        :return: replacement data type or the original typedef if a replacement was not found
        :rtype: ghidra.program.model.data.DataType
        :raises IllegalArgumentException: if typedef was not constructed or cloned for a specific
        data type manager.
        """
...
@typing.type_check_only
class EnumValues(java.lang.Object):
    """
    Immutable class to hold the name/values for an :obj:`EnumDB` object. It is created lazily by an
...
class SourceArchiveDB(ghidra.program.database.DbObject, ghidra.program.model.data.SourceArchive):
...
__all__ = ["ArrayDB", "ArrayDBAdapter", "ArrayDBAdapterV0", "ArrayDBAdapterV1", "BitFieldDBDataType", "BuiltinDBAdapter", "BuiltinDBAdapterV0", "CallingConventionDBAdapter", "CallingConventionDBAdapterNoTable", "CallingConventionDBAdapterV0", "CategoryDB", "CategoryDBAdapter", "CategoryDBAdapterV0", "ComponentDBAdapter", "ComponentDBAdapterV0", "CompositeDB", "CompositeDBAdapter", "CompositeDBAdapterV0", "CompositeDBAdapterV1", "CompositeDBAdapterV2V4", "CompositeDBAdapterV5V6", "DataTypeArchiveTransformer", "DataTypeArchiveTransformerPanel", "DataTypeComponentDB", "DataTypeDB", "DataTypeIDConverter", "DataTypeManagerDB", "DataTypeProxyComponentDB", "DataTypeSettingsDB", "DataTypeUtilities", "EnumDB", "EnumDBAdapter", "EnumDBAdapterNoTable", "EnumDBAdapterV0", "EnumDBAdapterV1", "EnumSignedState", "EnumValueDBAdapter", "EnumValueDBAdapterNoTable", "EnumValueDBAdapterV0", "EnumValueDBAdapterV1", "EnumValues", "FunctionDefinitionDB", "FunctionDefinitionDBAdapter", "FunctionDefinitionDBAdapterNoTable", "FunctionDefinitionDBAdapterV0", "FunctionDefinitionDBAdapterV1", "FunctionDefinitionDBAdapterV2", "FunctionParameterAdapter", "FunctionParameterAdapterNoTable", "FunctionParameterAdapterV0", "FunctionParameterAdapterV1", "LazyLoadingCachingMap", "ParameterDefinitionDB", "ParentChildAdapter", "ParentChildDBAdapterNoTable", "ParentChildDBAdapterV0", "PointerDB", "PointerDBAdapter", "PointerDBAdapterV0", "PointerDBAdapterV1", "PointerDBAdapterV2", "PointerTypedefInspector", "ProgramBasedDataTypeManagerDB", "ProgramDataTypeManager", "SettingDB", "SettingsCache", "SettingsDBAdapter", "SettingsDBAdapterV0", "SettingsDBAdapterV1", "SourceArchiveAdapter", "SourceArchiveAdapterNoTable", "SourceArchiveAdapterV0", "SourceArchiveDB", "SourceArchiveUpgradeMap", "StructureDB", "TypedefDB", "TypedefDBAdapter", "TypedefDBAdapterV0", "TypedefDBAdapterV1", "TypedefDBAdapterV2", "UnionDB"]
