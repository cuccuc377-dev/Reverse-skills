...
class TraceStackFrame(ghidra.trace.model.target.iface.TraceObjectInterface):
    ...
    def getStackPointer(self, snap: typing.Union[jpype.JLong, int]) -> ghidra.program.model.address.Address:
        """
    ...
    def setStackPointer(self, span: ghidra.trace.model.Lifespan, sp: ghidra.program.model.address.Address) -> None:
        """
        Set the stack pointer over the given span
        
        :param ghidra.trace.model.Lifespan span: the span
        :param ghidra.program.model.address.Address sp: the stack pointer
        """
...
__all__ = ["TraceStack", "TraceStackFrame", "TraceStackManager"]
