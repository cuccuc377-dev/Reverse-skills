...
@typing.type_check_only
class OverlayMessagePainter(java.lang.Object):
    """
...
__all__ = ["DecompilePlugin", "DecompilerActionContext", "DecompilerClipboardProvider", "DecompilerLocationMemento", "DecompilerProvider", "DisplayTypeCastsAction", "OverlayMessagePainter", "PrimaryDecompilerProvider"]
