...
class Abstract2DRStarTree(ghidra.util.database.spatial.AbstractRStarConstraintsTree[DS, DR, NS, NR, T, Q], typing.Generic[X, Y, DS, DR, NS, NR, T, Q]):
    ...
    class XAxis(java.util.Comparator[NS], typing.Generic[X, Y, NS]):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, space: EuclideanSpace2D[X, Y]) -> None:
            ...


    class YAxis(java.util.Comparator[NS], typing.Generic[X, Y, NS]):
...
__all__ = ["Abstract2DRStarTree", "AbstractRectangle2DQuery", "EuclideanSpace2D", "ImmutablePoint2D", "ImmutableRectangle2D", "Point2D", "Rectangle2D", "Rectangle2DDirection"]
