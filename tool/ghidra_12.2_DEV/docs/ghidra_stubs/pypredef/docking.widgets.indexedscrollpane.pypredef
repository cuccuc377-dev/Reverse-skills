...
class IndexedScrollPane(javax.swing.JPanel, IndexScrollListener):
    ...
    def getViewExtentSize(self) -> java.awt.Dimension:
        ...
    ...
    @property
    def viewExtentSize(self) -> java.awt.Dimension:
        ...
...
__all__ = ["DefaultViewToIndexMapper", "IndexedScrollable", "IndexedScrollPane", "IndexScrollListener", "PreMappedViewToIndexMapper", "UniformViewToIndexMapper", "ViewToIndexMapper"]
