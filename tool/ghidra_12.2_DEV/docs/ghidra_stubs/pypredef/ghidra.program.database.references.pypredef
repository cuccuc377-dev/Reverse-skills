...
class ReferenceDBManager(ghidra.program.model.symbol.ReferenceManager, ghidra.program.database.ManagerDB, db.util.ErrorHandler):
    ...
    @typing.type_check_only
    class VariableReferences(java.lang.Object):
        ...
        class_: typing.ClassVar[java.lang.Class]
    ...
    @typing.type_check_only
    class FromReferenceFactory(ghidra.program.database.DbFactory[RefList]):
        ...
        class_: typing.ClassVar[java.lang.Class]


    @typing.type_check_only
    class ToReferenceFactory(ghidra.program.database.DbFactory[RefList]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class RefList(ghidra.program.database.DbObject):

    class_: typing.ClassVar[java.lang.Class]

    def checkRefListSize(self, cache: ghidra.program.database.DbCache[RefList], newSpaceRequired: typing.Union[jpype.JInt, int]) -> RefList:
        """
        ...
        :param ghidra.program.database.DbCache[RefList] cache: RefList object cache
...
__all__ = ["BigRefListV0", "EmptyMemReferenceIterator", "EntryPointReferenceDB", "ExternalReferenceDB", "FromAdapter", "FromAdapterSharedTable", "FromAdapterV0", "MemReferenceDB", "OffsetReferenceDB", "OldStackRefDBAdpater", "RecordAdapter", "ReferenceDB", "ReferenceDBManager", "RefList", "RefListFlagsV0", "RefListV0", "ShiftedReferenceDB", "StackReferenceDB", "ToAdapter", "ToAdapterSharedTable", "ToAdapterV0", "ToAdapterV1"]
