...
class PcodeCompile(java.lang.Object):
    ...
    def findSymbol(self, loc: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str]) -> ghidra.pcodeCPort.slghsymbol.SleighSymbol:
        ...
    ...
    def parseIntegerLiteral(self, loc: ghidra.sleigh.grammar.Location, text: typing.Union[java.lang.String, str]) -> ghidra.sleigh.grammar.RadixBigInteger:
        ...
...
class SleighCompile(ghidra.pcodeCPort.sleighbase.SleighBase):
    ...
    *.slaspec) files.
    ...
    def setOptions(self, options: SleighCompileOptions) -> None:
        ...
...
class SleighCompileLauncher(ghidra.GhidraLaunchable):
    ...
    @staticmethod
    def compileAll(options: SleighCompileOptions) -> int:
        ...

    @staticmethod
    def compileOne(options: SleighCompileOptions) -> int:
        ...

    @staticmethod
    def launchCompile(options: SleighCompileOptions) -> int:
        ...
...
class SleighCompileOptions(java.lang.Object):
    """
    ...
    allMode: jpype.JBoolean
    allDir: java.io.File
    preprocs: java.util.Map[java.lang.String, java.lang.String]
    unnecessaryPcodeWarning: jpype.JBoolean
    lenientConflict: jpype.JBoolean
    allCollisionWarning: jpype.JBoolean
    allNopWarning: jpype.JBoolean
    deadTempWarning: jpype.JBoolean
    enforceLocalKeyWord: jpype.JBoolean
    unusedFieldWarning: jpype.JBoolean
    caseSensitiveRegisterNames: jpype.JBoolean
    debugOutput: jpype.JBoolean

    def __init__(self) -> None:
        ...

    def addPreprocessorMacroDefinition(self, name: typing.Union[java.lang.String, str], value: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def fromFile(argsFile: jpype.protocol.SupportsPath) -> SleighCompileOptions:
        """
        Evaluates the arguments in a sleighArgs.txt file and returns a :obj:`SleighCompileOptions`
        
        :param jpype.protocol.SupportsPath argsFile: file containing an argument per line
        :return: :obj:`SleighCompileOptions`
        :rtype: SleighCompileOptions
        """

    @staticmethod
    def parse(args: jpype.JArray[java.lang.String]) -> SleighCompileOptions:
        """
        Evaluates an array of string arguments and saves the values into a :obj:`SleighCompileOptions`
        instance.
        
        :param jpype.JArray[java.lang.String] args: array of arg strings
        :return: new :obj:`SleighCompileOptions` instance
        :rtype: SleighCompileOptions
        :raises SleighException: if error in an argument
        """
...
__all__ = ["ConsistencyChecker", "DirectoryVisitor", "ErrorWarningReporter", "ExprTree", "FieldContext", "FieldQuality", "MacroBuilder", "OptimizeRecord", "ParseException", "PcodeCompile", "PreprocessorDefinitions", "RtlPair", "SectionVector", "SemanticEnvironment", "SleighCompile", "SleighCompileLauncher", "SleighCompileOptions", "SleighCompilePreprocessorDefinitionsAdapater", "SpaceQuality", "space_class", "StarQuality", "Token", "Yylval"]
