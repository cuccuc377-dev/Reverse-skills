...
class DBTraceAddressSnapRangePropertyMapSpace(ghidra.trace.database.space.DBTraceSpaceBased, ghidra.util.database.spatial.SpatialMap[ghidra.trace.model.TraceAddressSnapRange, T, DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery], ghidra.trace.model.map.TraceAddressSnapRangePropertyMapSpace[T], typing.Generic[T, DR]):
    ...
    def getChildrenOf(self, rec: ghidra.util.database.spatial.DBTreeNodeRecord[typing.Any]) -> java.util.Collection[ghidra.util.database.spatial.DBTreeRecord[typing.Any, ghidra.trace.model.TraceAddressSnapRange]]:
        """
        For developers and testers.
        """
    ...
    def getRootBounds(self) -> ghidra.trace.model.TraceAddressSnapRange:
        """
        For developers and testers.
        """
    ...
    def paint(self, painter: DBTraceAddressSnapRangePropertyMapTree.Painter, depth: typing.Union[jpype.JInt, int]) -> None:
        """
        For developers and testers.
        """
    ...
    @property
    def childrenOf(self) -> java.util.Collection[ghidra.util.database.spatial.DBTreeRecord[typing.Any, ghidra.trace.model.TraceAddressSnapRange]]:
        ...
    ...
    @property
    def rootBounds(self) -> ghidra.trace.model.TraceAddressSnapRange:
        ...
...
class DBTraceAddressSnapRangePropertyMapTree(ghidra.util.database.spatial.rect.Abstract2DRStarTree[ghidra.program.model.address.Address, java.lang.Long, ghidra.trace.model.TraceAddressSnapRange, DR, ghidra.trace.model.TraceAddressSnapRange, DBTraceAddressSnapRangePropertyMapTree.DBTraceAddressSnapRangePropertyMapNode, T, DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery], typing.Generic[T, DR]):
    ...
    class TraceAddressSnapRangeQuery(ghidra.util.database.spatial.rect.AbstractRectangle2DQuery[ghidra.program.model.address.Address, java.lang.Long, ghidra.trace.model.TraceAddressSnapRange, ghidra.trace.model.TraceAddressSnapRange, DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery]):
        ...
        @staticmethod
        def intersectingEnclosed(range: ghidra.program.model.address.AddressRange, span: ghidra.trace.model.Lifespan) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...

        @staticmethod
        def intersectingMinWithin(range: ghidra.program.model.address.AddressRange, span: ghidra.trace.model.Lifespan) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...

        @staticmethod
        def leastRecent(range: ghidra.program.model.address.AddressRange, span: ghidra.trace.model.Lifespan) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...
        ...
        @staticmethod
        def minAt(address: ghidra.program.model.address.Address, snap: typing.Union[jpype.JLong, int]) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...

        @staticmethod
        def minAtSnap(snap: typing.Union[jpype.JLong, int], space: ghidra.program.model.address.AddressSpace) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...

        @staticmethod
        def minWithin(span: ghidra.trace.model.Lifespan, space: ghidra.program.model.address.AddressSpace) -> DBTraceAddressSnapRangePropertyMapTree.TraceAddressSnapRangeQuery:
            ...
    ...
    class Painter(java.lang.Object):

        class_: typing.ClassVar[java.lang.Class]

        def paint(self, shape: ghidra.trace.model.TraceAddressSnapRange, depth: typing.Union[jpype.JInt, int]) -> None:
            ...
    ...
    def internalGetChildrenOf(self, rec: ghidra.util.database.spatial.DBTreeNodeRecord[typing.Any]) -> java.util.Collection[ghidra.util.database.spatial.DBTreeRecord[typing.Any, ghidra.trace.model.TraceAddressSnapRange]]:
        """
        For developers and testers.
        """
...
__all__ = ["AbstractDBTraceAddressSnapRangePropertyMapOcclusionIterable", "AbstractDBTracePropertyMap", "DBTraceAddressSnapRangePropertyMap", "DBTraceAddressSnapRangePropertyMapAddressSetView", "DBTraceAddressSnapRangePropertyMapOcclusionIntoFutureIterable", "DBTraceAddressSnapRangePropertyMapOcclusionIntoPastIterable", "DBTraceAddressSnapRangePropertyMapSpace", "DBTraceAddressSnapRangePropertyMapTree"]
