...
class AsyncUtils(java.lang.Object):
    ...
    DIRECT_EXECUTOR: typing.Final[java.util.concurrent.Executor]
...
__all__ = ["AsyncDebouncer", "AsyncFence", "AsyncLazyMap", "AsyncLazyValue", "AsyncPairingQueue", "AsyncReference", "AsyncTimer", "AsyncUtils", "DisposedException", "SwingExecutorService"]
