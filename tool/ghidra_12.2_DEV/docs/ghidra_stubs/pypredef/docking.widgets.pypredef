...
class GHyperlinkComponent(javax.swing.JPanel):
    ...
    @typing.overload
    def addLink(self, text: typing.Union[java.lang.String, str], accessibleText: typing.Union[java.lang.String, str], linkActivatedCallback: utility.function.Callback) -> None:
        """
        Uses the given text to create a link the user can click.
        
        :param java.lang.String or str text: the text
        :param java.lang.String or str accessibleText: the text that should be read by a screen reader when the user focuses
        this link.
        :param utility.function.Callback linkActivatedCallback: the callback that will be called when the link is activated
        """
...
__all__ = ["AbstractGCellRenderer", "AutoLookup", "CursorPosition", "DataToStringConverter", "DefaultDropDownSelectionDataModel", "DialogRememberOption", "DropDownMultiSelectionChoiceListener", "DropDownMultiSelectionTextField", "DropDownSelectionChoiceListener", "DropDownSelectionTextField", "DropDownTextField", "DropDownTextFieldDataModel", "DropDownWindowVisibilityListener", "EmptyBorderButton", "EventTrigger", "FindDialog", "FindDialogResultsProvider", "GComponent", "GenericDateCellRenderer", "GHyperlinkComponent", "HyperlinkComponent", "InlineComponentTitledBorder", "InlineComponentTitledPanel", "JTreeMouseListenerDelegate", "ListSelectionDialog", "ListSelectionTableDialog", "MultiLineLabel", "OkDialog", "OptionDialog", "OptionDialogBuilder", "PasswordChangeDialog", "PasswordDialog", "PopupKeyStorePasswordProvider", "PopupWindow", "ScrollableTextArea", "SearchLocation", "SelectFromListDialog", "SideKickVerticalScrollbar", "SingleRowLayoutManager", "SmallBorderButton", "TitledPanel", "VariableHeightLayoutManager", "VariableHeightPanel"]
