...
class SleighUtils(java.lang.Enum[SleighUtils]):
    ...
    class LitIdMode(java.lang.Enum[SleighUtils.LitIdMode]):
        """
        ...
        class_: typing.ClassVar[java.lang.Class]
        NORMAL: typing.Final[SleighUtils.LitIdMode]
        """
        The normal mode. Un-prefixed integers are in base 10. Labels start with an alpha.
        """

        HEX: typing.Final[SleighUtils.LitIdMode]
        """
        ...
        ID_HEX: typing.Final[SleighUtils.LitIdMode]
        """
        Hex mode preferring ids. This works the same as :obj:`.HEX`, except that a literal that
        ...
        VALUES: typing.Final[java.util.List[SleighUtils.LitIdMode]]
        description: typing.Final[java.lang.String]
        radix: typing.Final[jpype.JInt]
        preferId: typing.Final[jpype.JBoolean]

        @staticmethod
        def valueOf(name: typing.Union[java.lang.String, str]) -> SleighUtils.LitIdMode:
            ...

        @staticmethod
        def values() -> jpype.JArray[SleighUtils.LitIdMode]:
            ...
    ...
    @staticmethod
    def lexerFor(mode: SleighUtils.LitIdMode, input: org.antlr.runtime.CharStream) -> ghidra.sleigh.grammar.SleighLexer:
        ...
    ...
    @staticmethod
    def parseSleigh(nt: SleighUtils.ParseFunction[T], text: typing.Union[java.lang.String, str], follow: typing.Union[java.lang.String, str], mode: SleighUtils.LitIdMode) -> T:
        """
        ...
        :param SleighUtils.LitIdMode mode: the mode for parsing integer literals and ids
    ...
    @staticmethod
    @typing.overload
    def parseSleighExpression(expression: typing.Union[java.lang.String, str], mode: SleighUtils.LitIdMode) -> org.antlr.runtime.tree.Tree:
        """
...
class DebuggerPcodeUtils(java.lang.Enum[DebuggerPcodeUtils]):
    ...
    class LabelBoundPcodeParser(SleighProgramCompiler.ErrorCollectingPcodeParser):
        ...
        def __init__(self, provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, current: ghidra.program.model.address.Address, mode: SleighUtils.LitIdMode) -> None:
            """
            ...
            :param ghidra.program.model.address.Address current: the current address for the "." symbol
            :param SleighUtils.LitIdMode mode: the mode for parsing integer literals and ids
            """

        def tryIntegerLiteral(self, loc: ghidra.sleigh.grammar.Location, nm: typing.Union[java.lang.String, str], check: typing.Union[jpype.JBoolean, bool]) -> ghidra.pcodeCPort.slghsymbol.SleighSymbol:
            ...
    ...
    @staticmethod
    @typing.overload
    def compileExpression(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, current: ghidra.program.model.address.Address, source: typing.Union[java.lang.String, str], mode: SleighUtils.LitIdMode) -> PcodeExpression:
        """
    ...
    @staticmethod
    @typing.overload
    def compileExpression(provider: ghidra.framework.plugintool.ServiceProvider, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, current: ghidra.program.model.address.Address, source: typing.Union[java.lang.String, str]) -> PcodeExpression:
        """
        Compile the given Sleigh expression into a p-code program, resolving user labels
...
__all__ = ["AbstractBytesPcodeExecutorStatePiece", "AbstractLongOffsetPcodeExecutorStatePiece", "AbstractPcodeExecutorState", "AbstractSleighPcodeUseropDefinition", "AccessPcodeExecutionException", "AddressesReadPcodeArithmetic", "AnnotatedPcodeUseropLibrary", "BytesPcodeArithmetic", "BytesPcodeExecutorState", "BytesPcodeExecutorStatePiece", "BytesPcodeExecutorStateSpace", "ComposedPcodeUseropLibrary", "ConcretionError", "DecodePcodeExecutionException", "DefaultPcodeExecutorState", "DefaultPcodeUseropLibrary", "FixedSleighPcodeUseropDefinition", "IndependentPairedPcodeExecutorState", "InjectionErrorPcodeExecutionException", "InterruptPcodeExecutionException", "LocationPcodeArithmetic", "LocationPcodeExecutorStatePiece", "OverloadedSleighPcodeUseropDefinition", "PairedPcodeArithmetic", "PairedPcodeExecutorState", "PairedPcodeExecutorStatePiece", "PcodeArithmetic", "PcodeExecutionException", "PcodeExecutor", "PcodeExecutorState", "PcodeExecutorStatePiece", "PcodeExpression", "PcodeFrame", "PcodeProgram", "PcodeStateCallbacks", "PcodeUseropLibrary", "PcodeUseropLibraryFactory", "SleighLinkException", "SleighPcodeUseropDefinition", "SleighProgramCompiler", "SleighUtils", "SuspendedPcodeExecutionException", "ValueLocation", "DebuggerPcodeUtils"]
