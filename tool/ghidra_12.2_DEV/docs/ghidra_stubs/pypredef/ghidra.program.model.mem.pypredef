...
class MemoryBlock(java.io.Serializable, java.lang.Comparable[MemoryBlock]):
    ...
    def getBytes(self, addr: ghidra.program.model.address.Address, b: jpype.JArray[jpype.JByte], off: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> int:
        """
        Tries to get ``len`` bytes from this block at the given address and put them into the 
    ...
    def isExternalBlock(self) -> bool:
        ...
        artificial :obj:`AddressSpace.EXTERNAL_SPACE` which is not a memory space.  This can be a 
    ...
    def putBytes(self, addr: ghidra.program.model.address.Address, b: jpype.JArray[jpype.JByte], off: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int]) -> int:
        """
        Tries to put ``len`` bytes from the specified byte array to this block. All the bytes may
...
__all__ = ["ByteMemBufferImpl", "DumbMemBufferImpl", "InvalidAddressException", "MemBuffer", "MemBufferInputStream", "MemBufferMixin", "Memory", "MemoryAccessException", "MemoryBlock", "MemoryBlockException", "MemoryBlockListener", "MemoryBlockSourceInfo", "MemoryBlockStub", "MemoryBlockType", "MemoryBufferImpl", "MemoryConflictException", "MemoryConstants", "MutableMemBuffer", "StubMemory", "WrappedMemBuffer"]
