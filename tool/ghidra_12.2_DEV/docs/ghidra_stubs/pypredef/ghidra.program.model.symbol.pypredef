...
class ExternalManager(java.lang.Object):
    ...
    def getExternalLibraryNames(self) -> jpype.JArray[java.lang.String]:
        ...
        NOTE: The :obj:`Library.UNKNOWN` library will always be returned as first in the list
    ...
    def getLibraries(self) -> java.util.List[ghidra.program.model.listing.Library]:
        """
        ...
        :rtype: java.util.List[ghidra.program.model.listing.Library]
        """

    def getLibraryOrdinal(self, libraryName: typing.Union[java.lang.String, str]) -> int:
        """
    ...
    def setExternalPath(self, libraryName: typing.Union[java.lang.String, str], pathname: typing.Union[java.lang.String, str], userDefined: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
        NOTE: Assigning path for :obj:`Library.UNKNOWN` Library will be ignored.
        ...
        :raises InvalidInputException: on invalid input specified
        """

    def setLibraryOrdinal(self, libraryName: typing.Union[java.lang.String, str], ordinal: typing.Union[jpype.JInt, int]) -> int:
        """
        Sets the Library search ordinal associated with an external name.
         
        
        Assigning ordinal for :obj:`Library.UNKNOWN` Library will fail and return -1.
        ...
        :param java.lang.String or str libraryName: the name of the library to position within Library search sequence
        :param jpype.JInt or int ordinal: library ordinal greater or equal to 1
        :return: the actual ordinal applied or -1 if change failed.
        :rtype: int
        """

    def updateExternalLibraryName(self, oldName: typing.Union[java.lang.String, str], newName: typing.Union[java.lang.String, str], source: SourceType) -> bool:
        """
    ...
    @property
    def libraries(self) -> java.util.List[ghidra.program.model.listing.Library]:
        ...
...
class SymbolTable(java.lang.Object):
    ...
    def getNamespace(self, name: typing.Union[java.lang.String, str], namespace: Namespace) -> Namespace:
        ...
        :param Namespace namespace: the parent namespace of the namespace to be retrieved; null for the global
                namespace
...
__all__ = ["AddressLabelPair", "DataRefType", "DynamicReference", "EntryPointReference", "Equate", "EquateReference", "EquateTable", "ExternalLocation", "ExternalLocationAdapter", "ExternalLocationIterator", "ExternalManager", "ExternalPath", "ExternalReference", "FlowType", "IdentityNameTransformer", "IllegalCharCppTransformer", "LabelHistory", "MemReferenceImpl", "Namespace", "NameTransformer", "OffsetReference", "Reference", "ReferenceIterator", "ReferenceIteratorAdapter", "ReferenceListener", "ReferenceManager", "RefType", "RefTypeFactory", "ShiftedReference", "SourceType", "StackReference", "Symbol", "SymbolIterator", "SymbolIteratorAdapter", "SymbolTable", "SymbolTableListener", "SymbolType", "SymbolUtilities", "ThunkReference"]
