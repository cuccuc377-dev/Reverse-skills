...
class StructureMerger(DataTypeMerger[ghidra.program.model.data.Structure]):
    ...
    @typing.overload
    def __init__(self, struct1: ghidra.program.model.data.Structure, struct2: ghidra.program.model.data.Structure, terminateOnError: typing.Union[jpype.JBoolean, bool]) -> None:
        ...
...
__all__ = ["DataTypeMergeException", "DataTypeMerger", "EnumMerger", "StructureMerger", "UnionMerger"]
