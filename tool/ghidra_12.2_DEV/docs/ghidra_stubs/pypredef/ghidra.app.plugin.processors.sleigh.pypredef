...
class SleighFileException(SleighException):
    """
...
class SleighFileLockException(SleighFileException):
...
class SleighLanguageDescription(ghidra.program.model.lang.BasicLanguageDescription):
    ...
    def __init__(self, id: ghidra.program.model.lang.LanguageID, description: typing.Union[java.lang.String, str], processor: ghidra.program.model.lang.Processor, endian: ghidra.program.model.lang.Endian, instructionEndian: ghidra.program.model.lang.Endian, size: typing.Union[jpype.JInt, int], variant: typing.Union[java.lang.String, str], version: typing.Union[jpype.JInt, int], minorVersion: typing.Union[jpype.JInt, int], deprecated: typing.Union[jpype.JBoolean, bool], spaceTruncations: collections.abc.Mapping, compilerSpecDescriptions: java.util.List[ghidra.program.model.lang.CompilerSpecDescription], externalNames: collections.abc.Mapping) -> None:
        """
        Construct a new language description
        
        :param ghidra.program.model.lang.LanguageID id: the name of the language
        :param java.lang.String or str description: language description text
        :param ghidra.program.model.lang.Processor processor: processor name/family
        :param ghidra.program.model.lang.Endian endian: data endianess
        :param ghidra.program.model.lang.Endian instructionEndian: instruction endianess
        ...
        :param java.util.List[ghidra.program.model.lang.CompilerSpecDescription] compilerSpecDescriptions: one or more compiler spec descriptions
    ...
    def getLanguageFile(self) -> SleighLanguageFile:
        """
        Returns the :obj:`SleighLanguageFile` which represents the .sla and .slaspec files.
        
        :return: :obj:`SleighLanguageFile` which represents the .sla and .slaspec files
        :rtype: SleighLanguageFile
        """
    ...
    def isSameSleighLanguageFile(self, other: SleighLanguageDescription) -> bool:
        """
        Tests if two Sleigh languages are based on the same .sla file.
        
        :param SleighLanguageDescription other: :obj:`SleighLanguageDescription`
        :return: true if the other :obj:`SleighLanguageDescription` uses the same .sla file
        :rtype: bool
        """
    ...
    def setSpecFile(self, specFile: generic.jar.ResourceFile) -> None:
        ...
        :param generic.jar.ResourceFile specFile: the specFile (.pspec) to associate with this description.
        """
    ...
    @property
    def sameSleighLanguageFile(self) -> jpype.JBoolean:
        ...

    @property
    def languageFile(self) -> SleighLanguageFile:
        ...


class SleighLanguageFile(java.lang.Object):
    """
    ...
    class CheckedRunnable(java.lang.Object, typing.Generic[E]):
    ...
    class_: typing.ClassVar[java.lang.Class]
    SLASPEC_EXT: typing.Final = ".slaspec"
    SLA_EXT: typing.Final = ".sla"
    ...
    def compileSlaFile(self, monitor: ghidra.util.task.TaskMonitor) -> None:
        """
        ...
        :meth:`withLock(Duration, TaskMonitor, CheckedRunnable) <.withLock>`
        
        :param ghidra.util.task.TaskMonitor monitor: :obj:`TaskMonitor`
        :raises SleighException: if error occurs during compilation
        """

    @staticmethod
    def fromSlaFilename(dir: generic.jar.ResourceFile, slaFilename: typing.Union[java.lang.String, str]) -> SleighLanguageFile:
        """
        Creates a :obj:`SleighLanguageFile` instance using the language directory and sla filename
        ...
        :param generic.jar.ResourceFile dir: :obj:`ResourceFile` language directory that should contain the sla or slaspec
        file
        :param java.lang.String or str slaFilename: name of the sla file (typically from the ldefs xml value), with optional
        .sla file extension
        :return: :obj:`SleighLanguageFile`, never null
        :rtype: SleighLanguageFile
        :raises SleighFileException: if sla and slaspec file can not be found
        """

    @staticmethod
    def fromSlaFilename_UserDir(dir: generic.jar.ResourceFile, slaFilename: typing.Union[java.lang.String, str]) -> SleighLanguageFile:
        """
        Creates a :obj:`SleighLanguageFile` instance using the language directory and Sleigh
        ...
        :param generic.jar.ResourceFile dir: :obj:`ResourceFile` language directory containing the slaspec file
        :param java.lang.String or str slaFilename: name of the sla file (typically from the ldefs xml value), with optional
        .sla file extension
        :return: :obj:`SleighLanguageFile`, never null
        :rtype: SleighLanguageFile
        :raises SleighFileException: if slaspec is not found
        """

    @staticmethod
    def getLanguageResourceFile(dir: generic.jar.ResourceFile, filename: typing.Union[java.lang.String, str], expectedExtension: typing.Union[java.lang.String, str]) -> generic.jar.ResourceFile:
        """
        ...
        :param generic.jar.ResourceFile dir: base directory where files are typically located
        :param java.lang.String or str filename: name of file, with or without the extension
        :param java.lang.String or str expectedExtension: extension of the specific type of sleigh file, leading dot required.
        Typically ".sla", ".slaspec", ".pspec", etc.
        :return: ResourceFile that exists, never null
        :rtype: generic.jar.ResourceFile
        :raises SleighFileException: if file is not found or has bad case matching
        """

    def getLockFile(self) -> java.io.File:
        ...
    ...
    def getSlaSpecFile(self) -> generic.jar.ResourceFile:
        """
    ...
    def isSlaFileStale(self) -> bool:
        ...
        NOTE: call this when holding the lock using :meth:`withLock(Duration, TaskMonitor, CheckedRunnable) <.withLock>`
        
        :return: true if slaspec file is newer than the sla file
        :rtype: bool
        """

    def needsCompilation(self, requiredSlaFormatVersion: typing.Union[jpype.JInt, int]) -> bool:
        """
        ...
        :param jpype.JInt or int requiredSlaFormatVersion: required sla format version
        :return: true if the .sla file needs to be compiled/recompiled
        :rtype: bool
        """

    @property
    def slaSpecFile(self) -> generic.jar.ResourceFile:
        ...

    @property
    def lockFile(self) -> java.io.File:
        ...
    ...
    @property
    def slaFileStale(self) -> jpype.JBoolean:
        ...

    @property
    def slaVersion(self) -> jpype.JInt:
        ...
...
class SleighLanguageProvider(ghidra.program.model.lang.LanguageProvider):
    ...
    @typing.type_check_only
    class LanguageRec(java.lang.Object):
        ...
        class_: typing.ClassVar[java.lang.Class]


    class_: typing.ClassVar[java.lang.Class]
    LANGUAGE_LOCK_TIMEOUT_PROPNAME: typing.Final = "ghidra.app.plugin.processors.sleigh.SleighLanguageProvider.LANGUAGE_LOCK_TIMEOUT_MS"
    """
    Property that can be set as a jvm startup option to control the sla lock timeout duration.
     
    
    See :obj:`.LANGUAGE_LOCK_TIMEOUT`.
    """

    LANGUAGE_LOCK_TIMEOUT: typing.Final[java.time.Duration]
    """
    ...
    :obj:`LanguageNotFoundException` exception.
    ...
    See :obj:`.LANGUAGE_LOCK_TIMEOUT_PROPNAME`.
    """


    def getLanguageDescription(self, languageId: ghidra.program.model.lang.LanguageID) -> SleighLanguageDescription:
        """
        Returns the :obj:`language description <SleighLanguageDescription>` of the specified language
        
        :param ghidra.program.model.lang.LanguageID languageId: :obj:`LanguageID`
        :return: :obj:`SleighLanguageDescription`
        :rtype: SleighLanguageDescription
        """

    @staticmethod
    def getSleighLanguageProvider() -> SleighLanguageProvider:
        """
        Returns a singleton instance of a :obj:`SleighLanguageProvider`.
        
        :return: singleton :obj:`SleighLanguageProvider`
        :rtype: SleighLanguageProvider
        """

    @property
    def languageDescription(self) -> SleighLanguageDescription:
        ...
...
__all__ = ["Constructor", "ConstructState", "ContextCache", "ContextChange", "ContextCommit", "ContextOp", "DecisionNode", "FixedHandle", "ModuleDefinitionsAdapter", "ModuleDefinitionsMap", "OpTplWalker", "ParserWalker", "PcodeEmit", "PcodeEmitObjects", "PcodeEmitPacked", "SleighCompilerSpecDescription", "SleighDebugLogger", "SleighException", "SleighFileException", "SleighFileLockException", "SleighInstructionPrototype", "SleighLanguage", "SleighLanguageDescription", "SleighLanguageFile", "SleighLanguageProvider", "SleighLanguageValidator", "SleighParserContext", "SpecExtensionEditor", "SpecExtensionPanel", "UniqueLayout", "VarnodeData"]
