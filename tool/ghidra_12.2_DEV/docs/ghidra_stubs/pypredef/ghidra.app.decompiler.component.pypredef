...
class ClangFieldElement(docking.widgets.fieldpanel.field.AbstractTextFieldElement):
    ...
    def __init__(self, hlController: ClangHighlightController, token: ghidra.app.decompiler.ClangToken, as_: docking.widgets.fieldpanel.field.AttributedString, col: typing.Union[jpype.JInt, int]) -> None:
        ...
...
class DecompilerPanel(javax.swing.JPanel, docking.widgets.fieldpanel.listener.FieldMouseListener, docking.widgets.fieldpanel.listener.FieldLocationListener, docking.widgets.fieldpanel.listener.FieldSelectionListener, ClangHighlightListener, docking.widgets.fieldpanel.listener.LayoutListener):
    ...
    def getViewContentBounds(self) -> java.awt.Rectangle:
        """
    ...
    @property
    def viewContentBounds(self) -> java.awt.Rectangle:
        ...
...
__all__ = ["ClangDecompilerHighlighter", "ClangFieldElement", "ClangHighlightController", "ClangHighlightListener", "ClangLayoutController", "ClangTextField", "ColorProvider", "DecompileData", "Decompiler", "DecompilerCallbackHandler", "DecompilerCallbackHandlerAdapter", "DecompilerController", "DecompileResultsListener", "DecompilerFindDialog", "DecompilerHoverProvider", "DecompilerManager", "DecompilerPanel", "DecompilerProgramListener", "DecompileRunnable", "DecompilerUtils", "DefaultColorProvider", "EmptyDecompileData", "HighlightToken", "LocationClangHighlightController", "NameTokenMatcher", "NullClangHighlightController", "TokenHighlightColors", "TokenHighlights", "TokenKey", "UserHighlights"]
