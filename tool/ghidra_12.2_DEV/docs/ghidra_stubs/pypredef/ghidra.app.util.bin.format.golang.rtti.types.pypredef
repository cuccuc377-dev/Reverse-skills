...
class GoPlainType(GoType, ghidra.app.util.bin.format.golang.structmapping.StructureReader[GoType]):
    ...
    def isValidSize(self) -> bool:
        ...

    @property
    def validSize(self) -> jpype.JBoolean:
        ...
...
class GoTypeFlag(java.lang.Enum[GoTypeFlag]):
    ...
    GCMaskOnDemand: typing.Final[GoTypeFlag]
    DirectIFace: typing.Final[GoTypeFlag]

    def getValue(self) -> int:
        ...

    def isSet(self, i: typing.Union[jpype.JInt, int], ver: ghidra.app.util.bin.format.golang.GoVer) -> bool:
        """
        Returns true if this enum instance is set in the supplied integer
        (for the specified go version)
        
        :param jpype.JInt or int i: int packed flag
        :param ghidra.app.util.bin.format.golang.GoVer ver: version of this binary
    ...
    @staticmethod
    def parseFlags(b: typing.Union[jpype.JInt, int], ver: ghidra.app.util.bin.format.golang.GoVer) -> java.util.Set[GoTypeFlag]:
        ...
...
__all__ = ["GoArrayType", "GoBaseType", "GoChanType", "GoFuncType", "GoIMethod", "GoInterfaceType", "GoKind", "GoMapType", "GoMethod", "GoPlainType", "GoPointerType", "GoSliceType", "GoStructField", "GoStructType", "GoType", "GoTypeBridge", "GoTypeDetector", "GoTypeFlag", "GoUncommonType"]
