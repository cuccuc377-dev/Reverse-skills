...
class DebuggerAddressTranslator(java.lang.Object):
    """
    ...
    def getMappedProgramUrlsInView(self, trace: ghidra.trace.model.Trace, set: ghidra.program.model.address.AddressSetView, snap: typing.Union[jpype.JLong, int]) -> java.util.Set[java.net.URL]:
        """
    ...
    @typing.overload
    def getOpenMappedViews(self, trace: ghidra.trace.model.Trace, set: ghidra.program.model.address.AddressSetView, snap: typing.Union[jpype.JLong, int]) -> java.util.Map[ghidra.program.model.listing.Program, java.util.Collection[MappedAddressRange]]:
        """
        ...
        :rtype: java.util.Map[ghidra.program.model.listing.Program, java.util.Collection[MappedAddressRange]]
        """

    @typing.overload
    def getOpenMappedViews(self, program: ghidra.program.model.listing.Program, set: ghidra.program.model.address.AddressSetView) -> java.util.Map[ghidra.trace.model.TraceSpan, java.util.Collection[MappedAddressRange]]:
        """
        ...
        :rtype: java.util.Map[ghidra.trace.model.TraceSpan, java.util.Collection[MappedAddressRange]]
        """
...
class DebuggerMissingModuleActionContext(docking.DefaultActionContext):
    ...
    def __init__(self, module: ghidra.trace.model.modules.TraceModule, snap: typing.Union[jpype.JLong, int]) -> None:
        ...
...
class MappedAddressRange(java.lang.Comparable[MappedAddressRange]):
    """
...
__all__ = ["DebuggerAddressTranslator", "DebuggerMissingModuleActionContext", "DebuggerMissingProgramActionContext", "DebuggerOpenProgramActionContext", "DebuggerStaticMappingChangeListener", "MapEntry", "MappedAddressRange", "MapProposal", "ModuleMapProposal", "RegionMapProposal", "SectionMapProposal"]
