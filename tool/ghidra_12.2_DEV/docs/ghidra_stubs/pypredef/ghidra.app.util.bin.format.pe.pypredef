...
import ghidra.app.util.bin.format.pe.chpe
...
class LoadConfigDirectory(ghidra.app.util.bin.StructConverter):
    ...
    def getArm64ecMetadata(self) -> ghidra.app.util.bin.format.pe.chpe.ImageArm64ecMetadata:
        """
        :return: the ARM64EC metadata (could be ``null`` if there is none)
        :rtype: ghidra.app.util.bin.format.pe.chpe.ImageArm64ecMetadata
        """
    ...
    def getChpeMetadataPointer(self) -> int:
        """
        :return: the CHPE metadata pointer (could be 0 if it's not a CHPE)
        :rtype: int
        """

    def getChpeMetadataX86(self) -> ghidra.app.util.bin.format.pe.chpe.ImageChpeMetadataX86:
        """
        :return: the X86 CHPE metadata (could be ``null`` if there is none)
        :rtype: ghidra.app.util.bin.format.pe.chpe.ImageChpeMetadataX86
        """
    ...
    @property
    def arm64ecMetadata(self) -> ghidra.app.util.bin.format.pe.chpe.ImageArm64ecMetadata:
        ...
    ...
    @property
    def chpeMetadataX86(self) -> ghidra.app.util.bin.format.pe.chpe.ImageChpeMetadataX86:
        ...
    ...
    @property
    def chpeMetadataPointer(self) -> jpype.JLong:
        ...
...
class OptionalHeader(ghidra.app.util.bin.StructConverter):
    ...
    def processLoadConfig(self, nt: NTHeader, log: ghidra.app.util.importer.MessageLog, monitor: ghidra.util.task.TaskMonitor) -> LoadConfigDirectory:
        """
        Parses the :obj:`LoadConfigDataDirectory` and returns its :obj:`LoadConfigDirectory`
        
        :param NTHeader nt: The :obj:`NTHeader`
        :param ghidra.app.util.importer.MessageLog log: The log
        :param ghidra.util.task.TaskMonitor monitor: The monitor
        :return: the parsed :obj:`LoadConfigDirectory`
        :rtype: LoadConfigDirectory
        :raises IOException: if an IO-related error occurred
        """
...
__all__ = ["ArchitectureDataDirectory", "BaseRelocation", "BaseRelocationDataDirectory", "BoundImportDataDirectory", "BoundImportDescriptor", "BoundImportForwarderRef", "COMDescriptorDataDirectory", "Constants", "ControlFlowGuard", "DataDirectory", "DebugDataDirectory", "DefaultDataDirectory", "DelayImportDataDirectory", "DelayImportDescriptor", "DllCharacteristics", "ExceptionDataDirectory", "ExportDataDirectory", "ExportInfo", "FileHeader", "GlobalPointerDataDirectory", "ImageCor20Header", "ImageRuntimeFunctionEntries", "ImageRuntimeFunctionEntries_ARM", "ImageRuntimeFunctionEntries_X86", "ImportAddressTableDataDirectory", "ImportByName", "ImportDataDirectory", "ImportDescriptor", "ImportInfo", "InvalidNTHeaderException", "LoadConfigDataDirectory", "LoadConfigDirectory", "MachineConstants", "MachineName", "NTHeader", "OffsetValidator", "OptionalHeader", "OptionalHeaderROM", "PeMarkupable", "PeSubsystem", "PeUtils", "PEx64UnwindInfo", "PEx64UnwindInfoDataType", "PortableExecutable", "ResourceDataDirectory", "RichHeader", "RichTable", "ROMHeader", "SectionFlags", "SectionHeader", "SecurityCertificate", "SecurityDataDirectory", "SeparateDebugHeader", "ThunkData", "TLSDataDirectory", "TLSDirectory"]
