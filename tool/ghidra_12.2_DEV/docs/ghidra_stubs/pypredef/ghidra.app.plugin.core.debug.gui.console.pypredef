...
class DebuggerConsoleProvider(ghidra.framework.plugintool.ComponentProviderAdapter, docking.actions.PopupActionProvider):
    ...
    @typing.type_check_only
    class LogTableColumns(java.lang.Enum[DebuggerConsoleProvider.LogTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerConsoleProvider.LogTableColumns, DebuggerConsoleProvider.LogRow[typing.Any]]):
...
__all__ = ["ConsoleActionsCellEditor", "ConsoleActionsCellRenderer", "DebuggerConsolePlugin", "DebuggerConsoleProvider", "HtmlOrProgressCellRenderer", "LogRowConsoleActionContext", "MonitorCellRenderer", "MonitorRowConsoleActionContext"]
