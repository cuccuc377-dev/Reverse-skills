...
class DebuggerSelectPlatformOfferDialog(docking.DialogComponentProvider):
    ...
    @typing.type_check_only
    class OfferTableColumns(java.lang.Enum[DebuggerSelectPlatformOfferDialog.OfferTableColumns], docking.widgets.table.EnumeratedTableColumn[DebuggerSelectPlatformOfferDialog.OfferTableColumns, ghidra.app.plugin.core.debug.mapping.DebuggerPlatformOffer]):
