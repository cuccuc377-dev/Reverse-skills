...
class AddressSetPropertyMapDB(ghidra.program.model.util.AddressSetPropertyMap):
    ...
    def moveAddressRange(self, fromAddr: ghidra.program.model.address.Address, toAddr: ghidra.program.model.address.Address, length: typing.Union[jpype.JLong, int], monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
        :raises AddressOverflowException: address out of bounds
...
__all__ = ["AddressRangeMapDB", "AddressRangeMapIterator", "AddressSetPropertyMapDB", "AndQuery", "DatabaseTableUtils", "DatabaseVersionException", "DBFieldAdapter", "DBKeyAdapter", "DBRecordAdapter", "EmptyRecordIterator", "FieldMatchQuery", "FieldRangeQuery", "IndexedAddressIterator", "NotQuery", "OrQuery", "Query", "QueryRecordIterator", "RecordFilter", "SharedRangeMapDB", "StringMatchQuery", "SynchronizedAddressSetCollection"]
