...
class AnalysisUnwoundFrame(AbstractUnwoundFrame[T], typing.Generic[T]):
    ...
    :meth:`StackUnwinder.getFrames(DebuggerCoordinates, TaskMonitor) <StackUnwinder.getFrames>`.
    """
...
class StackUnwinder(java.lang.Object):
    ...
    @typing.type_check_only
    class ThreadAndSnap(java.lang.Record):
    ...
    def computeUnwindInfo(self, snap: typing.Union[jpype.JLong, int], pcVal: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> StackUnwinder.StaticAndUnwind:
        """
    ...
    def findMatchForFunction(self, function: ghidra.program.model.listing.Function, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, warnings: StackUnwindWarningSet, monitor: ghidra.util.task.TaskMonitor) -> AnalysisUnwoundFrame[ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValue]:
        ...

    def getFrame(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, state: ghidra.pcode.exec_.PcodeExecutorState[typing.Any], level: typing.Union[jpype.JInt, int], warnings: StackUnwindWarningSet, monitor: ghidra.util.task.TaskMonitor) -> AnalysisUnwoundFrame[ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValue]:
        ...

    def getFrames(self, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates, monitor: ghidra.util.task.TaskMonitor) -> java.util.Map[java.lang.Integer, AnalysisUnwoundFrame[ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValue]]:
        ...

    def getRecoveredFrameCount(self) -> int:
        """
    ...
    @staticmethod
    def getState(tool: ghidra.framework.plugintool.PluginTool, coordinates: ghidra.debug.api.tracemgr.DebuggerCoordinates) -> ghidra.pcode.exec_.DebuggerPcodeUtils.WatchValuePcodeExecutorState:
        ...
    ...
    @property
    def recoveredFrameCount(self) -> jpype.JInt:
        ...
...
class UnwindAnalysis(java.lang.Object):
    ...
    def getUnwindInfo(self, key: ghidra.program.model.address.Address, monitor: ghidra.util.task.TaskMonitor) -> UnwindInfo:
        ...
...
__all__ = ["AbstractUnwoundFrame", "AnalysisUnwoundFrame", "DynamicMappingException", "EvaluationException", "FakeUnwoundFrame", "FrameStructureBuilder", "ListingUnwoundFrame", "SavedRegisterMap", "StackUnwinder", "StackUnwindWarning", "StackUnwindWarningSet", "Sym", "SymPcodeArithmetic", "SymPcodeExecutor", "SymPcodeExecutorState", "SymStateSpace", "UnwindAnalysis", "UnwindException", "UnwindInfo", "UnwindStackCommand", "UnwoundFrame"]
