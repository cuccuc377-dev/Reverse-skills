...
class DomainObject(java.lang.Object):
    ...
    def saveToPackedFile(self, outputFile: jpype.protocol.SupportsPath, monitor: ghidra.util.task.TaskMonitor) -> None:
        ...
        :param ghidra.util.task.TaskMonitor monitor: progress monitor
        :raises IOException: if an error occurs during operation
...
class ProjectManager(java.lang.Object):
    ...
    def setLastOpenedProject(self, projectLocator: ProjectLocator) -> None:
        ...
        :param ProjectLocator projectLocator: project location of last project that was opened.  A null value signals
...
__all__ = ["AbortedTransactionListener", "AbstractDomainObjectListenerBuilder", "ChangeSet", "DefaultDomainFileFilter", "DefaultLaunchMode", "DomainFile", "DomainFileFilter", "DomainFolder", "DomainFolderChangeListener", "DomainFolderFilter", "DomainFolderListenerAdapter", "DomainObject", "DomainObjectChangedEvent", "DomainObjectChangeRecord", "DomainObjectClosedListener", "DomainObjectDisplayUtils", "DomainObjectEvent", "DomainObjectEventIdGenerator", "DomainObjectException", "DomainObjectListener", "DomainObjectListenerBuilder", "DomainObjectLockedException", "EventQueueID", "EventType", "LinkedDomainFile", "LinkedDomainFolder", "LinkFileInfo", "Project", "ProjectData", "ProjectDataUtils", "ProjectListener", "ProjectLocator", "ProjectManager", "ProjectViewListener", "RuntimeIOException", "ToolAssociationInfo", "ToolChest", "ToolChestChangeListener", "ToolConnection", "ToolListener", "ToolManager", "ToolServices", "ToolSet", "ToolTemplate", "TransactionInfo", "TransactionListener", "UserData", "Workspace", "WorkspaceChangeListener", "XmlDataReader", "ServerInfo"]
