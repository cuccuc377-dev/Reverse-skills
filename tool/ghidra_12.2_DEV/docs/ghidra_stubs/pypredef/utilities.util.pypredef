...
class FileUtilities(java.lang.Object):
    ...
    def isPathContainedWithin(potentialParentFile: jpype.protocol.SupportsPath, otherFile: jpype.protocol.SupportsPath) -> bool:
        ...
        NOTE: Both files are converted to their :meth:`canonical form <File.getCanonicalPath>` prior
        ...
        :return: boolean true if ``otherFile``'s canonical path is within 
        ``potentialParentFile``'s canonical path
        :rtype: bool
        """
    ...
    def isPathContainedWithin(potentialParents: collections.abc.Sequence, otherFile: generic.jar.ResourceFile) -> bool:
        ...
        NOTE: All files are converted to their :meth:`canonical form <File.getCanonicalPath>` prior
        to comparing their paths, which may have performance implications, particularly on Windows.
        ...
        :return: boolean true if ``otherFile``'s canonical path is within any of the 
        ``potentialParents``' canonical paths
        :rtype: bool
        """
    ...
    @staticmethod
    @typing.overload
    def startsWith(potentialParentPath: typing.Union[java.lang.String, str], otherPath: typing.Union[java.lang.String, str]) -> bool:
        """
        Tests if ``otherPath`` starts with ``potentialParentPath``. The paths are
        :meth:`normalized <Path.normalize>` before comparing.
        
        :param java.lang.String or str potentialParentPath: The path that may be the parent
        :param java.lang.String or str otherPath: The path that may be the child
        :return: true if the normalized ``otherPath`` starts with the normalized 
        ``potentialParentPath`` and the paths are :obj:`valid <Paths.get>`; otherwise false
        :rtype: bool
        """

    @staticmethod
    @typing.overload
    def startsWith(potentialParents: collections.abc.Sequence, otherPath: typing.Union[java.lang.String, str]) -> bool:
        """
        Tests if ``otherPath`` starts with any of the given ``potentialParents``. The paths 
        are :meth:`normalized <Path.normalize>` before comparing.
        
        :param collections.abc.Sequence potentialParents: The paths that may be the parent
        :param java.lang.String or str otherPath: The path that may be the child
        :return: boolean true if the normalized ``otherPath`` starts with any of the given
        normalized ``potentialParents``s and the paths are :obj:`valid <Paths.get>`; otherwise
        false
        :rtype: bool
        """
...
class DbgMsgTracer(java.lang.Object):

    class CallRec(java.lang.Record, java.lang.AutoCloseable):

        class_: typing.ClassVar[java.lang.Class]

        def __init__(self, tracer: DbgMsgTracer, obj: java.lang.Object, name: typing.Union[java.lang.String, str], start: typing.Union[jpype.JLong, int]) -> None:
            ...
    ...
    @staticmethod
    def msg(obj: java.lang.Object, message: typing.Union[java.lang.String, str]) -> None:
        ...

    @staticmethod
    def rec(obj: java.lang.Object, name: typing.Union[java.lang.String, str]) -> DbgMsgTracer.CallRec:
        ...
...
__all__ = ["AnnotationUtilities", "FileResolutionResult", "FileUtilities", "DbgMsgTracer", "IDHashed", "IDKeyed", "ProxyUtilities", "SuppressableCallback"]
