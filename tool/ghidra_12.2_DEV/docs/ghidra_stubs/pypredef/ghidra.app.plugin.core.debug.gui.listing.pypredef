...
class DebuggerListingProvider(ghidra.app.plugin.core.codebrowser.CodeViewerProvider, ghidra.debug.api.listing.DebuggerListing):
...
__all__ = ["CursorBackgroundColorModel", "DebuggerListingActionContext", "DebuggerListingPlugin", "DebuggerListingProvider", "DebuggerTrackedRegisterListingBackgroundColorModel", "MemoryStateListingBackgroundColorModel"]
