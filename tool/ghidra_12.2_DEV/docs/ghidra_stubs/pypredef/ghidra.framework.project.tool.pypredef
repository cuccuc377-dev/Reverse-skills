...
class ExtensionsEnabledState(java.lang.Object):
    """
    ...
    def getAllKnownExtensions(self) -> java.util.Map[java.lang.String, java.util.Set[ghidra.util.classfinder.ClassFileInfo]]:
        """
        :return: a map of all known extensions to a set of their plugins
        :rtype: java.util.Map[java.lang.String, java.util.Set[ghidra.util.classfinder.ClassFileInfo]]
        """

    def propmtToConfigureNewPlugins(self, newPlugins: java.util.Set[ghidra.util.classfinder.ClassFileInfo]) -> None:
        """
        Shows a window to prompt the user to configure any new extension plugins.
        
        :param java.util.Set[ghidra.util.classfinder.ClassFileInfo] newPlugins: the new extension plugins
        """

    def removeInstalledPlugins(self, allPlugins: java.util.Set[ghidra.util.classfinder.ClassFileInfo]) -> None:
        """
        ...
        :param java.util.Set[ghidra.util.classfinder.ClassFileInfo] allPlugins: the plugins set to update
        """

    @property
    def allKnownExtensions(self) -> java.util.Map[java.lang.String, java.util.Set[ghidra.util.classfinder.ClassFileInfo]]:
        ...
...
@typing.type_check_only
class ToolExtensionsEnabledState(ExtensionsEnabledState):
    """
    The default extension state for a :obj:`PluginTool`.
    """
...
@typing.type_check_only
class ToolExtensionsStatusManager(java.lang.Object):
    """
    A class to manage saving and restoring of known extension used by a tool.
    """

    @typing.type_check_only
    class ExtensionMemento(java.lang.Record):
...
__all__ = ["ConnectionDescriptor", "ExtensionsEnabledState", "GhidraPluginsConfiguration", "GhidraTool", "GhidraToolTemplate", "OpenFileDropHandlerFactory", "SelectChangedToolDialog", "ToolConnectionImpl", "ToolExtensionsEnabledState", "ToolExtensionsStatusManager", "ToolManagerImpl", "ToolServicesImpl", "WorkspaceImpl"]
