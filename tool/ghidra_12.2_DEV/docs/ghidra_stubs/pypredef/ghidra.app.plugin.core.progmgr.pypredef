...
__all__ = ["AbstractProgramNameSwitchingAction", "AbstractUndoRedoAction", "CloseProgramAction", "MultiProgramManager", "MultiTabListener", "MultiTabPlugin", "ProgramCache", "ProgramLocator", "ProgramManagerPlugin", "ProgramOptionsAction", "ProgramSaveManager", "ProgramTabActionContext", "RedoAction", "SaveAsProgramAction", "SaveProgramAction", "TransactionMonitor", "UndoAction"]
