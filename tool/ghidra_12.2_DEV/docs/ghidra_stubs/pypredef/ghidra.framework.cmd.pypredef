...
class CompoundCmd(Command[T], typing.Generic[T]):
    ...
    def getCommands(self) -> java.util.List[Command[T]]:
        """
        :return: the commands in this compound command
        :rtype: java.util.List[Command[T]]
        """
    ...
    @property
    def commands(self) -> java.util.List[Command[T]]:
        ...
...
__all__ = ["BinaryAnalysisCommand", "BackgroundCommand", "Command", "CompoundBackgroundCommand", "CompoundCmd", "MergeableBackgroundCommand"]
