...
class Lock(java.util.concurrent.locks.ReentrantReadWriteLock):
    """
    ...
    adds convenient methods to get either a read or write lock that returns an :obj:`AutoCloseable`
    ...
    class Closeable(java.lang.AutoCloseable):
        ...
        java :obj:`java.io.Closeable` because it throws an exception on the close call that
        we don't want.
        """
    ...
    def read(self) -> Lock.Closeable:
        ...
        :rtype: Lock.Closeable
        """

    def withRead(self, supplier: java.util.function.Supplier[T]) -> T:
        """
        A convenience method for acquiring a read lock, executing a supplier object,
        then releasing the lock.
        
        :param T: the supplier return type:param java.util.function.Supplier[T] supplier: the supplier to execute while holding a read lock.
        :return: the result from the supplier
        :rtype: T
        """

    def withWrite(self, callback: utility.function.Callback) -> None:
        """
        A convenience method for acquiring a write lock, executing a callback object,
        then releasing the lock.
        
        :param utility.function.Callback callback: the callback to execute while holding a write lock.
        """

    def write(self) -> Lock.Closeable:
        """
...
class NumericUtilities(java.lang.Object):
    ...
    @staticmethod
    @typing.overload
    def convertBytesToString(bytes: jpype.JArray[jpype.JByte], delimiter: typing.Union[java.lang.String, str]) -> str:
        """
        Convert a byte array into a hexadecimal string.
        
        :param jpype.JArray[jpype.JByte] bytes: byte array
        :param java.lang.String or str delimiter: the text between byte strings, ``null`` ok
        :return: hex string representation
        :rtype: str
        """
    ...
    @staticmethod
    @typing.overload
    def convertBytesToString(bytes: jpype.JArray[jpype.JByte], start: typing.Union[jpype.JInt, int], len: typing.Union[jpype.JInt, int], delimiter: typing.Union[java.lang.String, str]) -> str:
        """
        Convert a byte array into a hexadecimal string.
...
__all__ = ["BrowserLoader", "GhidraJarBuilder", "LaunchErrorDialog", "ManualViewerCommandEditor", "ManualViewerCommandWrappedOption", "MultiComparableArrayIterator", "SourceFileUtils", "StackFrameImpl", "UndefinedFunction", "AbstractAddressSetView", "AddressIteratorAdapter", "AddressRangeComparators", "AddressRangeIterators", "DifferenceAddressSetView", "GhidraBigEndianDataConverter", "GhidraDataConverter", "GhidraLittleEndianDataConverter", "IntersectionAddressSetView", "ManualEntry", "SymmetricDifferenceAddressSetView", "TwoWayBreakdownAddressRangeIterator", "UnionAddressRangeIterator", "UnionAddressSetView", "XmlProgramUtilities", "Lock", "VersionExceptionHandler", "MD5Utilities", "NamingUtilities", "NotOwnerException", "PropertyFile", "ColorUtils", "DynamicHelpLocation", "HelpLocation", "HTMLUtilities", "TaskUtilities", "TrackedTaskListener", "WebColors", "BigEndianDataConverter", "CascadedDropTarget", "Conv", "CountLatch", "DataConverter", "DateUtils", "Disposable", "DropTargetDragEventWrapper", "FilterTransformer", "InvalidNameException", "JavaSourceFile", "JavaSourceLine", "LittleEndianDataConverter", "LongIterator", "MathUtilities", "MonitoredInputStream", "NumericUtilities", "ObjectStorage", "ObjectStorageStreamAdapter", "PrivateSaveable", "ReadOnlyException", "ReversedListIterator", "Saveable", "SaveableColor", "SaveablePoint", "SignednessFormatMode", "StatusListener", "StringFormat", "StringUtilities", "TestSuiteUtilities", "TestUniversalIdGenerator", "TriConsumer", "UniversalID", "UniversalIdGenerator", "WordLocation", "BoundedInputStream", "ConsoleErrorDisplay", "DefaultErrorLogger", "ErrorDisplay", "ErrorLogger", "Fixup", "HashingOutputStream", "Issue", "Location", "MessageType", "MonitoredOutputStream", "Msg", "NullOutputStream", "Swing", "SystemUtilities", "UserSearchUtils", "ByteBufferUtils", "DistinctIterator", "LanguageUtilities", "LazyCollection", "LockHold", "MergeSortingSpliterator", "PairingIteratorMerger", "StreamUtils", "TimedMsg"]
