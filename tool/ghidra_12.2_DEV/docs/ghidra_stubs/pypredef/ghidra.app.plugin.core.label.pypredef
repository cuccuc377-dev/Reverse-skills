...
class SymbolChooserDialog(docking.DialogComponentProvider):

    class_: typing.ClassVar[java.lang.Class]

    def __init__(self, plugin: LabelMgrPlugin, context: ghidra.app.context.ListingActionContext) -> None:
        ...
...
__all__ = ["AddLabelAction", "AllHistoryAction", "EditExternalLabelAction", "EditLabelAction", "LabelHistoryAction", "LabelHistoryDialog", "LabelHistoryInputDialog", "LabelHistoryListener", "LabelHistoryPanel", "LabelHistoryTableModel", "LabelHistoryTask", "LabelMgrPlugin", "RemoveLabelAction", "SetOperandLabelAction", "SymbolChooserDialog"]
