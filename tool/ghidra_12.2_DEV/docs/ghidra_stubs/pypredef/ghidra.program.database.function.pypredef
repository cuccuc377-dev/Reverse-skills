...
class FunctionDB(ghidra.program.database.DbObject, ghidra.program.model.listing.Function):
    """
...
class FunctionManagerDB(ghidra.program.model.listing.FunctionManager):
    ...
    @typing.type_check_only
    class FunctionFactory(ghidra.program.database.DbFactory[FunctionDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
class FunctionTagDB(ghidra.program.database.DbObject, ghidra.program.model.listing.FunctionTag):
    """
    ...
    def __init__(self, mgr: FunctionTagManagerDB, record: db.DBRecord) -> None:
        ...
...
class FunctionTagManagerDB(ghidra.program.model.listing.FunctionTagManager, db.util.ErrorHandler):
    ...
    @typing.type_check_only
    class TagFactory(ghidra.program.database.DbFactory[FunctionTagDB]):
        ...
        class_: typing.ClassVar[java.lang.Class]
...
@typing.type_check_only
class FunctionVariables(java.lang.Object):
    ...
    class_: typing.ClassVar[java.lang.Class]
...
__all__ = ["FunctionAdapter", "FunctionAdapterV0", "FunctionAdapterV1", "FunctionAdapterV2", "FunctionAdapterV3", "FunctionDB", "FunctionManagerDB", "FunctionStackFrame", "FunctionTagAdapter", "FunctionTagAdapterV0", "FunctionTagDB", "FunctionTagManagerDB", "FunctionTagMappingAdapter", "FunctionTagMappingAdapterNoTable", "FunctionTagMappingAdapterV0", "FunctionVariables", "LocalVariableDB", "OverlappingFunctionException", "ParameterDB", "ReturnParameterDB", "ThunkFunctionAdapter", "ThunkFunctionAdapterV0", "VariableDB"]
